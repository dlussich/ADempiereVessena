 ...
 * Fecha : 21/02/2011
 */
public class RCtaCteSaldosPendientes extends SvrProcess {
	 ...
	 * Constructor
	 */
	public RCtaCteSaldosPendientes() {
		...
		for (int i = 0; i < para.length; i++)
		{
			...
			if (name!= null){
				...
				/*if (name.equalsIgnoreCase("tipoReporteSaldoPend")){
					this.tipoCtaReporte = (String)para[i].getParameter();
				}*/
