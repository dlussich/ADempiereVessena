...
public class RStkAvailableMov extends SvrProcess {
	...
	// Variables para recibir filtros del reporte
		...
		private static final String TABLA_MOLDE = "UY_Molde_StkAvailableMov";
		
		
		/**
		 * Costructor.
		 */
		public RStkAvailableMov() {
		}
		...
		private void getData() throws Exception{
			...
			try
			{
				insert = "INSERT INTO " + TABLA_MOLDE + " (ad_client_id, ad_org_id, idusuario, idreporte,fecreporte," +
					    ...
					    " saldoinicial, saldoacumulado, entrada, salida, qty_available, record_id) ";
				...
				String funcionDisponible = "stk_available(stk.m_product_id, stk.m_warehouse_id, stk.m_locator_id, null, null, stk.movementdate)";
				...
				sql = " SELECT stk.ad_client_id,0," + this.adUserID + ",'" + this.idReporte + "',current_date," + 
					  ...
					  " case when sign = -1 then stk.movementqty else 0 end as salida, " + funcionDisponible + " as disponible," +
