...
/** Generated Model for UY_POSection
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_POSection extends PO implements I_UY_POSection, I_Persistent 
{
    ...
    public X_UY_POSection (Properties ctx, int UY_POSection_ID, String trxName)
    {
      super (ctx, UY_POSection_ID, trxName);
      /** if (UY_POSection_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_UY_POSection (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_POSection[")
