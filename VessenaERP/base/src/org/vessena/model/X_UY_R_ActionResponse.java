...
/** Generated Model for UY_R_ActionResponse
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_R_ActionResponse extends PO implements I_UY_R_ActionResponse, I_Persistent 
{
    ...
    public X_UY_R_ActionResponse (Properties ctx, int UY_R_ActionResponse_ID, String trxName)
    {
      super (ctx, UY_R_ActionResponse_ID, trxName);
      /** if (UY_R_ActionResponse_ID == 0)
        {
			setC_DocType_ID (0);
			setDateTrx (new Timestamp( System.currentTimeMillis() ));
			setUY_R_ActionResponse_ID (0);
    ...
    /** Load Constructor */
    public X_UY_R_ActionResponse (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_R_ActionResponse[")
	...
	/** RActionResponseType AD_Reference_ID=1000276 */
	public static final int RACTIONRESPONSETYPE_AD_Reference_ID=1000276;
	/** Cerrar Reclamo = CERRAR */
	public static final String RACTIONRESPONSETYPE_CerrarReclamo = "CERRAR";
	/** Derivar Reclamo = DERIVAR */
	public static final String RACTIONRESPONSETYPE_DerivarReclamo = "DERIVAR";
	/** Solicitar Ajuste = AJUSTE */
	public static final String RACTIONRESPONSETYPE_SolicitarAjuste = "AJUSTE";
	/** Set RActionResponseType.
		@param RActionResponseType RActionResponseType	  */
	public void setRActionResponseType (String RActionResponseType)
	{

		set_Value (COLUMNNAME_RActionResponseType, RActionResponseType);
	}

	/** Get RActionResponseType.
		@return RActionResponseType	  */
	public String getRActionResponseType () 
	{
		return (String)get_Value(COLUMNNAME_RActionResponseType);
	}
	...
	public void setUY_R_ActionResponse_ID (int UY_R_ActionResponse_ID)
	{
		if (UY_R_ActionResponse_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_R_ActionResponse_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_R_ActionResponse_ID, Integer.valueOf(UY_R_ActionResponse_ID));
	}
