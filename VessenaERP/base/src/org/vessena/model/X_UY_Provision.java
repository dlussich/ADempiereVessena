...
/** Generated Model for UY_Provision
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_Provision extends PO implements I_UY_Provision, I_Persistent 
{
    ...
    public X_UY_Provision (Properties ctx, int UY_Provision_ID, String trxName)
    {
      super (ctx, UY_Provision_ID, trxName);
      /** if (UY_Provision_ID == 0)
        {
			setC_DocType_ID (0);
			setC_Period_ID (0);
...
// PROM1
    ...
    /** Load Constructor */
    public X_UY_Provision (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_Provision[")
	...
	/** ProvisionType AD_Reference_ID=1000189 */
	public static final int PROVISIONTYPE_AD_Reference_ID=1000189;
	/** Promedio Mes = PROM1 */
	public static final String PROVISIONTYPE_PromedioMes = "PROM1";
	/** Promedio 3 Meses = PROM3 */
	public static final String PROVISIONTYPE_Promedio3Meses = "PROM3";
	/** Set ProvisionType.
		@param ProvisionType ProvisionType	  */
	public void setProvisionType (String ProvisionType)
	{

		set_ValueNoCheck (COLUMNNAME_ProvisionType, ProvisionType);
	}
	...
	public void setUY_Provision_ID (int UY_Provision_ID)
	{
		if (UY_Provision_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_Provision_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_Provision_ID, Integer.valueOf(UY_Provision_ID));
	}
