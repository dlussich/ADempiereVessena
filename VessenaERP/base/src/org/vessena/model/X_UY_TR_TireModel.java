...
/** Generated Model for UY_TR_TireModel
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_UY_TR_TireModel extends PO implements I_UY_TR_TireModel, I_Persistent 
{
    ...
    public X_UY_TR_TireModel (Properties ctx, int UY_TR_TireModel_ID, String trxName)
    {
      super (ctx, UY_TR_TireModel_ID, trxName);
      /** if (UY_TR_TireModel_ID == 0)
        {
			setName (null);
			setUY_TR_TireMark_ID (0);
			setUY_TR_TireModel_ID (0);
			setValue (null);
        } */
    }

    /** Load Constructor */
    public X_UY_TR_TireModel (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_TR_TireModel[")
	...
	public void setUY_TR_TireModel_ID (int UY_TR_TireModel_ID)
	{
		if (UY_TR_TireModel_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_TR_TireModel_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_TR_TireModel_ID, Integer.valueOf(UY_TR_TireModel_ID));
	}
