...
/** Generated Model for UY_TT_Comunica
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_TT_Comunica extends PO implements I_UY_TT_Comunica, I_Persistent 
{
    ...
    public X_UY_TT_Comunica (Properties ctx, int UY_TT_Comunica_ID, String trxName)
    {
      super (ctx, UY_TT_Comunica_ID, trxName);
      /** if (UY_TT_Comunica_ID == 0)
        {
			setAD_User_ID (0);
			setC_DocType_ID (0);
    ...
    /** Load Constructor */
    public X_UY_TT_Comunica (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_TT_Comunica[")
	...
	public void setUY_TT_Comunica_ID (int UY_TT_Comunica_ID)
	{
		if (UY_TT_Comunica_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_TT_Comunica_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_TT_Comunica_ID, Integer.valueOf(UY_TT_Comunica_ID));
	}
