...
/** Generated Model for UY_R_Action
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_R_Action extends PO implements I_UY_R_Action, I_Persistent 
{
    ...
    public X_UY_R_Action (Properties ctx, int UY_R_Action_ID, String trxName)
    {
      ...
      /** if (UY_R_Action_ID == 0)
        {
			setName (null);
			setUY_R_Action_ID (0);
			setUY_R_ActionType_ID (0);
			setValue (null);
        } */
    }

    /** Load Constructor */
    public X_UY_R_Action (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_R_Action[")
	...
	/** Instancia AD_Reference_ID=1000309 */
	public static final int INSTANCIA_AD_Reference_ID=1000309;
	/** Gestion = GESTION */
	public static final String INSTANCIA_Gestion = "GESTION";
	/** Notificacion = NOTIFICACION */
	public static final String INSTANCIA_Notificacion = "NOTIFICACION";
	/** Set Instancia.
		@param Instancia Instancia	  */
	public void setInstancia (String Instancia)
	{

		set_Value (COLUMNNAME_Instancia, Instancia);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_Instancia);
	}
	...
	{
		if (UY_R_Action_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_R_Action_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_R_Action_ID, Integer.valueOf(UY_R_Action_ID));
	}
