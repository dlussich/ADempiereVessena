...
/** Generated Model for UY_Gerencial_BP
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_Gerencial_BP extends PO implements I_UY_Gerencial_BP, I_Persistent 
{
    ...
    public X_UY_Gerencial_BP (Properties ctx, int UY_Gerencial_BP_ID, String trxName)
    {
      super (ctx, UY_Gerencial_BP_ID, trxName);
      /** if (UY_Gerencial_BP_ID == 0)
        {
			setC_BPartner_ID (0);
			setUY_Gerencial_Account_ID (0);
			setUY_Gerencial_BP_ID (0);
    ...
    /** Load Constructor */
    public X_UY_Gerencial_BP (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_Gerencial_BP[")
	...
	public void setUY_Gerencial_BP_ID (int UY_Gerencial_BP_ID)
	{
		if (UY_Gerencial_BP_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_Gerencial_BP_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_Gerencial_BP_ID, Integer.valueOf(UY_Gerencial_BP_ID));
	}
