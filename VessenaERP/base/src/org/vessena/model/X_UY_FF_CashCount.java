...
/** Generated Model for UY_FF_CashCount
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_UY_FF_CashCount extends PO implements I_UY_FF_CashCount, I_Persistent 
{

	/**
	 *
	 */
	private static final long serialVersionUID = 20140130L;

    /** Standard Constructor */
    public X_UY_FF_CashCount (Properties ctx, int UY_FF_CashCount_ID, String trxName)
    {
      super (ctx, UY_FF_CashCount_ID, trxName);
      /** if (UY_FF_CashCount_ID == 0)
        {
			setAD_User_ID (0);
			setamt1 (Env.ZERO);
			setamt2 (Env.ZERO);
...
// DR
    ...
    /** Load Constructor */
    public X_UY_FF_CashCount (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_FF_CashCount[")
	...
	public void setUY_FF_CashCount_ID (int UY_FF_CashCount_ID)
	{
		if (UY_FF_CashCount_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_FF_CashCount_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_FF_CashCount_ID, Integer.valueOf(UY_FF_CashCount_ID));
	}
