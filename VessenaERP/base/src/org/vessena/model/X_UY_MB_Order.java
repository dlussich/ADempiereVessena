...
/** Generated Model for UY_MB_Order
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_MB_Order extends PO implements I_UY_MB_Order, I_Persistent 
{
    ...
    public X_UY_MB_Order (Properties ctx, int UY_MB_Order_ID, String trxName)
    {
...
// N
    ...
    /** Load Constructor */
    public X_UY_MB_Order (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_MB_Order[")
	...
	/** Set TimeOrdered.
		@param TimeOrdered TimeOrdered	  */
	public void setTimeOrdered (Timestamp TimeOrdered)
	{
		set_Value (COLUMNNAME_TimeOrdered, TimeOrdered);
	}
	...
	{
		return (Timestamp)get_Value(COLUMNNAME_TimeOrdered);
	}
    ...
    {
		return (I_UY_MB_Device)MTable.get(getCtx(), I_UY_MB_Device.Table_Name)
			.getPO(getUY_MB_Device_ID(), get_TrxName());	}
	...
	public void setUY_MB_Device_ID (int UY_MB_Device_ID)
	{
		if (UY_MB_Device_ID < 1) 
			set_Value (COLUMNNAME_UY_MB_Device_ID, null);
		else 
			set_Value (COLUMNNAME_UY_MB_Device_ID, Integer.valueOf(UY_MB_Device_ID));
	}
	...
	{
		if (UY_MB_Order_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_MB_Order_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_MB_Order_ID, Integer.valueOf(UY_MB_Order_ID));
	}
