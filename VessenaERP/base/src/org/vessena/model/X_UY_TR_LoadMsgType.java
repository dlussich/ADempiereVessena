...
/** Generated Model for UY_TR_LoadMsgType
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_TR_LoadMsgType extends PO implements I_UY_TR_LoadMsgType, I_Persistent 
{
    ...
    public X_UY_TR_LoadMsgType (Properties ctx, int UY_TR_LoadMsgType_ID, String trxName)
    {
      super (ctx, UY_TR_LoadMsgType_ID, trxName);
      /** if (UY_TR_LoadMsgType_ID == 0)
        {
			setIsReleased (false);
// N
			setName (null);
    ...
    /** Load Constructor */
    public X_UY_TR_LoadMsgType (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_TR_LoadMsgType[")
	...
	public void setUY_TR_LoadMsgType_ID (int UY_TR_LoadMsgType_ID)
	{
		if (UY_TR_LoadMsgType_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_TR_LoadMsgType_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_TR_LoadMsgType_ID, Integer.valueOf(UY_TR_LoadMsgType_ID));
	}
