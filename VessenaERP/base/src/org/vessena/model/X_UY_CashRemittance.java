...
/** Generated Model for UY_CashRemittance
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_CashRemittance extends PO implements I_UY_CashRemittance, I_Persistent 
{

	/**
	 *
	 */
	private static final long serialVersionUID = 20151230L;

    /** Standard Constructor */
    public X_UY_CashRemittance (Properties ctx, int UY_CashRemittance_ID, String trxName)
    {
      super (ctx, UY_CashRemittance_ID, trxName);
      /** if (UY_CashRemittance_ID == 0)
        {
			setC_DocType_ID (0);
			setChecked (false);
// N
...
// N
    ...
    /** Load Constructor */
    public X_UY_CashRemittance (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_CashRemittance[")
	...
	/** Set IsLastRemittance.
		@param IsLastRemittance IsLastRemittance	  */
	public void setIsLastRemittance (boolean IsLastRemittance)
	{
		set_Value (COLUMNNAME_IsLastRemittance, Boolean.valueOf(IsLastRemittance));
	}

	/** Get IsLastRemittance.
		@return IsLastRemittance	  */
	public boolean isLastRemittance () 
	{
		Object oo = get_Value(COLUMNNAME_IsLastRemittance);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	public void setUY_CashRemittance_ID (int UY_CashRemittance_ID)
	{
		if (UY_CashRemittance_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_CashRemittance_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_CashRemittance_ID, Integer.valueOf(UY_CashRemittance_ID));
	}
