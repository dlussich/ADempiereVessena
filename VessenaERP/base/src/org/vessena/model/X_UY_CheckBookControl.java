...
/** Generated Model for UY_CheckBookControl
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_UY_CheckBookControl extends PO implements I_UY_CheckBookControl, I_Persistent 
{

	/**
	 *
	 */
	private static final long serialVersionUID = 20120328L;

    /** Standard Constructor */
    public X_UY_CheckBookControl (Properties ctx, int UY_CheckBookControl_ID, String trxName)
    {
      super (ctx, UY_CheckBookControl_ID, trxName);
      /** if (UY_CheckBookControl_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_UY_CheckBookControl (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_CheckBookControl[")
	...
	{
		set_ValueNoCheck (COLUMNNAME_Control, Integer.valueOf(Control));
	}
	...
	{
		set_ValueNoCheck (COLUMNNAME_Diference, Integer.valueOf(Diference));
	}
	...
	public I_UY_CheckBook getUY_CheckBook() throws RuntimeException
    {
		return (I_UY_CheckBook)MTable.get(getCtx(), I_UY_CheckBook.Table_Name)
			.getPO(getUY_CheckBook_ID(), get_TrxName());	}
	...
	public void setUY_CheckBook_ID (int UY_CheckBook_ID)
	{
		if (UY_CheckBook_ID < 1) 
			set_Value (COLUMNNAME_UY_CheckBook_ID, null);
		else 
			set_Value (COLUMNNAME_UY_CheckBook_ID, Integer.valueOf(UY_CheckBook_ID));
	}
	...
	public void setUY_CheckBookControl_ID (int UY_CheckBookControl_ID)
	{
		if (UY_CheckBookControl_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_CheckBookControl_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_CheckBookControl_ID, Integer.valueOf(UY_CheckBookControl_ID));
	}
