...
/** Generated Model for UY_BG_LabSampleReception
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_BG_LabSampleReception extends PO implements I_UY_BG_LabSampleReception, I_Persistent 
{
    ...
    public X_UY_BG_LabSampleReception (Properties ctx, int UY_BG_LabSampleReception_ID, String trxName)
    {
      super (ctx, UY_BG_LabSampleReception_ID, trxName);
      /** if (UY_BG_LabSampleReception_ID == 0)
        {
			setC_DocType_ID (0);
			setDocAction (null);
// R
...
// EP
			...
			setM_Product_ID (0);
			setQty (Env.ZERO);
			setUY_BG_LabSampleReception_ID (0);
			setUY_BG_LabSection_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_BG_LabSampleReception (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_BG_LabSampleReception[")
	...
	/** Set Cliente_ID_2.
		@param Cliente_ID_2 Cliente_ID_2	  */
	public void setCliente_ID_2 (int Cliente_ID_2)
	{
		set_Value (COLUMNNAME_Cliente_ID_2, Integer.valueOf(Cliente_ID_2));
	}

	/** Get Cliente_ID_2.
		@return Cliente_ID_2	  */
	public int getCliente_ID_2 () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_Cliente_ID_2);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Name2 AD_Reference_ID=1000542 */
	public static final int NAME2_AD_Reference_ID=1000542;
	/** Cliente = CL */
	public static final String NAME2_Cliente = "CL";
	/** Puesto de Bolsa = PB */
	public static final String NAME2_PuestoDeBolsa = "PB";
	/** Sub Cliente = SC */
	public static final String NAME2_SubCliente = "SC";
	/** Set Name 2.
		@param Name2 
		Additional Name
	  */
	...
	/** Set UY_BG_LabSampleReception.
		@param UY_BG_LabSampleReception_ID UY_BG_LabSampleReception	  */
	public void setUY_BG_LabSampleReception_ID (int UY_BG_LabSampleReception_ID)
	{
		if (UY_BG_LabSampleReception_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_BG_LabSampleReception_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_BG_LabSampleReception_ID, Integer.valueOf(UY_BG_LabSampleReception_ID));
	}

	/** Get UY_BG_LabSampleReception.
		@return UY_BG_LabSampleReception	  */
	public int getUY_BG_LabSampleReception_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_BG_LabSampleReception_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
