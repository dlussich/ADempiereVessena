...
/** Generated Model for UY_YearEndIntegral
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_UY_YearEndIntegral extends PO implements I_UY_YearEndIntegral, I_Persistent 
{
    ...
    public X_UY_YearEndIntegral (Properties ctx, int UY_YearEndIntegral_ID, String trxName)
    {
      super (ctx, UY_YearEndIntegral_ID, trxName);
      /** if (UY_YearEndIntegral_ID == 0)
        {
			setC_DocType_ID (0);
...
// N
    ...
    /** Load Constructor */
    public X_UY_YearEndIntegral (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_YearEndIntegral[")
	...
	public void setUY_YearEndIntegral_ID (int UY_YearEndIntegral_ID)
	{
		if (UY_YearEndIntegral_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_YearEndIntegral_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_YearEndIntegral_ID, Integer.valueOf(UY_YearEndIntegral_ID));
	}
