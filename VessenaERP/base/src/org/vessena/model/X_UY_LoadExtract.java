...
/** Generated Model for UY_LoadExtract
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_UY_LoadExtract extends PO implements I_UY_LoadExtract, I_Persistent 
{

	/**
	 *
	 */
	private static final long serialVersionUID = 20130421L;

    /** Standard Constructor */
    public X_UY_LoadExtract (Properties ctx, int UY_LoadExtract_ID, String trxName)
    {
      super (ctx, UY_LoadExtract_ID, trxName);
      /** if (UY_LoadExtract_ID == 0)
        {
			setAmount (Env.ZERO);
...
// N
    ...
    /** Load Constructor */
    public X_UY_LoadExtract (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_LoadExtract[")
	...
	public void setUY_LoadExtract_ID (int UY_LoadExtract_ID)
	{
		if (UY_LoadExtract_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_LoadExtract_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_LoadExtract_ID, Integer.valueOf(UY_LoadExtract_ID));
	}
