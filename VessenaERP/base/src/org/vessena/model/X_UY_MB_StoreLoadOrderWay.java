...
/** Generated Model for UY_MB_StoreLoadOrderWay
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_MB_StoreLoadOrderWay extends PO implements I_UY_MB_StoreLoadOrderWay, I_Persistent 
{
    ...
    public X_UY_MB_StoreLoadOrderWay (Properties ctx, int UY_MB_StoreLoadOrderWay_ID, String trxName)
    {
      super (ctx, UY_MB_StoreLoadOrderWay_ID, trxName);
      /** if (UY_MB_StoreLoadOrderWay_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_UY_MB_StoreLoadOrderWay (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_MB_StoreLoadOrderWay[")
	...
	public void setUY_MB_StoreLoadOrderWay_ID (int UY_MB_StoreLoadOrderWay_ID)
	{
		if (UY_MB_StoreLoadOrderWay_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_MB_StoreLoadOrderWay_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_MB_StoreLoadOrderWay_ID, Integer.valueOf(UY_MB_StoreLoadOrderWay_ID));
	}
