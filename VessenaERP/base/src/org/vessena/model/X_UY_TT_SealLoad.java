...
/** Generated Model for UY_TT_SealLoad
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_TT_SealLoad extends PO implements I_UY_TT_SealLoad, I_Persistent 
{
    ...
    public X_UY_TT_SealLoad (Properties ctx, int UY_TT_SealLoad_ID, String trxName)
    {
      super (ctx, UY_TT_SealLoad_ID, trxName);
      /** if (UY_TT_SealLoad_ID == 0)
        {
			setAD_User_ID (0);
			setC_DocType_ID (0);
...
// DR
    ...
    /** Load Constructor */
    public X_UY_TT_SealLoad (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_TT_SealLoad[")
	...
	public void setUY_TT_SealLoad_ID (int UY_TT_SealLoad_ID)
	{
		if (UY_TT_SealLoad_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_TT_SealLoad_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_TT_SealLoad_ID, Integer.valueOf(UY_TT_SealLoad_ID));
	}
