...
/** Generated Model for UY_AsignaTransporteHdr
 *  @author Adempiere (generated) 
 *  @version Release 3.5.4a - $Id$ */
public class X_UY_AsignaTransporteHdr extends PO implements I_UY_AsignaTransporteHdr, I_Persistent 
{
    ...
    public X_UY_AsignaTransporteHdr (Properties ctx, int UY_AsignaTransporteHdr_ID, String trxName)
    {
      super (ctx, UY_AsignaTransporteHdr_ID, trxName);
      /** if (UY_AsignaTransporteHdr_ID == 0)
        {
			setC_DocType_ID (0);
...
// 'DR'
    ...
    /** Load Constructor */
    public X_UY_AsignaTransporteHdr (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_AsignaTransporteHdr[")
