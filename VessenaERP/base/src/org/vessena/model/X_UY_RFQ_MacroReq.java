...
/** Generated Model for UY_RFQ_MacroReq
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_RFQ_MacroReq extends PO implements I_UY_RFQ_MacroReq, I_Persistent 
{
    ...
    public X_UY_RFQ_MacroReq (Properties ctx, int UY_RFQ_MacroReq_ID, String trxName)
    {
      super (ctx, UY_RFQ_MacroReq_ID, trxName);
      /** if (UY_RFQ_MacroReq_ID == 0)
        {
...
// DR
    ...
    /** Load Constructor */
    public X_UY_RFQ_MacroReq (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_RFQ_MacroReq[")
	...
	public void setUY_RFQ_MacroReq_ID (int UY_RFQ_MacroReq_ID)
	{
		if (UY_RFQ_MacroReq_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_RFQ_MacroReq_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_RFQ_MacroReq_ID, Integer.valueOf(UY_RFQ_MacroReq_ID));
	}
