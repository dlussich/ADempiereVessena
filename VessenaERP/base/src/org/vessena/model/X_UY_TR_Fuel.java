...
/** Generated Model for UY_TR_Fuel
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_TR_Fuel extends PO implements I_UY_TR_Fuel, I_Persistent 
{
    ...
    public X_UY_TR_Fuel (Properties ctx, int UY_TR_Fuel_ID, String trxName)
    {
...
// CR
    ...
    /** Load Constructor */
    public X_UY_TR_Fuel (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_TR_Fuel[")
	...
	{
		if (UY_TR_Fuel_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_TR_Fuel_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_TR_Fuel_ID, Integer.valueOf(UY_TR_Fuel_ID));
	}
