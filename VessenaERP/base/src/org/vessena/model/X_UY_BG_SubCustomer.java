...
/** Generated Model for UY_BG_SubCustomer
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_BG_SubCustomer extends PO implements I_UY_BG_SubCustomer, I_Persistent 
{
    ...
    public X_UY_BG_SubCustomer (Properties ctx, int UY_BG_SubCustomer_ID, String trxName)
    {
      super (ctx, UY_BG_SubCustomer_ID, trxName);
      /** if (UY_BG_SubCustomer_ID == 0)
        {
			setIsSmartPhone1 (false);
			setIsSmartPhone2 (false);
			setName (null);
			setUY_BG_Customer_ID (0);
			setUY_BG_SubCustomer_ID (0);
			setValue (null);
        } */
    }

    /** Load Constructor */
    public X_UY_BG_SubCustomer (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_BG_SubCustomer[")
	...
	public void setUY_BG_SubCustomer_ID (int UY_BG_SubCustomer_ID)
	{
		if (UY_BG_SubCustomer_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_BG_SubCustomer_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_BG_SubCustomer_ID, Integer.valueOf(UY_BG_SubCustomer_ID));
	}
