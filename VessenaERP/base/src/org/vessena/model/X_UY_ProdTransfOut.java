...
/** Generated Model for UY_ProdTransfOut
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_ProdTransfOut extends PO implements I_UY_ProdTransfOut, I_Persistent 
{
    ...
    public X_UY_ProdTransfOut (Properties ctx, int UY_ProdTransfOut_ID, String trxName)
    {
      super (ctx, UY_ProdTransfOut_ID, trxName);
      /** if (UY_ProdTransfOut_ID == 0)
        {
			setC_UOM_ID (0);
...
// 1
			...
			setUY_ProdTransfOut_ID (0);
			setValue (null);
        } */
    }

    /** Load Constructor */
    public X_UY_ProdTransfOut (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_ProdTransfOut[")
	...
	/** Set UY_ProdTransfOut.
		@param UY_ProdTransfOut_ID UY_ProdTransfOut	  */
	public void setUY_ProdTransfOut_ID (int UY_ProdTransfOut_ID)
	{
		if (UY_ProdTransfOut_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_ProdTransfOut_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_ProdTransfOut_ID, Integer.valueOf(UY_ProdTransfOut_ID));
	}

	/** Get UY_ProdTransfOut.
		@return UY_ProdTransfOut	  */
	public int getUY_ProdTransfOut_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_ProdTransfOut_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
