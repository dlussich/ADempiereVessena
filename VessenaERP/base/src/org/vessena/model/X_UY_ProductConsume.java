...
/** Generated Model for UY_ProductConsume
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_ProductConsume extends PO implements I_UY_ProductConsume, I_Persistent 
{
    ...
    public X_UY_ProductConsume (Properties ctx, int UY_ProductConsume_ID, String trxName)
    {
      super (ctx, UY_ProductConsume_ID, trxName);
      /** if (UY_ProductConsume_ID == 0)
        {
			setAD_User_ID (0);
			setC_DocType_ID (0);
...
// N
    ...
    /** Load Constructor */
    public X_UY_ProductConsume (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_ProductConsume[")
	...
	public void setUY_ProductConsume_ID (int UY_ProductConsume_ID)
	{
		if (UY_ProductConsume_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_ProductConsume_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_ProductConsume_ID, Integer.valueOf(UY_ProductConsume_ID));
	}
