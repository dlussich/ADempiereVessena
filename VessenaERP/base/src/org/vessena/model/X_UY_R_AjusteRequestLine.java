...
/** Generated Model for UY_R_AjusteRequestLine
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_R_AjusteRequestLine extends PO implements I_UY_R_AjusteRequestLine, I_Persistent 
{
    ...
    public X_UY_R_AjusteRequestLine (Properties ctx, int UY_R_AjusteRequestLine_ID, String trxName)
    {
      super (ctx, UY_R_AjusteRequestLine_ID, trxName);
      /** if (UY_R_AjusteRequestLine_ID == 0)
        {
			setAccountNo (null);
			setCedula (null);
			setUY_R_AjusteRequest_ID (0);
			setUY_R_AjusteRequestLine_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_R_AjusteRequestLine (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_R_AjusteRequestLine[")
	...
	public void setUY_R_AjusteRequestLine_ID (int UY_R_AjusteRequestLine_ID)
	{
		if (UY_R_AjusteRequestLine_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_R_AjusteRequestLine_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_R_AjusteRequestLine_ID, Integer.valueOf(UY_R_AjusteRequestLine_ID));
	}
