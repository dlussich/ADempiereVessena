...
/** Generated Model for UY_TT_PrintVale
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_TT_PrintVale extends PO implements I_UY_TT_PrintVale, I_Persistent 
{
    ...
    public X_UY_TT_PrintVale (Properties ctx, int UY_TT_PrintVale_ID, String trxName)
    {
      super (ctx, UY_TT_PrintVale_ID, trxName);
      /** if (UY_TT_PrintVale_ID == 0)
        {
			setC_DocType_ID (0);
			setDocAction (null);
// AY
...
// DR
    ...
    /** Load Constructor */
    public X_UY_TT_PrintVale (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_TT_PrintVale[")
	...
	public void setUY_TT_PrintVale_ID (int UY_TT_PrintVale_ID)
	{
		if (UY_TT_PrintVale_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_TT_PrintVale_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_TT_PrintVale_ID, Integer.valueOf(UY_TT_PrintVale_ID));
	}
