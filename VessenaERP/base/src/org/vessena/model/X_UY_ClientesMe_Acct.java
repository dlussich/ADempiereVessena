...
/** Generated Model for UY_ClientesMe_Acct
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_ClientesMe_Acct extends PO implements I_UY_ClientesMe_Acct, I_Persistent 
{
    ...
    public X_UY_ClientesMe_Acct (Properties ctx, int UY_ClientesMe_Acct_ID, String trxName)
    {
      super (ctx, UY_ClientesMe_Acct_ID, trxName);
      /** if (UY_ClientesMe_Acct_ID == 0)
        {
			setC_AcctSchema_ID (0);
			setC_BPartner_ID (0);
			setC_Currency_ID (0);
			setUY_ClientesMe_Acct_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_ClientesMe_Acct (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_ClientesMe_Acct[")
	...
	/** Set UY_ClientesMe_Acct.
		@param UY_ClientesMe_Acct_ID UY_ClientesMe_Acct	  */
	public void setUY_ClientesMe_Acct_ID (int UY_ClientesMe_Acct_ID)
	{
		if (UY_ClientesMe_Acct_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_ClientesMe_Acct_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_ClientesMe_Acct_ID, Integer.valueOf(UY_ClientesMe_Acct_ID));
	}

	/** Get UY_ClientesMe_Acct.
		@return UY_ClientesMe_Acct	  */
	public int getUY_ClientesMe_Acct_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_ClientesMe_Acct_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
