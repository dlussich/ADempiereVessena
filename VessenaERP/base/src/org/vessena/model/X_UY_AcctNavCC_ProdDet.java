...
/** Generated Model for UY_AcctNavCC_ProdDet
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_AcctNavCC_ProdDet extends PO implements I_UY_AcctNavCC_ProdDet, I_Persistent 
{
    ...
    public X_UY_AcctNavCC_ProdDet (Properties ctx, int UY_AcctNavCC_ProdDet_ID, String trxName)
    {
      super (ctx, UY_AcctNavCC_ProdDet_ID, trxName);
      /** if (UY_AcctNavCC_ProdDet_ID == 0)
        {
			setC_BPartner_ID (0);
			setM_Product_ID (0);
			...
			setUY_AcctNavCC_ProdDet_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_AcctNavCC_ProdDet (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_AcctNavCC_ProdDet[")
	...
	/** Set UY_AcctNavCC_ProdDet.
		@param UY_AcctNavCC_ProdDet_ID UY_AcctNavCC_ProdDet	  */
	public void setUY_AcctNavCC_ProdDet_ID (int UY_AcctNavCC_ProdDet_ID)
	{
		if (UY_AcctNavCC_ProdDet_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_AcctNavCC_ProdDet_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_AcctNavCC_ProdDet_ID, Integer.valueOf(UY_AcctNavCC_ProdDet_ID));
	}

	/** Get UY_AcctNavCC_ProdDet.
		@return UY_AcctNavCC_ProdDet	  */
	public int getUY_AcctNavCC_ProdDet_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_AcctNavCC_ProdDet_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
    ...
    {
		return (I_UY_AcctNavCC_Prod)MTable.get(getCtx(), I_UY_AcctNavCC_Prod.Table_Name)
			.getPO(getUY_AcctNavCC_Prod_ID(), get_TrxName());	}
	...
	public void setUY_AcctNavCC_Prod_ID (int UY_AcctNavCC_Prod_ID)
	{
		if (UY_AcctNavCC_Prod_ID < 1) 
			set_Value (COLUMNNAME_UY_AcctNavCC_Prod_ID, null);
		else 
			set_Value (COLUMNNAME_UY_AcctNavCC_Prod_ID, Integer.valueOf(UY_AcctNavCC_Prod_ID));
	}
