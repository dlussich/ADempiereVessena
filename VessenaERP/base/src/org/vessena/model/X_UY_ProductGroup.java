...
/** Generated Model for UY_ProductGroup
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_ProductGroup extends PO implements I_UY_ProductGroup, I_Persistent 
{
    ...
    public X_UY_ProductGroup (Properties ctx, int UY_ProductGroup_ID, String trxName)
    {
      super (ctx, UY_ProductGroup_ID, trxName);
      /** if (UY_ProductGroup_ID == 0)
        {
			setName (null);
			setUY_Linea_Negocio_ID (0);
			setUY_ProductGroup_ID (0);
			setValue (null);
        } */
    }

    /** Load Constructor */
    public X_UY_ProductGroup (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_ProductGroup[")
	...
	public void setUY_ProductGroup_ID (int UY_ProductGroup_ID)
	{
		if (UY_ProductGroup_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_ProductGroup_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_ProductGroup_ID, Integer.valueOf(UY_ProductGroup_ID));
	}
