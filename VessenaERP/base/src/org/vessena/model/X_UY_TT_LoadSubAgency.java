...
/** Generated Model for UY_TT_LoadSubAgency
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_TT_LoadSubAgency extends PO implements I_UY_TT_LoadSubAgency, I_Persistent 
{
    ...
    public X_UY_TT_LoadSubAgency (Properties ctx, int UY_TT_LoadSubAgency_ID, String trxName)
    {
      super (ctx, UY_TT_LoadSubAgency_ID, trxName);
      /** if (UY_TT_LoadSubAgency_ID == 0)
        {
			setAD_User_ID (0);
			setC_DocType_ID (0);
...
// DR
    ...
    /** Load Constructor */
    public X_UY_TT_LoadSubAgency (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_TT_LoadSubAgency[")
	...
	/** LoadSubAgencyType AD_Reference_ID=1010384 */
	public static final int LOADSUBAGENCYTYPE_AD_Reference_ID=1010384;
	/** ENTREGA DE CUENTAS = ENTREGA */
	public static final String LOADSUBAGENCYTYPE_ENTREGADECUENTAS = "ENTREGA";
	/** RECEPCION EN SUBAGENCIA = RECEPCION */
	public static final String LOADSUBAGENCYTYPE_RECEPCIONENSUBAGENCIA = "RECEPCION";
	/** Set LoadSubAgencyType.
		@param LoadSubAgencyType LoadSubAgencyType	  */
	public void setLoadSubAgencyType (String LoadSubAgencyType)
	{

		set_Value (COLUMNNAME_LoadSubAgencyType, LoadSubAgencyType);
	}

	/** Get LoadSubAgencyType.
		@return LoadSubAgencyType	  */
	public String getLoadSubAgencyType () 
	{
		return (String)get_Value(COLUMNNAME_LoadSubAgencyType);
	}
	...
	public void setUY_TT_LoadSubAgency_ID (int UY_TT_LoadSubAgency_ID)
	{
		if (UY_TT_LoadSubAgency_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_TT_LoadSubAgency_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_TT_LoadSubAgency_ID, Integer.valueOf(UY_TT_LoadSubAgency_ID));
	}
