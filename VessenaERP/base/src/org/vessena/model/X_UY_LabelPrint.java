...
/** Generated Model for UY_LabelPrint
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_LabelPrint extends PO implements I_UY_LabelPrint, I_Persistent 
{
    ...
    public X_UY_LabelPrint (Properties ctx, int UY_LabelPrint_ID, String trxName)
    {
      super (ctx, UY_LabelPrint_ID, trxName);
      /** if (UY_LabelPrint_ID == 0)
        {
			setC_DocType_ID (0);
...
// DR
    ...
    /** Load Constructor */
    public X_UY_LabelPrint (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_LabelPrint[")
	...
	/** Set labelprinttype.
		@param labelprinttype labelprinttype	  */
	public void setlabelprinttype (String labelprinttype)
	{
		set_Value (COLUMNNAME_labelprinttype, labelprinttype);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_labelprinttype);
	}
	...
	public void setUY_LabelPrint_ID (int UY_LabelPrint_ID)
	{
		if (UY_LabelPrint_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_LabelPrint_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_LabelPrint_ID, Integer.valueOf(UY_LabelPrint_ID));
	}
