...
/** Generated Model for UY_TT_SealLoadBox
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_TT_SealLoadBox extends PO implements I_UY_TT_SealLoadBox, I_Persistent 
{
    ...
    public X_UY_TT_SealLoadBox (Properties ctx, int UY_TT_SealLoadBox_ID, String trxName)
    {
      super (ctx, UY_TT_SealLoadBox_ID, trxName);
      /** if (UY_TT_SealLoadBox_ID == 0)
        {
			setUY_TT_SealLoadBox_ID (0);
			setUY_TT_SealLoad_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_TT_SealLoadBox (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_TT_SealLoadBox[")
	...
	/** Set UY_TT_SealLoadBox.
		@param UY_TT_SealLoadBox_ID UY_TT_SealLoadBox	  */
	public void setUY_TT_SealLoadBox_ID (int UY_TT_SealLoadBox_ID)
	{
		if (UY_TT_SealLoadBox_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_TT_SealLoadBox_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_TT_SealLoadBox_ID, Integer.valueOf(UY_TT_SealLoadBox_ID));
	}

	/** Get UY_TT_SealLoadBox.
		@return UY_TT_SealLoadBox	  */
	public int getUY_TT_SealLoadBox_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_TT_SealLoadBox_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
