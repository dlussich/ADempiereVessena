...
/** Generated Model for UY_TR_Clearing
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_TR_Clearing extends PO implements I_UY_TR_Clearing, I_Persistent 
{
    ...
    public X_UY_TR_Clearing (Properties ctx, int UY_TR_Clearing_ID, String trxName)
    {
      super (ctx, UY_TR_Clearing_ID, trxName);
      /** if (UY_TR_Clearing_ID == 0)
        {
			setC_Currency_ID (0);
			setC_DocType_ID (0);
...
// N
    ...
    /** Load Constructor */
    public X_UY_TR_Clearing (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_TR_Clearing[")
	...
	/** Set C_Currency3_ID.
		@param C_Currency3_ID C_Currency3_ID	  */
	public void setC_Currency3_ID (int C_Currency3_ID)
	{
		if (C_Currency3_ID < 1) 
			set_Value (COLUMNNAME_C_Currency3_ID, null);
		else 
			set_Value (COLUMNNAME_C_Currency3_ID, Integer.valueOf(C_Currency3_ID));
	}

	/** Get C_Currency3_ID.
		@return C_Currency3_ID	  */
	public int getC_Currency3_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_C_Currency3_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set DifferenceAmt2.
		@param DifferenceAmt2 DifferenceAmt2	  */
	...
	/** Set ExpenseAmt2.
		@param ExpenseAmt2 ExpenseAmt2	  */
	public void setExpenseAmt2 (BigDecimal ExpenseAmt2)
	{
		set_Value (COLUMNNAME_ExpenseAmt2, ExpenseAmt2);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_ExpenseAmt2);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	/** Set SaldoAnterior2.
		@param SaldoAnterior2 SaldoAnterior2	  */
	public void setSaldoAnterior2 (BigDecimal SaldoAnterior2)
	{
		set_Value (COLUMNNAME_SaldoAnterior2, SaldoAnterior2);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_SaldoAnterior2);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	public void setUY_TR_Clearing_ID (int UY_TR_Clearing_ID)
	{
		if (UY_TR_Clearing_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_TR_Clearing_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_TR_Clearing_ID, Integer.valueOf(UY_TR_Clearing_ID));
	}
