...
/** Generated Model for UY_MB_StoreLOCrew
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_MB_StoreLOCrew extends PO implements I_UY_MB_StoreLOCrew, I_Persistent 
{
    ...
    public X_UY_MB_StoreLOCrew (Properties ctx, int UY_MB_StoreLOCrew_ID, String trxName)
    {
      super (ctx, UY_MB_StoreLOCrew_ID, trxName);
      /** if (UY_MB_StoreLOCrew_ID == 0)
        {
			setAD_User_ID (0);
			setUY_MB_StoreLoadOrderWay_ID (0);
			setUY_MB_StoreLOCrew_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_MB_StoreLOCrew (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_MB_StoreLOCrew[")
	...
	/** Set UY_MB_StoreLOCrew.
		@param UY_MB_StoreLOCrew_ID UY_MB_StoreLOCrew	  */
	public void setUY_MB_StoreLOCrew_ID (int UY_MB_StoreLOCrew_ID)
	{
		if (UY_MB_StoreLOCrew_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_MB_StoreLOCrew_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_MB_StoreLOCrew_ID, Integer.valueOf(UY_MB_StoreLOCrew_ID));
	}

	/** Get UY_MB_StoreLOCrew.
		@return UY_MB_StoreLOCrew	  */
	public int getUY_MB_StoreLOCrew_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_MB_StoreLOCrew_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
