...
/** Generated Model for UY_HRAportesPatronales
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_UY_HRAportesPatronales extends PO implements I_UY_HRAportesPatronales, I_Persistent 
{
    ...
    public X_UY_HRAportesPatronales (Properties ctx, int UY_HRAportesPatronales_ID, String trxName)
    {
      super (ctx, UY_HRAportesPatronales_ID, trxName);
      /** if (UY_HRAportesPatronales_ID == 0)
        {
			setC_DocType_ID (0);
...
// N
    ...
    /** Load Constructor */
    public X_UY_HRAportesPatronales (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_HRAportesPatronales[")
	...
	public void setUY_HRAportesPatronales_ID (int UY_HRAportesPatronales_ID)
	{
		if (UY_HRAportesPatronales_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_HRAportesPatronales_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_HRAportesPatronales_ID, Integer.valueOf(UY_HRAportesPatronales_ID));
	}
