...
/** Generated Model for UY_TT_Retention
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_TT_Retention extends PO implements I_UY_TT_Retention, I_Persistent 
{
    ...
    public X_UY_TT_Retention (Properties ctx, int UY_TT_Retention_ID, String trxName)
    {
      super (ctx, UY_TT_Retention_ID, trxName);
      /** if (UY_TT_Retention_ID == 0)
        {
			setAD_User_ID (0);
			setC_DocType_ID (0);
...
// DR
    ...
    /** Load Constructor */
    public X_UY_TT_Retention (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_TT_Retention[")
	...
	public void setUY_TT_Retention_ID (int UY_TT_Retention_ID)
	{
		if (UY_TT_Retention_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_TT_Retention_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_TT_Retention_ID, Integer.valueOf(UY_TT_Retention_ID));
	}
