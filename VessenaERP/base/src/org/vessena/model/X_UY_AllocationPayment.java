...
/** Generated Model for UY_AllocationPayment
 *  @author Adempiere (generated) 
 *  @version Release 3.5.4a - $Id$ */
public class X_UY_AllocationPayment extends PO implements I_UY_AllocationPayment, I_Persistent 
{
    ...
    public X_UY_AllocationPayment (Properties ctx, int UY_AllocationPayment_ID, String trxName)
    {
      super (ctx, UY_AllocationPayment_ID, trxName);
      /** if (UY_AllocationPayment_ID == 0)
        {
...
// N
    ...
    /** Load Constructor */
    public X_UY_AllocationPayment (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_AllocationPayment[")
	...
	public void setUY_AllocationPayment_ID (int UY_AllocationPayment_ID)
	{
		if (UY_AllocationPayment_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_AllocationPayment_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_AllocationPayment_ID, Integer.valueOf(UY_AllocationPayment_ID));
	}
