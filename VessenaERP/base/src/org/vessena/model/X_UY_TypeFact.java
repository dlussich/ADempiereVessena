...
/** Generated Model for UY_TypeFact
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_TypeFact extends PO implements I_UY_TypeFact, I_Persistent 
{
    ...
    public X_UY_TypeFact (Properties ctx, int UY_TypeFact_ID, String trxName)
    {
...
// DR
    ...
    /** Load Constructor */
    public X_UY_TypeFact (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_TypeFact[")
	...
	/** Set C_DocType_ID_2.
		@param C_DocType_ID_2 C_DocType_ID_2	  */
	public void setC_DocType_ID_2 (int C_DocType_ID_2)
	{
		set_Value (COLUMNNAME_C_DocType_ID_2, Integer.valueOf(C_DocType_ID_2));
	}

	/** Get C_DocType_ID_2.
		@return C_DocType_ID_2	  */
	public int getC_DocType_ID_2 () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_C_DocType_ID_2);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	{
		if (UY_TypeFact_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_TypeFact_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_TypeFact_ID, Integer.valueOf(UY_TypeFact_ID));
	}
