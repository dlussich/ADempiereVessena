...
/** Generated Model for Cov_Ticket_LineLuncheon
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_Cov_Ticket_LineLuncheon extends PO implements I_Cov_Ticket_LineLuncheon, I_Persistent 
{
    ...
    public X_Cov_Ticket_LineLuncheon (Properties ctx, int Cov_Ticket_LineLuncheon_ID, String trxName)
    {
      super (ctx, Cov_Ticket_LineLuncheon_ID, trxName);
      /** if (Cov_Ticket_LineLuncheon_ID == 0)
        {
			setCov_Ticket_LineLuncheon_ID (0);
        } */
    }

    /** Load Constructor */
    public X_Cov_Ticket_LineLuncheon (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Cov_Ticket_LineLuncheon[")
	...
	/** Set Cov_Ticket_LineLuncheon.
		@param Cov_Ticket_LineLuncheon_ID Cov_Ticket_LineLuncheon	  */
	public void setCov_Ticket_LineLuncheon_ID (int Cov_Ticket_LineLuncheon_ID)
	{
		if (Cov_Ticket_LineLuncheon_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Cov_Ticket_LineLuncheon_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Cov_Ticket_LineLuncheon_ID, Integer.valueOf(Cov_Ticket_LineLuncheon_ID));
	}

	/** Get Cov_Ticket_LineLuncheon.
		@return Cov_Ticket_LineLuncheon	  */
	public int getCov_Ticket_LineLuncheon_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_Cov_Ticket_LineLuncheon_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
