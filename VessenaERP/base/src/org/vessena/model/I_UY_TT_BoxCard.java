...
/** Generated Interface for UY_TT_BoxCard
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC
 */
public interface I_UY_TT_BoxCard 
{

    /** TableName=UY_TT_BoxCard */
    public static final String Table_Name = "UY_TT_BoxCard";
    ...
    /** Column name UY_TT_BoxCard_ID */
    public static final String COLUMNNAME_UY_TT_BoxCard_ID = "UY_TT_BoxCard_ID";

	/** Set UY_TT_BoxCard	  */
	public void setUY_TT_BoxCard_ID (int UY_TT_BoxCard_ID);

	/** Get UY_TT_BoxCard	  */
	public int getUY_TT_BoxCard_ID();
