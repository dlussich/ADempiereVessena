...
/** Generated Model for UY_Gerencial_Prod
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_Gerencial_Prod extends PO implements I_UY_Gerencial_Prod, I_Persistent 
{
    ...
    public X_UY_Gerencial_Prod (Properties ctx, int UY_Gerencial_Prod_ID, String trxName)
    {
      super (ctx, UY_Gerencial_Prod_ID, trxName);
      /** if (UY_Gerencial_Prod_ID == 0)
        {
			setC_BPartner_ID (0);
			setM_Product_ID (0);
			...
			setUY_Gerencial_Prod_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_Gerencial_Prod (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_Gerencial_Prod[")
	...
	public I_UY_Gerencial_BP getUY_Gerencial_BP() throws RuntimeException
    {
		return (I_UY_Gerencial_BP)MTable.get(getCtx(), I_UY_Gerencial_BP.Table_Name)
			.getPO(getUY_Gerencial_BP_ID(), get_TrxName());	}

	/** Set UY_Gerencial_BP.
		@param UY_Gerencial_BP_ID UY_Gerencial_BP	  */
	public void setUY_Gerencial_BP_ID (int UY_Gerencial_BP_ID)
	{
		if (UY_Gerencial_BP_ID < 1) 
			set_Value (COLUMNNAME_UY_Gerencial_BP_ID, null);
		else 
			set_Value (COLUMNNAME_UY_Gerencial_BP_ID, Integer.valueOf(UY_Gerencial_BP_ID));
	}

	/** Get UY_Gerencial_BP.
		@return UY_Gerencial_BP	  */
	public int getUY_Gerencial_BP_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_Gerencial_BP_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	public void setUY_Gerencial_Prod_ID (int UY_Gerencial_Prod_ID)
	{
		if (UY_Gerencial_Prod_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_Gerencial_Prod_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_Gerencial_Prod_ID, Integer.valueOf(UY_Gerencial_Prod_ID));
	}
