...
/** Generated Model for UY_CFE_Inbox
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_CFE_Inbox extends PO implements I_UY_CFE_Inbox, I_Persistent 
{
    ...
    public X_UY_CFE_Inbox (Properties ctx, int UY_CFE_Inbox_ID, String trxName)
    {
      super (ctx, UY_CFE_Inbox_ID, trxName);
      /** if (UY_CFE_Inbox_ID == 0)
        {
			setC_DocType_ID (0);
...
// DR
    ...
    /** Load Constructor */
    public X_UY_CFE_Inbox (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_CFE_Inbox[")
	...
	/** Set ExecuteAction5.
		@param ExecuteAction5 ExecuteAction5	  */
	public void setExecuteAction5 (String ExecuteAction5)
	{
		set_Value (COLUMNNAME_ExecuteAction5, ExecuteAction5);
	}

	/** Get ExecuteAction5.
		@return ExecuteAction5	  */
	public String getExecuteAction5 () 
	{
		return (String)get_Value(COLUMNNAME_ExecuteAction5);
	}
	...
	public void setUY_CFE_Inbox_ID (int UY_CFE_Inbox_ID)
	{
		if (UY_CFE_Inbox_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_CFE_Inbox_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_CFE_Inbox_ID, Integer.valueOf(UY_CFE_Inbox_ID));
	}
