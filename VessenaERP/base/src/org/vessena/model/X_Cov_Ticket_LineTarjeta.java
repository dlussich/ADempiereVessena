...
/** Generated Model for Cov_Ticket_LineTarjeta
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_Cov_Ticket_LineTarjeta extends PO implements I_Cov_Ticket_LineTarjeta, I_Persistent 
{
    ...
    public X_Cov_Ticket_LineTarjeta (Properties ctx, int Cov_Ticket_LineTarjeta_ID, String trxName)
    {
      super (ctx, Cov_Ticket_LineTarjeta_ID, trxName);
      /** if (Cov_Ticket_LineTarjeta_ID == 0)
        {
			setCov_Ticket_LineTarjeta_ID (0);
        } */
    }

    /** Load Constructor */
    public X_Cov_Ticket_LineTarjeta (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Cov_Ticket_LineTarjeta[")
	...
	/** Set Cov_Ticket_LineTarjeta.
		@param Cov_Ticket_LineTarjeta_ID Cov_Ticket_LineTarjeta	  */
	public void setCov_Ticket_LineTarjeta_ID (int Cov_Ticket_LineTarjeta_ID)
	{
		if (Cov_Ticket_LineTarjeta_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Cov_Ticket_LineTarjeta_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Cov_Ticket_LineTarjeta_ID, Integer.valueOf(Cov_Ticket_LineTarjeta_ID));
	}

	/** Get Cov_Ticket_LineTarjeta.
		@return Cov_Ticket_LineTarjeta	  */
	public int getCov_Ticket_LineTarjeta_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_Cov_Ticket_LineTarjeta_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
