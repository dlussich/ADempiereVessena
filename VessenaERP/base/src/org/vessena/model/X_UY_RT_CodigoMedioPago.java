...
/** Generated Model for UY_RT_CodigoMedioPago
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_RT_CodigoMedioPago extends PO implements I_UY_RT_CodigoMedioPago, I_Persistent 
{
    ...
    public X_UY_RT_CodigoMedioPago (Properties ctx, int UY_RT_CodigoMedioPago_ID, String trxName)
    {
      super (ctx, UY_RT_CodigoMedioPago_ID, trxName);
      /** if (UY_RT_CodigoMedioPago_ID == 0)
        {
			setName (null);
			setUY_RT_CodigoMedioPago_ID (0);
			setValue (null);
        } */
    }

    /** Load Constructor */
    public X_UY_RT_CodigoMedioPago (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_RT_CodigoMedioPago[")
	...
	public void setUY_RT_CodigoMedioPago_ID (int UY_RT_CodigoMedioPago_ID)
	{
		if (UY_RT_CodigoMedioPago_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_RT_CodigoMedioPago_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_RT_CodigoMedioPago_ID, Integer.valueOf(UY_RT_CodigoMedioPago_ID));
	}
