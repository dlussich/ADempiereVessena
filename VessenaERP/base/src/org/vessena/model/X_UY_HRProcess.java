...
/** Generated Model for UY_HRProcess
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_UY_HRProcess extends PO implements I_UY_HRProcess, I_Persistent 
{
    ...
    public X_UY_HRProcess (Properties ctx, int UY_HRProcess_ID, String trxName)
    {
      super (ctx, UY_HRProcess_ID, trxName);
      /** if (UY_HRProcess_ID == 0)
        {
...
// N
    ...
    /** Load Constructor */
    public X_UY_HRProcess (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_HRProcess[")
	...
	public void setUY_HRProcess_ID (int UY_HRProcess_ID)
	{
		if (UY_HRProcess_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_HRProcess_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_HRProcess_ID, Integer.valueOf(UY_HRProcess_ID));
	}
