...
/** Generated Model for UY_YearEnd
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_UY_YearEnd extends PO implements I_UY_YearEnd, I_Persistent 
{
    ...
    public X_UY_YearEnd (Properties ctx, int UY_YearEnd_ID, String trxName)
    {
...
// DR
			setDocumentNo (null);
			setProcessed (false);
			setProcessIntegral (false);
			setUY_YearEnd_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_YearEnd (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_YearEnd[")
	...
	/** Set ProcessIntegral.
		@param ProcessIntegral ProcessIntegral	  */
	public void setProcessIntegral (boolean ProcessIntegral)
	{
		set_Value (COLUMNNAME_ProcessIntegral, Boolean.valueOf(ProcessIntegral));
	}

	/** Get ProcessIntegral.
		@return ProcessIntegral	  */
	public boolean isProcessIntegral () 
	{
		Object oo = get_Value(COLUMNNAME_ProcessIntegral);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	{
		if (UY_YearEnd_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_YearEnd_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_YearEnd_ID, Integer.valueOf(UY_YearEnd_ID));
	}
