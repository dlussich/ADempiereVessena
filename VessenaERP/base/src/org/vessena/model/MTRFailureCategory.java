 ...
 *
 */
public class MTRFailureCategory extends X_UY_TR_FailureCategory {

	/**
	 * 
	 */
	private static final long serialVersionUID = -458052176352808539L;

	/**
	 * @param ctx
	 * @param UY_TR_FailureCategory_ID
	 * @param trxName
	 */
	public MTRFailureCategory(Properties ctx, int UY_TR_FailureCategory_ID,
			String trxName) {
	 ...
	 * @param trxName
	 */
	public MTRFailureCategory(Properties ctx, ResultSet rs, String trxName) {
