...
/** Generated Interface for UY_ValidacionCampos
 *  @author Adempiere (generated) 
 *  @version Release 3.5.4a
 */
public interface I_UY_ValidacionCampos 
{

    /** TableName=UY_ValidacionCampos */
    public static final String Table_Name = "UY_ValidacionCampos";
    ...
    /** Column name uy_c_bank_iscaja_id */
    public static final String COLUMNNAME_uy_c_bank_iscaja_id = "uy_c_bank_iscaja_id";
    ...
    /** Column name uy_c_bank_iscajame_id */
    public static final String COLUMNNAME_uy_c_bank_iscajame_id = "uy_c_bank_iscajame_id";
    ...
    /** Column name uy_c_bank_iscajamn_id */
    public static final String COLUMNNAME_uy_c_bank_iscajamn_id = "uy_c_bank_iscajamn_id";
    ...
    /** Column name uy_c_bankaccount_propio_id */
    public static final String COLUMNNAME_uy_c_bankaccount_propio_id = "uy_c_bankaccount_propio_id";
    ...
    /** Column name uy_c_bankaccount_propiome_id */
    public static final String COLUMNNAME_uy_c_bankaccount_propiome_id = "uy_c_bankaccount_propiome_id";
    ...
    /** Column name uy_c_bankaccount_propiomn_id */
    public static final String COLUMNNAME_uy_c_bankaccount_propiomn_id = "uy_c_bankaccount_propiomn_id";
    ...
    /** Column name uy_c_bankaccount_terceros_id */
    public static final String COLUMNNAME_uy_c_bankaccount_terceros_id = "uy_c_bankaccount_terceros_id";
    ...
    /** Column name uy_c_bankaccount_tercerosme_id */
    public static final String COLUMNNAME_uy_c_bankaccount_tercerosme_id = "uy_c_bankaccount_tercerosme_id";
    ...
    /** Column name uy_c_bankaccount_tercerosmn_id */
    public static final String COLUMNNAME_uy_c_bankaccount_tercerosmn_id = "uy_c_bankaccount_tercerosmn_id";
    ...
    /** Column name UY_ValidacionCampos_ID */
    public static final String COLUMNNAME_UY_ValidacionCampos_ID = "UY_ValidacionCampos_ID";
