...
/** Generated Model for UY_TT_RetPrintValeCard
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_TT_RetPrintValeCard extends PO implements I_UY_TT_RetPrintValeCard, I_Persistent 
{
    ...
    public X_UY_TT_RetPrintValeCard (Properties ctx, int UY_TT_RetPrintValeCard_ID, String trxName)
    {
      super (ctx, UY_TT_RetPrintValeCard_ID, trxName);
      /** if (UY_TT_RetPrintValeCard_ID == 0)
        {
			setDateTrx (new Timestamp( System.currentTimeMillis() ));
			setIsRetained (false);
			setIsValid (false);
			setScanText (null);
			setUY_TT_RetPrintValeCard_ID (0);
			setUY_TT_RetPrintVale_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_TT_RetPrintValeCard (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_TT_RetPrintValeCard[")
	...
	/** Set UY_TT_RetPrintValeCard.
		@param UY_TT_RetPrintValeCard_ID UY_TT_RetPrintValeCard	  */
	public void setUY_TT_RetPrintValeCard_ID (int UY_TT_RetPrintValeCard_ID)
	{
		if (UY_TT_RetPrintValeCard_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_TT_RetPrintValeCard_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_TT_RetPrintValeCard_ID, Integer.valueOf(UY_TT_RetPrintValeCard_ID));
	}

	/** Get UY_TT_RetPrintValeCard.
		@return UY_TT_RetPrintValeCard	  */
	public int getUY_TT_RetPrintValeCard_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_TT_RetPrintValeCard_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
