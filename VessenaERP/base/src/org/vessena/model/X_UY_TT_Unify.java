...
/** Generated Model for UY_TT_Unify
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_TT_Unify extends PO implements I_UY_TT_Unify, I_Persistent 
{
    ...
    public X_UY_TT_Unify (Properties ctx, int UY_TT_Unify_ID, String trxName)
    {
...
// DR
    ...
    /** Load Constructor */
    public X_UY_TT_Unify (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_TT_Unify[")
	...
	{
		if (UY_TT_Unify_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_TT_Unify_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_TT_Unify_ID, Integer.valueOf(UY_TT_Unify_ID));
	}
