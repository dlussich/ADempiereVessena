...
/** Generated Model for UY_RecuentoDef
 *  @author Adempiere (generated) 
 *  @version Release 3.5.4a - $Id$ */
public class X_UY_RecuentoDef extends PO implements I_UY_RecuentoDef, I_Persistent 
{
    ...
    public X_UY_RecuentoDef (Properties ctx, int UY_RecuentoDef_ID, String trxName)
    {
      super (ctx, UY_RecuentoDef_ID, trxName);
      /** if (UY_RecuentoDef_ID == 0)
        {
			setC_DocType_ID (0);
// @SQL=(SELECT C_DocType_ID FROM C_DocType WHERE C_DocType.DocBaseType='REC')
...
// 0
    ...
    /** Load Constructor */
    public X_UY_RecuentoDef (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_RecuentoDef[")
	...
	{
		set_ValueNoCheck (COLUMNNAME_porcento, Integer.valueOf(porcento));
	}
