...
/** Generated Model for UY_TR_MarkModel
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_UY_TR_MarkModel extends PO implements I_UY_TR_MarkModel, I_Persistent 
{
    ...
    public X_UY_TR_MarkModel (Properties ctx, int UY_TR_MarkModel_ID, String trxName)
    {
      super (ctx, UY_TR_MarkModel_ID, trxName);
      /** if (UY_TR_MarkModel_ID == 0)
        {
			setName (null);
			setUY_TR_Mark_ID (0);
			setUY_TR_MarkModel_ID (0);
			setValue (null);
        } */
    }

    /** Load Constructor */
    public X_UY_TR_MarkModel (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_TR_MarkModel[")
	...
	public void setUY_TR_MarkModel_ID (int UY_TR_MarkModel_ID)
	{
		if (UY_TR_MarkModel_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_TR_MarkModel_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_TR_MarkModel_ID, Integer.valueOf(UY_TR_MarkModel_ID));
	}
