...
/** Generated Model for UY_TR_ClearingTruck
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_TR_ClearingTruck extends PO implements I_UY_TR_ClearingTruck, I_Persistent 
{
    ...
    public X_UY_TR_ClearingTruck (Properties ctx, int UY_TR_ClearingTruck_ID, String trxName)
    {
      super (ctx, UY_TR_ClearingTruck_ID, trxName);
      /** if (UY_TR_ClearingTruck_ID == 0)
        {
			setUY_TR_Clearing_ID (0);
			setUY_TR_ClearingTruck_ID (0);
			setUY_TR_Truck_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_TR_ClearingTruck (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_TR_ClearingTruck[")
	...
	public void setUY_TR_ClearingTruck_ID (int UY_TR_ClearingTruck_ID)
	{
		if (UY_TR_ClearingTruck_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_TR_ClearingTruck_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_TR_ClearingTruck_ID, Integer.valueOf(UY_TR_ClearingTruck_ID));
	}
