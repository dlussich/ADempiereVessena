...
/** Generated Model for UY_Devengamiento
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_Devengamiento extends PO implements I_UY_Devengamiento, I_Persistent 
{
    ...
    public X_UY_Devengamiento (Properties ctx, int UY_Devengamiento_ID, String trxName)
    {
      super (ctx, UY_Devengamiento_ID, trxName);
      /** if (UY_Devengamiento_ID == 0)
        {
			setC_DocType_ID (0);
...
// N
    ...
    /** Load Constructor */
    public X_UY_Devengamiento (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_Devengamiento[")
	...
	public void setUY_Devengamiento_ID (int UY_Devengamiento_ID)
	{
		if (UY_Devengamiento_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_Devengamiento_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_Devengamiento_ID, Integer.valueOf(UY_Devengamiento_ID));
	}
