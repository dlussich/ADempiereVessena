...
/** Generated Model for UY_CargoRegister
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_UY_CargoRegister extends PO implements I_UY_CargoRegister, I_Persistent 
{
    ...
    public X_UY_CargoRegister (Properties ctx, int UY_CargoRegister_ID, String trxName)
    {
      super (ctx, UY_CargoRegister_ID, trxName);
      /** if (UY_CargoRegister_ID == 0)
        {
...
// N
    ...
    /** Load Constructor */
    public X_UY_CargoRegister (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_CargoRegister[")
	...
	public void setUY_CargoRegister_ID (int UY_CargoRegister_ID)
	{
		if (UY_CargoRegister_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_CargoRegister_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_CargoRegister_ID, Integer.valueOf(UY_CargoRegister_ID));
	}
