...
/** Generated Model for UY_ResguardoGen
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_ResguardoGen extends PO implements I_UY_ResguardoGen, I_Persistent 
{
    ...
    public X_UY_ResguardoGen (Properties ctx, int UY_ResguardoGen_ID, String trxName)
    {
      super (ctx, UY_ResguardoGen_ID, trxName);
      /** if (UY_ResguardoGen_ID == 0)
        {
			setC_Currency_ID (0);
			setC_DocType_ID (0);
...
// DR
    ...
    /** Load Constructor */
    public X_UY_ResguardoGen (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_ResguardoGen[")
	...
	public void setUY_ResguardoGen_ID (int UY_ResguardoGen_ID)
	{
		if (UY_ResguardoGen_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_ResguardoGen_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_ResguardoGen_ID, Integer.valueOf(UY_ResguardoGen_ID));
	}
