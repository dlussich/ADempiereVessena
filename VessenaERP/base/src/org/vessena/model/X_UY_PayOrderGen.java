...
/** Generated Model for UY_PayOrderGen
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_PayOrderGen extends PO implements I_UY_PayOrderGen, I_Persistent 
{
    ...
    public X_UY_PayOrderGen (Properties ctx, int UY_PayOrderGen_ID, String trxName)
    {
      super (ctx, UY_PayOrderGen_ID, trxName);
      /** if (UY_PayOrderGen_ID == 0)
        {
...
// CDF
    ...
    /** Load Constructor */
    public X_UY_PayOrderGen (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_PayOrderGen[")
	...
	public void setUY_PayOrderGen_ID (int UY_PayOrderGen_ID)
	{
		if (UY_PayOrderGen_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_PayOrderGen_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_PayOrderGen_ID, Integer.valueOf(UY_PayOrderGen_ID));
	}
