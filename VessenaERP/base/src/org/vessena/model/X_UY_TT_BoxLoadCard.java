...
/** Generated Model for UY_TT_BoxLoadCard
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_TT_BoxLoadCard extends PO implements I_UY_TT_BoxLoadCard, I_Persistent 
{
    ...
    public X_UY_TT_BoxLoadCard (Properties ctx, int UY_TT_BoxLoadCard_ID, String trxName)
    {
      super (ctx, UY_TT_BoxLoadCard_ID, trxName);
      /** if (UY_TT_BoxLoadCard_ID == 0)
        {
			setDateTrx (new Timestamp( System.currentTimeMillis() ));
			setIsRetained (false);
			setIsValid (false);
			setScanText (null);
			setUY_TT_BoxLoadCard_ID (0);
			setUY_TT_BoxLoad_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_TT_BoxLoadCard (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_TT_BoxLoadCard[")
	...
	/** Set UY_TT_BoxLoadCard.
		@param UY_TT_BoxLoadCard_ID UY_TT_BoxLoadCard	  */
	public void setUY_TT_BoxLoadCard_ID (int UY_TT_BoxLoadCard_ID)
	{
		if (UY_TT_BoxLoadCard_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_TT_BoxLoadCard_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_TT_BoxLoadCard_ID, Integer.valueOf(UY_TT_BoxLoadCard_ID));
	}

	/** Get UY_TT_BoxLoadCard.
		@return UY_TT_BoxLoadCard	  */
	public int getUY_TT_BoxLoadCard_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_TT_BoxLoadCard_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	public I_UY_TT_BoxLoad getUY_TT_BoxLoad() throws RuntimeException
    {
		return (I_UY_TT_BoxLoad)MTable.get(getCtx(), I_UY_TT_BoxLoad.Table_Name)
			.getPO(getUY_TT_BoxLoad_ID(), get_TrxName());	}

	/** Set UY_TT_BoxLoad.
		@param UY_TT_BoxLoad_ID UY_TT_BoxLoad	  */
	public void setUY_TT_BoxLoad_ID (int UY_TT_BoxLoad_ID)
	{
		if (UY_TT_BoxLoad_ID < 1) 
			set_Value (COLUMNNAME_UY_TT_BoxLoad_ID, null);
		else 
			set_Value (COLUMNNAME_UY_TT_BoxLoad_ID, Integer.valueOf(UY_TT_BoxLoad_ID));
	}

	/** Get UY_TT_BoxLoad.
		@return UY_TT_BoxLoad	  */
	public int getUY_TT_BoxLoad_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_TT_BoxLoad_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
