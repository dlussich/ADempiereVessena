...
/** Generated Model for UY_Fdu_InvoiceType
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_Fdu_InvoiceType extends PO implements I_UY_Fdu_InvoiceType, I_Persistent 
{
    ...
    public X_UY_Fdu_InvoiceType (Properties ctx, int UY_Fdu_InvoiceType_ID, String trxName)
    {
      super (ctx, UY_Fdu_InvoiceType_ID, trxName);
      /** if (UY_Fdu_InvoiceType_ID == 0)
        {
			setC_BPartner_ID (0);
			setUY_FduFile_ID (0);
    ...
    /** Load Constructor */
    public X_UY_Fdu_InvoiceType (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_Fdu_InvoiceType[")
	...
	public void setUY_Fdu_InvoiceType_ID (int UY_Fdu_InvoiceType_ID)
	{
		if (UY_Fdu_InvoiceType_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_Fdu_InvoiceType_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_Fdu_InvoiceType_ID, Integer.valueOf(UY_Fdu_InvoiceType_ID));
	}
