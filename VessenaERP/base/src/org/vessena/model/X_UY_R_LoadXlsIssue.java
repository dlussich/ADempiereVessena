...
/** Generated Model for UY_R_LoadXlsIssue
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_R_LoadXlsIssue extends PO implements I_UY_R_LoadXlsIssue, I_Persistent 
{
    ...
    public X_UY_R_LoadXlsIssue (Properties ctx, int UY_R_LoadXlsIssue_ID, String trxName)
    {
      super (ctx, UY_R_LoadXlsIssue_ID, trxName);
      /** if (UY_R_LoadXlsIssue_ID == 0)
        {
			setErrorMsg (null);
			setUY_R_LoadXls_ID (0);
			setUY_R_LoadXlsIssue_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_R_LoadXlsIssue (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_R_LoadXlsIssue[")
	...
	/** Set UY_R_LoadXlsIssue.
		@param UY_R_LoadXlsIssue_ID UY_R_LoadXlsIssue	  */
	public void setUY_R_LoadXlsIssue_ID (int UY_R_LoadXlsIssue_ID)
	{
		if (UY_R_LoadXlsIssue_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_R_LoadXlsIssue_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_R_LoadXlsIssue_ID, Integer.valueOf(UY_R_LoadXlsIssue_ID));
	}

	/** Get UY_R_LoadXlsIssue.
		@return UY_R_LoadXlsIssue	  */
	public int getUY_R_LoadXlsIssue_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_R_LoadXlsIssue_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
