...
/** Generated Model for UY_AcctNavCC
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_AcctNavCC extends PO implements I_UY_AcctNavCC, I_Persistent 
{
    ...
    public X_UY_AcctNavCC (Properties ctx, int UY_AcctNavCC_ID, String trxName)
    {
      super (ctx, UY_AcctNavCC_ID, trxName);
      /** if (UY_AcctNavCC_ID == 0)
        {
			setProcessed (false);
    ...
    /** Load Constructor */
    public X_UY_AcctNavCC (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_AcctNavCC[")
	...
	public void setUY_AcctNavCC_ID (int UY_AcctNavCC_ID)
	{
		if (UY_AcctNavCC_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_AcctNavCC_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_AcctNavCC_ID, Integer.valueOf(UY_AcctNavCC_ID));
	}
