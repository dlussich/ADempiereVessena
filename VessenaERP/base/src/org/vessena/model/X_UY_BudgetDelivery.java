...
/** Generated Model for UY_BudgetDelivery
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_BudgetDelivery extends PO implements I_UY_BudgetDelivery, I_Persistent 
{

	/**
	 *
	 */
	private static final long serialVersionUID = 20121021L;

    /** Standard Constructor */
    public X_UY_BudgetDelivery (Properties ctx, int UY_BudgetDelivery_ID, String trxName)
    {
      super (ctx, UY_BudgetDelivery_ID, trxName);
      /** if (UY_BudgetDelivery_ID == 0)
        {
			setC_BPartner_ID (0);
			setC_DocType_ID (0);
...
// DR
    ...
    /** Load Constructor */
    public X_UY_BudgetDelivery (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_BudgetDelivery[")
	...
	public void setUY_BudgetDelivery_ID (int UY_BudgetDelivery_ID)
	{
		if (UY_BudgetDelivery_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_BudgetDelivery_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_BudgetDelivery_ID, Integer.valueOf(UY_BudgetDelivery_ID));
	}
