...
/** Generated Model for UY_TR_FailureCategory
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_UY_TR_FailureCategory extends PO implements I_UY_TR_FailureCategory, I_Persistent 
{
    ...
    public X_UY_TR_FailureCategory (Properties ctx, int UY_TR_FailureCategory_ID, String trxName)
    {
      super (ctx, UY_TR_FailureCategory_ID, trxName);
      /** if (UY_TR_FailureCategory_ID == 0)
        {
			setName (null);
			setUY_TR_FailureCategory_ID (0);
			setValue (null);
        } */
    }

    /** Load Constructor */
    public X_UY_TR_FailureCategory (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_TR_FailureCategory[")
	...
	public void setUY_TR_FailureCategory_ID (int UY_TR_FailureCategory_ID)
	{
		if (UY_TR_FailureCategory_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_TR_FailureCategory_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_TR_FailureCategory_ID, Integer.valueOf(UY_TR_FailureCategory_ID));
	}
