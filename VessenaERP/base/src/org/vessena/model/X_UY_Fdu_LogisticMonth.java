...
/** Generated Model for UY_Fdu_LogisticMonth
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_Fdu_LogisticMonth extends PO implements I_UY_Fdu_LogisticMonth, I_Persistent 
{
    ...
    public X_UY_Fdu_LogisticMonth (Properties ctx, int UY_Fdu_LogisticMonth_ID, String trxName)
    {
      super (ctx, UY_Fdu_LogisticMonth_ID, trxName);
      /** if (UY_Fdu_LogisticMonth_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_UY_Fdu_LogisticMonth (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_Fdu_LogisticMonth[")
	...
	public void setUY_Fdu_LogisticMonth_ID (int UY_Fdu_LogisticMonth_ID)
	{
		if (UY_Fdu_LogisticMonth_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_Fdu_LogisticMonth_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_Fdu_LogisticMonth_ID, Integer.valueOf(UY_Fdu_LogisticMonth_ID));
	}
