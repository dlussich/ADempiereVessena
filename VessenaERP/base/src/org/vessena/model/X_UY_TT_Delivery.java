...
/** Generated Model for UY_TT_Delivery
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_TT_Delivery extends PO implements I_UY_TT_Delivery, I_Persistent 
{
    ...
    public X_UY_TT_Delivery (Properties ctx, int UY_TT_Delivery_ID, String trxName)
    {
      super (ctx, UY_TT_Delivery_ID, trxName);
      /** if (UY_TT_Delivery_ID == 0)
        {
			setAD_User_ID (0);
			setC_DocType_ID (0);
...
// DR
    ...
    /** Load Constructor */
    public X_UY_TT_Delivery (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_TT_Delivery[")
	...
	public void setUY_TT_Delivery_ID (int UY_TT_Delivery_ID)
	{
		if (UY_TT_Delivery_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_TT_Delivery_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_TT_Delivery_ID, Integer.valueOf(UY_TT_Delivery_ID));
	}
