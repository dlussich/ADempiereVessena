...
/** Generated Model for UY_R_AjusteAction
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_R_AjusteAction extends PO implements I_UY_R_AjusteAction, I_Persistent 
{
    ...
    public X_UY_R_AjusteAction (Properties ctx, int UY_R_AjusteAction_ID, String trxName)
    {
      super (ctx, UY_R_AjusteAction_ID, trxName);
      /** if (UY_R_AjusteAction_ID == 0)
        {
			setC_DocType_ID (0);
    ...
    /** Load Constructor */
    public X_UY_R_AjusteAction (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_R_AjusteAction[")
	...
	public void setUY_R_AjusteAction_ID (int UY_R_AjusteAction_ID)
	{
		if (UY_R_AjusteAction_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_R_AjusteAction_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_R_AjusteAction_ID, Integer.valueOf(UY_R_AjusteAction_ID));
	}
