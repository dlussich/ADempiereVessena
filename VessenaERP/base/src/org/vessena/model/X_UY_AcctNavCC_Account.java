...
/** Generated Model for UY_AcctNavCC_Account
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_AcctNavCC_Account extends PO implements I_UY_AcctNavCC_Account, I_Persistent 
{
    ...
    public X_UY_AcctNavCC_Account (Properties ctx, int UY_AcctNavCC_Account_ID, String trxName)
    {
      super (ctx, UY_AcctNavCC_Account_ID, trxName);
      /** if (UY_AcctNavCC_Account_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_UY_AcctNavCC_Account (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_AcctNavCC_Account[")
	...
	public void setUY_AcctNavCC_Account_ID (int UY_AcctNavCC_Account_ID)
	{
		if (UY_AcctNavCC_Account_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_AcctNavCC_Account_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_AcctNavCC_Account_ID, Integer.valueOf(UY_AcctNavCC_Account_ID));
	}
