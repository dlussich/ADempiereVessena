...
/** Generated Model for UY_TT_ReceiptScan
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_TT_ReceiptScan extends PO implements I_UY_TT_ReceiptScan, I_Persistent 
{
    ...
    public X_UY_TT_ReceiptScan (Properties ctx, int UY_TT_ReceiptScan_ID, String trxName)
    {
      super (ctx, UY_TT_ReceiptScan_ID, trxName);
      /** if (UY_TT_ReceiptScan_ID == 0)
        {
			setScanText (null);
    ...
    /** Load Constructor */
    public X_UY_TT_ReceiptScan (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_TT_ReceiptScan[")
	...
	public void setUY_TT_ReceiptScan_ID (int UY_TT_ReceiptScan_ID)
	{
		if (UY_TT_ReceiptScan_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_TT_ReceiptScan_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_TT_ReceiptScan_ID, Integer.valueOf(UY_TT_ReceiptScan_ID));
	}
