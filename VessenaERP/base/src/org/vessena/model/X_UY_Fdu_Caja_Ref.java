...
/** Generated Model for UY_Fdu_Caja_Ref
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_Fdu_Caja_Ref extends PO implements I_UY_Fdu_Caja_Ref, I_Persistent 
{
    ...
    public X_UY_Fdu_Caja_Ref (Properties ctx, int UY_Fdu_Caja_Ref_ID, String trxName)
    {
      super (ctx, UY_Fdu_Caja_Ref_ID, trxName);
      /** if (UY_Fdu_Caja_Ref_ID == 0)
        {
			setcodigo (null);
    ...
    /** Load Constructor */
    public X_UY_Fdu_Caja_Ref (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_Fdu_Caja_Ref[")
	...
	public void setUY_Fdu_Caja_Ref_ID (int UY_Fdu_Caja_Ref_ID)
	{
		if (UY_Fdu_Caja_Ref_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_Fdu_Caja_Ref_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_Fdu_Caja_Ref_ID, Integer.valueOf(UY_Fdu_Caja_Ref_ID));
	}
