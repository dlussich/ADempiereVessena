...
/** Generated Model for Cov_Ticket_LineRetiro
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_Cov_Ticket_LineRetiro extends PO implements I_Cov_Ticket_LineRetiro, I_Persistent 
{
    ...
    public X_Cov_Ticket_LineRetiro (Properties ctx, int Cov_Ticket_LineRetiro_ID, String trxName)
    {
      super (ctx, Cov_Ticket_LineRetiro_ID, trxName);
      /** if (Cov_Ticket_LineRetiro_ID == 0)
        {
			setCov_Ticket_LineRetiro_ID (0);
        } */
    }

    /** Load Constructor */
    public X_Cov_Ticket_LineRetiro (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Cov_Ticket_LineRetiro[")
	...
	/** Set Cov_Ticket_LineRetiro.
		@param Cov_Ticket_LineRetiro_ID Cov_Ticket_LineRetiro	  */
	public void setCov_Ticket_LineRetiro_ID (int Cov_Ticket_LineRetiro_ID)
	{
		if (Cov_Ticket_LineRetiro_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Cov_Ticket_LineRetiro_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Cov_Ticket_LineRetiro_ID, Integer.valueOf(Cov_Ticket_LineRetiro_ID));
	}

	/** Get Cov_Ticket_LineRetiro.
		@return Cov_Ticket_LineRetiro	  */
	public int getCov_Ticket_LineRetiro_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_Cov_Ticket_LineRetiro_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
