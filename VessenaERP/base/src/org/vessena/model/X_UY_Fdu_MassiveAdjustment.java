...
/** Generated Model for UY_Fdu_MassiveAdjustment
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_Fdu_MassiveAdjustment extends PO implements I_UY_Fdu_MassiveAdjustment, I_Persistent 
{
    ...
    public X_UY_Fdu_MassiveAdjustment (Properties ctx, int UY_Fdu_MassiveAdjustment_ID, String trxName)
    {
      super (ctx, UY_Fdu_MassiveAdjustment_ID, trxName);
      /** if (UY_Fdu_MassiveAdjustment_ID == 0)
        {
			setAD_User_ID (0);
			setC_DocType_ID (0);
...
// DR
    ...
    /** Load Constructor */
    public X_UY_Fdu_MassiveAdjustment (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_Fdu_MassiveAdjustment[")
	...
	public void setUY_Fdu_MassiveAdjustment_ID (int UY_Fdu_MassiveAdjustment_ID)
	{
		if (UY_Fdu_MassiveAdjustment_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_Fdu_MassiveAdjustment_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_Fdu_MassiveAdjustment_ID, Integer.valueOf(UY_Fdu_MassiveAdjustment_ID));
	}
