...
/** Generated Model for UY_CFE_DataEnvelope
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_CFE_DataEnvelope extends PO implements I_UY_CFE_DataEnvelope, I_Persistent 
{
    ...
    public X_UY_CFE_DataEnvelope (Properties ctx, int UY_CFE_DataEnvelope_ID, String trxName)
    {
      super (ctx, UY_CFE_DataEnvelope_ID, trxName);
      /** if (UY_CFE_DataEnvelope_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_UY_CFE_DataEnvelope (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_CFE_DataEnvelope[")
        .append(get_ID()).append("]");
      return sb.toString();
    }

	/** ProviderAgent AD_Reference_ID=1000521 */
	public static final int PROVIDERAGENT_AD_Reference_ID=1000521;
	/** InvoiCy = INVOICY */
	...
	public void setUY_CFE_DataEnvelope_ID (int UY_CFE_DataEnvelope_ID)
	{
		if (UY_CFE_DataEnvelope_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_CFE_DataEnvelope_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_CFE_DataEnvelope_ID, Integer.valueOf(UY_CFE_DataEnvelope_ID));
	}
