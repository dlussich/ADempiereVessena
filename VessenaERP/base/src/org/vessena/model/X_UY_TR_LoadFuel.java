...
/** Generated Model for UY_TR_LoadFuel
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_TR_LoadFuel extends PO implements I_UY_TR_LoadFuel, I_Persistent 
{
    ...
    public X_UY_TR_LoadFuel (Properties ctx, int UY_TR_LoadFuel_ID, String trxName)
    {
      super (ctx, UY_TR_LoadFuel_ID, trxName);
      /** if (UY_TR_LoadFuel_ID == 0)
        {
			setC_DocType_ID (0);
			setDocAction (null);
// AY
...
// DR
    ...
    /** Load Constructor */
    public X_UY_TR_LoadFuel (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_TR_LoadFuel[")
	...
	public void setUY_TR_LoadFuel_ID (int UY_TR_LoadFuel_ID)
	{
		if (UY_TR_LoadFuel_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_TR_LoadFuel_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_TR_LoadFuel_ID, Integer.valueOf(UY_TR_LoadFuel_ID));
	}
