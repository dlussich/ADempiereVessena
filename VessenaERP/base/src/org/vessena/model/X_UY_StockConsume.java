...
/** Generated Model for UY_StockConsume
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_StockConsume extends PO implements I_UY_StockConsume, I_Persistent 
{
    ...
    public X_UY_StockConsume (Properties ctx, int UY_StockConsume_ID, String trxName)
    {
      super (ctx, UY_StockConsume_ID, trxName);
      /** if (UY_StockConsume_ID == 0)
        {
			setAD_Table_ID (0);
			setC_Currency_ID (0);
			setC_DocType_ID (0);
    ...
    /** Load Constructor */
    public X_UY_StockConsume (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_StockConsume[")
	...
	public void setUY_StockConsume_ID (int UY_StockConsume_ID)
	{
		if (UY_StockConsume_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_StockConsume_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_StockConsume_ID, Integer.valueOf(UY_StockConsume_ID));
	}
