...
/** Generated Model for UY_Familia
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_Familia extends PO implements I_UY_Familia, I_Persistent 
{
    ...
    public X_UY_Familia (Properties ctx, int UY_Familia_ID, String trxName)
    {
    ...
    /** Load Constructor */
    public X_UY_Familia (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_Familia[")
	...
	{
		if (UY_Familia_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_Familia_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_Familia_ID, Integer.valueOf(UY_Familia_ID));
	}
