...
/** Generated Model for UY_MB_StoreLOPay
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_MB_StoreLOPay extends PO implements I_UY_MB_StoreLOPay, I_Persistent 
{
    ...
    public X_UY_MB_StoreLOPay (Properties ctx, int UY_MB_StoreLOPay_ID, String trxName)
    {
      super (ctx, UY_MB_StoreLOPay_ID, trxName);
      /** if (UY_MB_StoreLOPay_ID == 0)
        {
			setamtmt (Env.ZERO);
			setamtusd (Env.ZERO);
			setC_Currency_ID (0);
			setUY_MB_StoreLoadOrder_ID (0);
			setUY_MB_StoreLOPay_ID (0);
			setUY_MB_StoreLOSale_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_MB_StoreLOPay (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_MB_StoreLOPay[")
	...
	/** Set UY_MB_StoreLOPay.
		@param UY_MB_StoreLOPay_ID UY_MB_StoreLOPay	  */
	public void setUY_MB_StoreLOPay_ID (int UY_MB_StoreLOPay_ID)
	{
		if (UY_MB_StoreLOPay_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_MB_StoreLOPay_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_MB_StoreLOPay_ID, Integer.valueOf(UY_MB_StoreLOPay_ID));
	}

	/** Get UY_MB_StoreLOPay.
		@return UY_MB_StoreLOPay	  */
	public int getUY_MB_StoreLOPay_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_MB_StoreLOPay_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
