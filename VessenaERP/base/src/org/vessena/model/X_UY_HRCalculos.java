...
/** Generated Model for UY_HRCalculos
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_UY_HRCalculos extends PO implements I_UY_HRCalculos, I_Persistent 
{
    ...
    public X_UY_HRCalculos (Properties ctx, int UY_HRCalculos_ID, String trxName)
    {
      super (ctx, UY_HRCalculos_ID, trxName);
      /** if (UY_HRCalculos_ID == 0)
        {
			setcodigo (null);
			setHR_Concept_ID (0);
			setName (null);
			setUY_HRCalculos_ID (0);
			setValue (null);
        } */
    }

    /** Load Constructor */
    public X_UY_HRCalculos (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_HRCalculos[")
	...
	public void setUY_HRCalculos_ID (int UY_HRCalculos_ID)
	{
		if (UY_HRCalculos_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_HRCalculos_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_HRCalculos_ID, Integer.valueOf(UY_HRCalculos_ID));
	}
