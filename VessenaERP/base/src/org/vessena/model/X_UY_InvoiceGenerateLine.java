...
/** Generated Model for UY_InvoiceGenerateLine
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_InvoiceGenerateLine extends PO implements I_UY_InvoiceGenerateLine, I_Persistent 
{
    ...
    public X_UY_InvoiceGenerateLine (Properties ctx, int UY_InvoiceGenerateLine_ID, String trxName)
    {
      super (ctx, UY_InvoiceGenerateLine_ID, trxName);
      /** if (UY_InvoiceGenerateLine_ID == 0)
        {
			setC_BPartner_ID (0);
			setC_DocType_ID (0);
			setC_Invoice_ID (0);
			setUY_InvoiceGenerate_ID (0);
			setUY_InvoiceGenerateLine_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_InvoiceGenerateLine (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_InvoiceGenerateLine[")
	...
	public void setUY_InvoiceGenerateLine_ID (int UY_InvoiceGenerateLine_ID)
	{
		if (UY_InvoiceGenerateLine_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_InvoiceGenerateLine_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_InvoiceGenerateLine_ID, Integer.valueOf(UY_InvoiceGenerateLine_ID));
	}
