...
/** Generated Model for UY_TT_Chequera
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_UY_TT_Chequera extends PO implements I_UY_TT_Chequera, I_Persistent 
{
    ...
    public X_UY_TT_Chequera (Properties ctx, int UY_TT_Chequera_ID, String trxName)
    {
      super (ctx, UY_TT_Chequera_ID, trxName);
      /** if (UY_TT_Chequera_ID == 0)
        {
			setC_DocType_ID (0);
			setDocAction (null);
// AY
...
// DR
    ...
    /** Load Constructor */
    public X_UY_TT_Chequera (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_TT_Chequera[")
	...
	public void setUY_TT_Chequera_ID (int UY_TT_Chequera_ID)
	{
		if (UY_TT_Chequera_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_TT_Chequera_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_TT_Chequera_ID, Integer.valueOf(UY_TT_Chequera_ID));
	}
