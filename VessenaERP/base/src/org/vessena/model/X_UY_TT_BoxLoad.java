...
/** Generated Model for UY_TT_BoxLoad
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_TT_BoxLoad extends PO implements I_UY_TT_BoxLoad, I_Persistent 
{
    ...
    public X_UY_TT_BoxLoad (Properties ctx, int UY_TT_BoxLoad_ID, String trxName)
    {
      super (ctx, UY_TT_BoxLoad_ID, trxName);
      /** if (UY_TT_BoxLoad_ID == 0)
        {
			setAD_User_ID (0);
			setC_DocType_ID (0);
...
// DR
    ...
    /** Load Constructor */
    public X_UY_TT_BoxLoad (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_TT_BoxLoad[")
	...
	public void setUY_TT_BoxLoad_ID (int UY_TT_BoxLoad_ID)
	{
		if (UY_TT_BoxLoad_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_TT_BoxLoad_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_TT_BoxLoad_ID, Integer.valueOf(UY_TT_BoxLoad_ID));
	}
