...
/** Generated Model for Cov_Ticket_LineEfectivo
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_Cov_Ticket_LineEfectivo extends PO implements I_Cov_Ticket_LineEfectivo, I_Persistent 
{

	/**
	 *
	 */
	private static final long serialVersionUID = 20150423L;

    /** Standard Constructor */
    public X_Cov_Ticket_LineEfectivo (Properties ctx, int Cov_Ticket_LineEfectivo_ID, String trxName)
    {
      super (ctx, Cov_Ticket_LineEfectivo_ID, trxName);
      /** if (Cov_Ticket_LineEfectivo_ID == 0)
        {
			setCov_Ticket_LineEfectivo_ID (0);
        } */
    }

    /** Load Constructor */
    public X_Cov_Ticket_LineEfectivo (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Cov_Ticket_LineEfectivo[")
	...
	/** Set Cov_Ticket_LineEfectivo.
		@param Cov_Ticket_LineEfectivo_ID Cov_Ticket_LineEfectivo	  */
	public void setCov_Ticket_LineEfectivo_ID (int Cov_Ticket_LineEfectivo_ID)
	{
		if (Cov_Ticket_LineEfectivo_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Cov_Ticket_LineEfectivo_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Cov_Ticket_LineEfectivo_ID, Integer.valueOf(Cov_Ticket_LineEfectivo_ID));
	}

	/** Get Cov_Ticket_LineEfectivo.
		@return Cov_Ticket_LineEfectivo	  */
	public int getCov_Ticket_LineEfectivo_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_Cov_Ticket_LineEfectivo_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
