...
/** Generated Model for UY_PayEmit
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_PayEmit extends PO implements I_UY_PayEmit, I_Persistent 
{
    ...
    public X_UY_PayEmit (Properties ctx, int UY_PayEmit_ID, String trxName)
    {
...
// CDF
    ...
    /** Load Constructor */
    public X_UY_PayEmit (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_PayEmit[")
	...
	/** PayEmitType AD_Reference_ID=1000264 */
	public static final int PAYEMITTYPE_AD_Reference_ID=1000264;
	/** Cheque Diferido = CDF */
	public static final String PAYEMITTYPE_ChequeDiferido = "CDF";
	/** Cheque Contado = CCO */
	public static final String PAYEMITTYPE_ChequeContado = "CCO";
	/** Set PayEmitType.
		@param PayEmitType PayEmitType	  */
	public void setPayEmitType (String PayEmitType)
	{

		set_Value (COLUMNNAME_PayEmitType, PayEmitType);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_PayEmitType);
	}
	...
	{
		if (UY_PayEmit_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_PayEmit_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_PayEmit_ID, Integer.valueOf(UY_PayEmit_ID));
	}
