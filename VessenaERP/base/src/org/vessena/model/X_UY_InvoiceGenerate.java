...
/** Generated Model for UY_InvoiceGenerate
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_InvoiceGenerate extends PO implements I_UY_InvoiceGenerate, I_Persistent 
{
    ...
    public X_UY_InvoiceGenerate (Properties ctx, int UY_InvoiceGenerate_ID, String trxName)
    {
      super (ctx, UY_InvoiceGenerate_ID, trxName);
      /** if (UY_InvoiceGenerate_ID == 0)
        {
			setC_DocType_ID (0);
			...
			setM_Product_ID (0);
			setProcessed (false);
			setUY_InvoiceGenerate_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_InvoiceGenerate (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_InvoiceGenerate[")
	...
	public void setUY_InvoiceGenerate_ID (int UY_InvoiceGenerate_ID)
	{
		if (UY_InvoiceGenerate_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_InvoiceGenerate_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_InvoiceGenerate_ID, Integer.valueOf(UY_InvoiceGenerate_ID));
	}
