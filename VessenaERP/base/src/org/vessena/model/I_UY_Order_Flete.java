...
/** Generated Interface for UY_Order_Flete
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC
 */
public interface I_UY_Order_Flete 
{

    /** TableName=UY_Order_Flete */
    public static final String Table_Name = "UY_Order_Flete";
    ...
    /** Column name UY_Order_Flete_ID */
    public static final String COLUMNNAME_UY_Order_Flete_ID = "UY_Order_Flete_ID";

	/** Set UY_Order_Flete	  */
	public void setUY_Order_Flete_ID (int UY_Order_Flete_ID);

	/** Get UY_Order_Flete	  */
	public int getUY_Order_Flete_ID();
}
