...
/** Generated Model for UY_Credit_Filter
 *  @author Adempiere (generated) 
 *  @version Release 3.5.4a - $Id$ */
public class X_UY_Credit_Filter extends PO implements I_UY_Credit_Filter, I_Persistent 
{
    ...
    public X_UY_Credit_Filter (Properties ctx, int UY_Credit_Filter_ID, String trxName)
    {
      super (ctx, UY_Credit_Filter_ID, trxName);
      /** if (UY_Credit_Filter_ID == 0)
        {
...
// @Date@
    ...
    /** Load Constructor */
    public X_UY_Credit_Filter (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_Credit_Filter[")
	...
	/** DocAction AD_Reference_ID=1000052 */
	public static final int DOCACTION_AD_Reference_ID=1000052;
	/** Sin Reserva = 1 */
	public static final String DOCACTION_SinReserva = "1";
	/** Reserva Parcial = 2 */
	public static final String DOCACTION_ReservaParcial = "2";
	/** Reserva Total = 3 */
	public static final String DOCACTION_ReservaTotal = "3";
	/** Set Document Action.
		@param DocAction 
	...
	public void setUY_Credit_Filter_ID (int UY_Credit_Filter_ID)
	{
		if (UY_Credit_Filter_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_Credit_Filter_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_Credit_Filter_ID, Integer.valueOf(UY_Credit_Filter_ID));
	}
