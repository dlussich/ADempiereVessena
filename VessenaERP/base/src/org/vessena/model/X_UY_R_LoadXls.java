...
/** Generated Model for UY_R_LoadXls
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_R_LoadXls extends PO implements I_UY_R_LoadXls, I_Persistent 
{
    ...
    public X_UY_R_LoadXls (Properties ctx, int UY_R_LoadXls_ID, String trxName)
    {
      super (ctx, UY_R_LoadXls_ID, trxName);
      /** if (UY_R_LoadXls_ID == 0)
        {
			setC_DocType_ID (0);
...
// DR
    ...
    /** Load Constructor */
    public X_UY_R_LoadXls (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_R_LoadXls[")
	...
	public void setUY_R_LoadXls_ID (int UY_R_LoadXls_ID)
	{
		if (UY_R_LoadXls_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_R_LoadXls_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_R_LoadXls_ID, Integer.valueOf(UY_R_LoadXls_ID));
	}
