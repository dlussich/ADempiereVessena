...
/** Generated Model for UY_ExchangeDiffHdr
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_ExchangeDiffHdr extends PO implements I_UY_ExchangeDiffHdr, I_Persistent 
{

	/**
	 *
	 */
	private static final long serialVersionUID = 20130201L;

    /** Standard Constructor */
    public X_UY_ExchangeDiffHdr (Properties ctx, int UY_ExchangeDiffHdr_ID, String trxName)
    {
      super (ctx, UY_ExchangeDiffHdr_ID, trxName);
      /** if (UY_ExchangeDiffHdr_ID == 0)
        {
			setC_DocType_ID (0);
...
// N
    ...
    /** Load Constructor */
    public X_UY_ExchangeDiffHdr (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_ExchangeDiffHdr[")
	...
	public void setUY_ExchangeDiffHdr_ID (int UY_ExchangeDiffHdr_ID)
	{
		if (UY_ExchangeDiffHdr_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_ExchangeDiffHdr_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_ExchangeDiffHdr_ID, Integer.valueOf(UY_ExchangeDiffHdr_ID));
	}
