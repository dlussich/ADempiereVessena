...
/** Generated Model for UY_CashCashier
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_CashCashier extends PO implements I_UY_CashCashier, I_Persistent 
{
    ...
    public X_UY_CashCashier (Properties ctx, int UY_CashCashier_ID, String trxName)
    {
      super (ctx, UY_CashCashier_ID, trxName);
      /** if (UY_CashCashier_ID == 0)
        {
			setAmount (Env.ZERO);
			setC_BPartner_ID (0);
			setC_DocType_ID (0);
    ...
    /** Load Constructor */
    public X_UY_CashCashier (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_CashCashier[")
	...
	public void setUY_CashCashier_ID (int UY_CashCashier_ID)
	{
		if (UY_CashCashier_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_CashCashier_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_CashCashier_ID, Integer.valueOf(UY_CashCashier_ID));
	}
