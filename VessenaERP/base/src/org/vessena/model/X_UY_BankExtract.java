...
/** Generated Model for UY_BankExtract
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_UY_BankExtract extends PO implements I_UY_BankExtract, I_Persistent 
{
    ...
    public X_UY_BankExtract (Properties ctx, int UY_BankExtract_ID, String trxName)
    {
      super (ctx, UY_BankExtract_ID, trxName);
      /** if (UY_BankExtract_ID == 0)
        {
...
// Y
    ...
    /** Load Constructor */
    public X_UY_BankExtract (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_BankExtract[")
	...
	public void setUY_BankExtract_ID (int UY_BankExtract_ID)
	{
		if (UY_BankExtract_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_BankExtract_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_BankExtract_ID, Integer.valueOf(UY_BankExtract_ID));
	}
