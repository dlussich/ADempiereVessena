...
/** Generated Model for UY_AcctNavCC_CC
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_AcctNavCC_CC extends PO implements I_UY_AcctNavCC_CC, I_Persistent 
{
    ...
    public X_UY_AcctNavCC_CC (Properties ctx, int UY_AcctNavCC_CC_ID, String trxName)
    {
      super (ctx, UY_AcctNavCC_CC_ID, trxName);
      /** if (UY_AcctNavCC_CC_ID == 0)
        {
			setC_Activity_ID_1 (0);
			setGL_Journal_ID (0);
			setUY_AcctNavCC_Account_ID (0);
			setUY_AcctNavCC_CC_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_AcctNavCC_CC (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_AcctNavCC_CC[")
	...
	/** Set UY_AcctNavCC_CC.
		@param UY_AcctNavCC_CC_ID UY_AcctNavCC_CC	  */
	public void setUY_AcctNavCC_CC_ID (int UY_AcctNavCC_CC_ID)
	{
		if (UY_AcctNavCC_CC_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_AcctNavCC_CC_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_AcctNavCC_CC_ID, Integer.valueOf(UY_AcctNavCC_CC_ID));
	}

	/** Get UY_AcctNavCC_CC.
		@return UY_AcctNavCC_CC	  */
	public int getUY_AcctNavCC_CC_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_AcctNavCC_CC_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	public I_UY_AcctNavCC_Journal getUY_AcctNavCC_Journal() throws RuntimeException
    {
		return (I_UY_AcctNavCC_Journal)MTable.get(getCtx(), I_UY_AcctNavCC_Journal.Table_Name)
			.getPO(getUY_AcctNavCC_Journal_ID(), get_TrxName());	}

	/** Set UY_AcctNavCC_Journal.
		@param UY_AcctNavCC_Journal_ID UY_AcctNavCC_Journal	  */
	public void setUY_AcctNavCC_Journal_ID (int UY_AcctNavCC_Journal_ID)
	{
		if (UY_AcctNavCC_Journal_ID < 1) 
			set_Value (COLUMNNAME_UY_AcctNavCC_Journal_ID, null);
		else 
			set_Value (COLUMNNAME_UY_AcctNavCC_Journal_ID, Integer.valueOf(UY_AcctNavCC_Journal_ID));
	}

	/** Get UY_AcctNavCC_Journal.
		@return UY_AcctNavCC_Journal	  */
	public int getUY_AcctNavCC_Journal_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_AcctNavCC_Journal_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
