...
/** Generated Model for UY_CashClose
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_UY_CashClose extends PO implements I_UY_CashClose, I_Persistent 
{
    ...
    public X_UY_CashClose (Properties ctx, int UY_CashClose_ID, String trxName)
    {
      super (ctx, UY_CashClose_ID, trxName);
      /** if (UY_CashClose_ID == 0)
        {
			setAD_User_ID (0);
			...
			setProcessed (false);
			setsaldo (Env.ZERO);
			setsaldoinicial (Env.ZERO);
			setUY_CashClose_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_CashClose (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_CashClose[")
	...
	public void setUY_CashClose_ID (int UY_CashClose_ID)
	{
		if (UY_CashClose_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_CashClose_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_CashClose_ID, Integer.valueOf(UY_CashClose_ID));
	}
