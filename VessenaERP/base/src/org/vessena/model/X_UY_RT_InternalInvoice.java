...
/** Generated Model for UY_RT_InternalInvoice
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_RT_InternalInvoice extends PO implements I_UY_RT_InternalInvoice, I_Persistent 
{
    ...
    public X_UY_RT_InternalInvoice (Properties ctx, int UY_RT_InternalInvoice_ID, String trxName)
    {
      super (ctx, UY_RT_InternalInvoice_ID, trxName);
      /** if (UY_RT_InternalInvoice_ID == 0)
        {
			setAD_Org_ID_To (0);
			setC_BPartner_ID (0);
			setC_DocType_ID (0);
...
// N
    ...
    /** Load Constructor */
    public X_UY_RT_InternalInvoice (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_RT_InternalInvoice[")
	...
	public void setUY_RT_InternalInvoice_ID (int UY_RT_InternalInvoice_ID)
	{
		if (UY_RT_InternalInvoice_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_RT_InternalInvoice_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_RT_InternalInvoice_ID, Integer.valueOf(UY_RT_InternalInvoice_ID));
	}
