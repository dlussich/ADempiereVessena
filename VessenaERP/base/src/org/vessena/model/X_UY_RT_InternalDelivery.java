...
/** Generated Model for UY_RT_InternalDelivery
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_RT_InternalDelivery extends PO implements I_UY_RT_InternalDelivery, I_Persistent 
{
    ...
    public X_UY_RT_InternalDelivery (Properties ctx, int UY_RT_InternalDelivery_ID, String trxName)
    {
      super (ctx, UY_RT_InternalDelivery_ID, trxName);
      /** if (UY_RT_InternalDelivery_ID == 0)
        {
			setAD_Org_ID_To (0);
			setC_DocType_ID (0);
...
// DR
    ...
    /** Load Constructor */
    public X_UY_RT_InternalDelivery (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_RT_InternalDelivery[")
	...
	/** Set C_Order_ID_To.
		@param C_Order_ID_To C_Order_ID_To	  */
	public void setC_Order_ID_To (int C_Order_ID_To)
	{
		set_Value (COLUMNNAME_C_Order_ID_To, Integer.valueOf(C_Order_ID_To));
	}

	/** Get C_Order_ID_To.
		@return C_Order_ID_To	  */
	public int getC_Order_ID_To () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_C_Order_ID_To);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	public void setUY_RT_InternalDelivery_ID (int UY_RT_InternalDelivery_ID)
	{
		if (UY_RT_InternalDelivery_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_RT_InternalDelivery_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_RT_InternalDelivery_ID, Integer.valueOf(UY_RT_InternalDelivery_ID));
	}
