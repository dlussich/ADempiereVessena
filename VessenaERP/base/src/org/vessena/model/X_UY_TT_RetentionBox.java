...
/** Generated Model for UY_TT_RetentionBox
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_TT_RetentionBox extends PO implements I_UY_TT_RetentionBox, I_Persistent 
{
    ...
    public X_UY_TT_RetentionBox (Properties ctx, int UY_TT_RetentionBox_ID, String trxName)
    {
      super (ctx, UY_TT_RetentionBox_ID, trxName);
      /** if (UY_TT_RetentionBox_ID == 0)
        {
			setUY_TT_RetentionBox_ID (0);
			setUY_TT_Retention_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_TT_RetentionBox (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_TT_RetentionBox[")
	...
	/** Set UY_TT_RetentionBox.
		@param UY_TT_RetentionBox_ID UY_TT_RetentionBox	  */
	public void setUY_TT_RetentionBox_ID (int UY_TT_RetentionBox_ID)
	{
		if (UY_TT_RetentionBox_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_TT_RetentionBox_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_TT_RetentionBox_ID, Integer.valueOf(UY_TT_RetentionBox_ID));
	}

	/** Get UY_TT_RetentionBox.
		@return UY_TT_RetentionBox	  */
	public int getUY_TT_RetentionBox_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_TT_RetentionBox_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
