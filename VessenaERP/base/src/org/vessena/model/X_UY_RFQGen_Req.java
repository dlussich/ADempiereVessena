...
/** Generated Model for UY_RFQGen_Req
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_UY_RFQGen_Req extends PO implements I_UY_RFQGen_Req, I_Persistent 
{
    ...
    public X_UY_RFQGen_Req (Properties ctx, int UY_RFQGen_Req_ID, String trxName)
    {
      super (ctx, UY_RFQGen_Req_ID, trxName);
      /** if (UY_RFQGen_Req_ID == 0)
        {
			setIsSelected (false);
			setQtyRequired (Env.ZERO);
			setUY_RFQGen_Prod_ID (0);
			setUY_RFQGen_Req_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_RFQGen_Req (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_RFQGen_Req[")
	...
	/** Set UY_RFQGen_Req.
		@param UY_RFQGen_Req_ID UY_RFQGen_Req	  */
	public void setUY_RFQGen_Req_ID (int UY_RFQGen_Req_ID)
	{
		if (UY_RFQGen_Req_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_RFQGen_Req_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_RFQGen_Req_ID, Integer.valueOf(UY_RFQGen_Req_ID));
	}

	/** Get UY_RFQGen_Req.
		@return UY_RFQGen_Req	  */
	public int getUY_RFQGen_Req_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_RFQGen_Req_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
