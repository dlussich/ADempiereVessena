...
/** Generated Model for UY_Conciliation
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_UY_Conciliation extends PO implements I_UY_Conciliation, I_Persistent 
{
    ...
    public X_UY_Conciliation (Properties ctx, int UY_Conciliation_ID, String trxName)
    {
      super (ctx, UY_Conciliation_ID, trxName);
      /** if (UY_Conciliation_ID == 0)
        {
...
// N
    ...
    /** Load Constructor */
    public X_UY_Conciliation (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_Conciliation[")
	...
	{
		set_Value (COLUMNNAME_Diference, Diference);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_Diference);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	/** Set LoadConciliated.
		@param LoadConciliated LoadConciliated	  */
	public void setLoadConciliated (boolean LoadConciliated)
	{
		set_Value (COLUMNNAME_LoadConciliated, Boolean.valueOf(LoadConciliated));
	}

	/** Get LoadConciliated.
		@return LoadConciliated	  */
	public boolean isLoadConciliated () 
	{
		Object oo = get_Value(COLUMNNAME_LoadConciliated);
		if (oo != null) 
		{
	...
	/** Set ManualConciliation.
		@param ManualConciliation ManualConciliation	  */
	public void setManualConciliation (String ManualConciliation)
	{
		set_Value (COLUMNNAME_ManualConciliation, ManualConciliation);
	}

	/** Get ManualConciliation.
		@return ManualConciliation	  */
	public String getManualConciliation () 
	{
		return (String)get_Value(COLUMNNAME_ManualConciliation);
	}
	...
	{
		set_Value (COLUMNNAME_Orden1, Orden1);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_Orden1);
	}
	...
	{
		set_Value (COLUMNNAME_Orden2, Orden2);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_Orden2);
	}
	...
	{
		set_Value (COLUMNNAME_Orden3, Orden3);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_Orden3);
	}
	...
	{
		set_Value (COLUMNNAME_Orden4, Orden4);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_Orden4);
	}
	...
	public void setUY_Conciliation_ID (int UY_Conciliation_ID)
	{
		if (UY_Conciliation_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_Conciliation_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_Conciliation_ID, Integer.valueOf(UY_Conciliation_ID));
	}
