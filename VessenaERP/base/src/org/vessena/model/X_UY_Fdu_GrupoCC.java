...
/** Generated Model for UY_Fdu_GrupoCC
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_Fdu_GrupoCC extends PO implements I_UY_Fdu_GrupoCC, I_Persistent 
{
    ...
    public X_UY_Fdu_GrupoCC (Properties ctx, int UY_Fdu_GrupoCC_ID, String trxName)
    {
      super (ctx, UY_Fdu_GrupoCC_ID, trxName);
      /** if (UY_Fdu_GrupoCC_ID == 0)
        {
			setName (null);
			setUY_FduFile_ID (0);
			setUY_Fdu_GrupoCC_ID (0);
			setValue (null);
        } */
    }

    /** Load Constructor */
    public X_UY_Fdu_GrupoCC (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_Fdu_GrupoCC[")
	...
	public void setUY_Fdu_GrupoCC_ID (int UY_Fdu_GrupoCC_ID)
	{
		if (UY_Fdu_GrupoCC_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_Fdu_GrupoCC_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_Fdu_GrupoCC_ID, Integer.valueOf(UY_Fdu_GrupoCC_ID));
	}
