...
/** Generated Model for UY_TT_UnifyCard
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_TT_UnifyCard extends PO implements I_UY_TT_UnifyCard, I_Persistent 
{
    ...
    public X_UY_TT_UnifyCard (Properties ctx, int UY_TT_UnifyCard_ID, String trxName)
    {
      super (ctx, UY_TT_UnifyCard_ID, trxName);
      /** if (UY_TT_UnifyCard_ID == 0)
        {
			setDateTrx (new Timestamp( System.currentTimeMillis() ));
			setIsRetained (false);
			setIsValid (false);
			setScanText (null);
			setUY_TT_UnifyCard_ID (0);
			setUY_TT_Unify_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_TT_UnifyCard (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_TT_UnifyCard[")
	...
	/** Set UY_TT_UnifyCard.
		@param UY_TT_UnifyCard_ID UY_TT_UnifyCard	  */
	public void setUY_TT_UnifyCard_ID (int UY_TT_UnifyCard_ID)
	{
		if (UY_TT_UnifyCard_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_TT_UnifyCard_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_TT_UnifyCard_ID, Integer.valueOf(UY_TT_UnifyCard_ID));
	}

	/** Get UY_TT_UnifyCard.
		@return UY_TT_UnifyCard	  */
	public int getUY_TT_UnifyCard_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_TT_UnifyCard_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
