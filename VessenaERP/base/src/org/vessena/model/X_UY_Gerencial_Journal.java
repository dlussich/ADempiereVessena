...
/** Generated Model for UY_Gerencial_Journal
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_Gerencial_Journal extends PO implements I_UY_Gerencial_Journal, I_Persistent 
{

	/**
	 *
	 */
	private static final long serialVersionUID = 20140419L;

    /** Standard Constructor */
    public X_UY_Gerencial_Journal (Properties ctx, int UY_Gerencial_Journal_ID, String trxName)
    {
      super (ctx, UY_Gerencial_Journal_ID, trxName);
      /** if (UY_Gerencial_Journal_ID == 0)
        {
			setGL_Journal_ID (0);
			setUY_Gerencial_Account_ID (0);
			setUY_Gerencial_ID (0);
			setUY_Gerencial_Journal_ID (0);
			setUY_Gerencial_Main_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_Gerencial_Journal (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_Gerencial_Journal[")
	...
	public void setUY_Gerencial_Journal_ID (int UY_Gerencial_Journal_ID)
	{
		if (UY_Gerencial_Journal_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_Gerencial_Journal_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_Gerencial_Journal_ID, Integer.valueOf(UY_Gerencial_Journal_ID));
	}
