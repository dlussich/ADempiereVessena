...
/** Generated Model for UY_StoreLOSale
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_StoreLOSale extends PO implements I_UY_StoreLOSale, I_Persistent 
{
    ...
    public X_UY_StoreLOSale (Properties ctx, int UY_StoreLOSale_ID, String trxName)
    {
      super (ctx, UY_StoreLOSale_ID, trxName);
      /** if (UY_StoreLOSale_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_UY_StoreLOSale (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_StoreLOSale[")
	...
	public void setUY_StoreLOSale_ID (int UY_StoreLOSale_ID)
	{
		if (UY_StoreLOSale_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_StoreLOSale_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_StoreLOSale_ID, Integer.valueOf(UY_StoreLOSale_ID));
	}
