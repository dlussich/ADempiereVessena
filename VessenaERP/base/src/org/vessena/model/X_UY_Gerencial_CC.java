...
/** Generated Model for UY_Gerencial_CC
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_Gerencial_CC extends PO implements I_UY_Gerencial_CC, I_Persistent 
{

	/**
	 *
	 */
	private static final long serialVersionUID = 20140418L;

    /** Standard Constructor */
    public X_UY_Gerencial_CC (Properties ctx, int UY_Gerencial_CC_ID, String trxName)
    {
      super (ctx, UY_Gerencial_CC_ID, trxName);
      /** if (UY_Gerencial_CC_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_UY_Gerencial_CC (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_Gerencial_CC[")
	...
	public void setUY_Gerencial_CC_ID (int UY_Gerencial_CC_ID)
	{
		if (UY_Gerencial_CC_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_Gerencial_CC_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_Gerencial_CC_ID, Integer.valueOf(UY_Gerencial_CC_ID));
	}
	...
	public I_UY_Gerencial_Detail getUY_Gerencial_Detail() throws RuntimeException
    {
		return (I_UY_Gerencial_Detail)MTable.get(getCtx(), I_UY_Gerencial_Detail.Table_Name)
			.getPO(getUY_Gerencial_Detail_ID(), get_TrxName());	}
	...
	public void setUY_Gerencial_Detail_ID (int UY_Gerencial_Detail_ID)
	{
		if (UY_Gerencial_Detail_ID < 1) 
			set_Value (COLUMNNAME_UY_Gerencial_Detail_ID, null);
		else 
			set_Value (COLUMNNAME_UY_Gerencial_Detail_ID, Integer.valueOf(UY_Gerencial_Detail_ID));
	}
	...
	public I_UY_Gerencial_Journal getUY_Gerencial_Journal() throws RuntimeException
    {
		return (I_UY_Gerencial_Journal)MTable.get(getCtx(), I_UY_Gerencial_Journal.Table_Name)
			.getPO(getUY_Gerencial_Journal_ID(), get_TrxName());	}

	/** Set UY_Gerencial_Journal.
		@param UY_Gerencial_Journal_ID UY_Gerencial_Journal	  */
	public void setUY_Gerencial_Journal_ID (int UY_Gerencial_Journal_ID)
	{
		if (UY_Gerencial_Journal_ID < 1) 
			set_Value (COLUMNNAME_UY_Gerencial_Journal_ID, null);
		else 
			set_Value (COLUMNNAME_UY_Gerencial_Journal_ID, Integer.valueOf(UY_Gerencial_Journal_ID));
	}

	/** Get UY_Gerencial_Journal.
		@return UY_Gerencial_Journal	  */
	public int getUY_Gerencial_Journal_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_Gerencial_Journal_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
