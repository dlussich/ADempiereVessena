...
/** Generated Model for UY_AcctNavCC_CCDET
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_AcctNavCC_CCDET extends PO implements I_UY_AcctNavCC_CCDET, I_Persistent 
{
    ...
    public X_UY_AcctNavCC_CCDET (Properties ctx, int UY_AcctNavCC_CCDET_ID, String trxName)
    {
      super (ctx, UY_AcctNavCC_CCDET_ID, trxName);
      /** if (UY_AcctNavCC_CCDET_ID == 0)
        {
			setC_Activity_ID_1 (0);
			setGL_Journal_ID (0);
			setUY_AcctNavCC_Account_ID (0);
			setUY_AcctNavCC_CCDET_ID (0);
    ...
    /** Load Constructor */
    public X_UY_AcctNavCC_CCDET (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_AcctNavCC_CCDET[")
	...
	/** Set UY_AcctNavCC_CCDET.
		@param UY_AcctNavCC_CCDET_ID UY_AcctNavCC_CCDET	  */
	public void setUY_AcctNavCC_CCDET_ID (int UY_AcctNavCC_CCDET_ID)
	{
		if (UY_AcctNavCC_CCDET_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_AcctNavCC_CCDET_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_AcctNavCC_CCDET_ID, Integer.valueOf(UY_AcctNavCC_CCDET_ID));
	}

	/** Get UY_AcctNavCC_CCDET.
		@return UY_AcctNavCC_CCDET	  */
	public int getUY_AcctNavCC_CCDET_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_AcctNavCC_CCDET_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
    ...
    {
		return (I_UY_AcctNavCC_CC)MTable.get(getCtx(), I_UY_AcctNavCC_CC.Table_Name)
			.getPO(getUY_AcctNavCC_CC_ID(), get_TrxName());	}
	...
	public void setUY_AcctNavCC_CC_ID (int UY_AcctNavCC_CC_ID)
	{
		if (UY_AcctNavCC_CC_ID < 1) 
			set_Value (COLUMNNAME_UY_AcctNavCC_CC_ID, null);
		else 
			set_Value (COLUMNNAME_UY_AcctNavCC_CC_ID, Integer.valueOf(UY_AcctNavCC_CC_ID));
	}
