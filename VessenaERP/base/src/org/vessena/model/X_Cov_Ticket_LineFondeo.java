...
/** Generated Model for Cov_Ticket_LineFondeo
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_Cov_Ticket_LineFondeo extends PO implements I_Cov_Ticket_LineFondeo, I_Persistent 
{
    ...
    public X_Cov_Ticket_LineFondeo (Properties ctx, int Cov_Ticket_LineFondeo_ID, String trxName)
    {
      super (ctx, Cov_Ticket_LineFondeo_ID, trxName);
      /** if (Cov_Ticket_LineFondeo_ID == 0)
        {
			setCov_Ticket_LineFondeo_ID (0);
        } */
    }

    /** Load Constructor */
    public X_Cov_Ticket_LineFondeo (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Cov_Ticket_LineFondeo[")
	...
	/** Set Cov_Ticket_LineFondeo.
		@param Cov_Ticket_LineFondeo_ID Cov_Ticket_LineFondeo	  */
	public void setCov_Ticket_LineFondeo_ID (int Cov_Ticket_LineFondeo_ID)
	{
		if (Cov_Ticket_LineFondeo_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Cov_Ticket_LineFondeo_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Cov_Ticket_LineFondeo_ID, Integer.valueOf(Cov_Ticket_LineFondeo_ID));
	}

	/** Get Cov_Ticket_LineFondeo.
		@return Cov_Ticket_LineFondeo	  */
	public int getCov_Ticket_LineFondeo_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_Cov_Ticket_LineFondeo_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
