...
/** Generated Model for UY_RT_ConfirmProd
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_RT_ConfirmProd extends PO implements I_UY_RT_ConfirmProd, I_Persistent 
{
    ...
    public X_UY_RT_ConfirmProd (Properties ctx, int UY_RT_ConfirmProd_ID, String trxName)
    {
      super (ctx, UY_RT_ConfirmProd_ID, trxName);
      /** if (UY_RT_ConfirmProd_ID == 0)
        {
			setAD_User_ID (0);
			setC_DocType_ID (0);
    ...
    /** Load Constructor */
    public X_UY_RT_ConfirmProd (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_RT_ConfirmProd[")
	...
	public void setUY_RT_ConfirmProd_ID (int UY_RT_ConfirmProd_ID)
	{
		if (UY_RT_ConfirmProd_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_RT_ConfirmProd_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_RT_ConfirmProd_ID, Integer.valueOf(UY_RT_ConfirmProd_ID));
	}
