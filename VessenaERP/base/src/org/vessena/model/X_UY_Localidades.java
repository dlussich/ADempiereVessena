...
/** Generated Model for UY_Localidades
 *  @author Adempiere (generated) 
 *  @version Release 3.5.4a - $Id$ */
public class X_UY_Localidades extends PO implements I_UY_Localidades, I_Persistent 
{
    ...
    public X_UY_Localidades (Properties ctx, int UY_Localidades_ID, String trxName)
    {
      super (ctx, UY_Localidades_ID, trxName);
      /** if (UY_Localidades_ID == 0)
        {
			setUY_Localidades_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_Localidades (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_Localidades[")
	...
	public void setUY_Localidades_ID (int UY_Localidades_ID)
	{
		if (UY_Localidades_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_Localidades_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_Localidades_ID, Integer.valueOf(UY_Localidades_ID));
	}
