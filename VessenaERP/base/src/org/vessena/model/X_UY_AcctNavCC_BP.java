...
/** Generated Model for UY_AcctNavCC_BP
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_AcctNavCC_BP extends PO implements I_UY_AcctNavCC_BP, I_Persistent 
{
    ...
    public X_UY_AcctNavCC_BP (Properties ctx, int UY_AcctNavCC_BP_ID, String trxName)
    {
      super (ctx, UY_AcctNavCC_BP_ID, trxName);
      /** if (UY_AcctNavCC_BP_ID == 0)
        {
			setC_BPartner_ID (0);
			setUY_AcctNavCC_Account_ID (0);
			setUY_AcctNavCC_BP_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_AcctNavCC_BP (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_AcctNavCC_BP[")
	...
	public void setUY_AcctNavCC_BP_ID (int UY_AcctNavCC_BP_ID)
	{
		if (UY_AcctNavCC_BP_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_AcctNavCC_BP_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_AcctNavCC_BP_ID, Integer.valueOf(UY_AcctNavCC_BP_ID));
	}
