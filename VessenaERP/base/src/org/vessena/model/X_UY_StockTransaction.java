...
/** Generated Model for UY_StockTransaction
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_StockTransaction extends PO implements I_UY_StockTransaction, I_Persistent 
{
    ...
    public X_UY_StockTransaction (Properties ctx, int UY_StockTransaction_ID, String trxName)
    {
      super (ctx, UY_StockTransaction_ID, trxName);
      /** if (UY_StockTransaction_ID == 0)
        {
			setad_table_affected_id (0);
			setAD_Table_ID (0);
			setAD_User_ID (0);
			setc_doctype_affected_id (0);
			setC_DocType_ID (0);
			setC_Period_ID (0);
			setC_UOM_ID (0);
			setDateTrx (new Timestamp( System.currentTimeMillis() ));
			setDocumentNo (null);
			setdocumentno_affected (null);
    ...
    /** Load Constructor */
    public X_UY_StockTransaction (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_StockTransaction[")
        .append(get_ID()).append("]");
      return sb.toString();
    }

	/** Set ad_table_affected_id.
		@param ad_table_affected_id ad_table_affected_id	  */
	public void setad_table_affected_id (int ad_table_affected_id)
	{
		set_Value (COLUMNNAME_ad_table_affected_id, Integer.valueOf(ad_table_affected_id));
	}

	/** Get ad_table_affected_id.
		@return ad_table_affected_id	  */
	public int getad_table_affected_id () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_ad_table_affected_id);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	{
		set_Value (COLUMNNAME_c_doctype_affected_id, Integer.valueOf(c_doctype_affected_id));
	}
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_c_doctype_affected_id);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set documentno_affected.
		@param documentno_affected documentno_affected	  */
	public void setdocumentno_affected (String documentno_affected)
	{
		set_Value (COLUMNNAME_documentno_affected, documentno_affected);
	}

	/** Get documentno_affected.
		@return documentno_affected	  */
	public String getdocumentno_affected () 
	{
		return (String)get_Value(COLUMNNAME_documentno_affected);
	}
	...
	/** Set record_affected_id.
		@param record_affected_id record_affected_id	  */
	public void setrecord_affected_id (int record_affected_id)
	{
		set_Value (COLUMNNAME_record_affected_id, Integer.valueOf(record_affected_id));
	}

	/** Get record_affected_id.
		@return record_affected_id	  */
	public int getrecord_affected_id () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_record_affected_id);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	public void setUY_StockTransaction_ID (int UY_StockTransaction_ID)
	{
		if (UY_StockTransaction_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_StockTransaction_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_StockTransaction_ID, Integer.valueOf(UY_StockTransaction_ID));
	}
