...
/** Generated Model for UY_BG_DailyPrice
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_BG_DailyPrice extends PO implements I_UY_BG_DailyPrice, I_Persistent 
{
    ...
    public X_UY_BG_DailyPrice (Properties ctx, int UY_BG_DailyPrice_ID, String trxName)
    {
      super (ctx, UY_BG_DailyPrice_ID, trxName);
      /** if (UY_BG_DailyPrice_ID == 0)
        {
			setAD_User_ID (0);
...
// DR
			...
			setProcessed (false);
			setUY_BG_Bursa_ID (0);
			setUY_BG_DailyPrice_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_BG_DailyPrice (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_BG_DailyPrice[")
	...
	/** Set UY_BG_DailyPrice.
		@param UY_BG_DailyPrice_ID UY_BG_DailyPrice	  */
	public void setUY_BG_DailyPrice_ID (int UY_BG_DailyPrice_ID)
	{
		if (UY_BG_DailyPrice_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_BG_DailyPrice_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_BG_DailyPrice_ID, Integer.valueOf(UY_BG_DailyPrice_ID));
	}

	/** Get UY_BG_DailyPrice.
		@return UY_BG_DailyPrice	  */
	public int getUY_BG_DailyPrice_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_BG_DailyPrice_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
