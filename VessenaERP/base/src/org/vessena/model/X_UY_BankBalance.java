...
/** Generated Model for UY_BankBalance
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_BankBalance extends PO implements I_UY_BankBalance, I_Persistent 
{
    ...
    public X_UY_BankBalance (Properties ctx, int UY_BankBalance_ID, String trxName)
    {
      super (ctx, UY_BankBalance_ID, trxName);
      /** if (UY_BankBalance_ID == 0)
        {
			setC_DocType_ID (0);
    ...
    /** Load Constructor */
    public X_UY_BankBalance (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_BankBalance[")
	...
	public void setUY_BankBalance_ID (int UY_BankBalance_ID)
	{
		if (UY_BankBalance_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_BankBalance_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_BankBalance_ID, Integer.valueOf(UY_BankBalance_ID));
	}
