...
/** Generated Model for UY_TR_ReadKM
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_TR_ReadKM extends PO implements I_UY_TR_ReadKM, I_Persistent 
{
    ...
    public X_UY_TR_ReadKM (Properties ctx, int UY_TR_ReadKM_ID, String trxName)
    {
      super (ctx, UY_TR_ReadKM_ID, trxName);
      /** if (UY_TR_ReadKM_ID == 0)
        {
			setC_DocType_ID (0);
...
// Y
    ...
    /** Load Constructor */
    public X_UY_TR_ReadKM (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_TR_ReadKM[")
	...
	public void setUY_TR_ReadKM_ID (int UY_TR_ReadKM_ID)
	{
		if (UY_TR_ReadKM_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_TR_ReadKM_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_TR_ReadKM_ID, Integer.valueOf(UY_TR_ReadKM_ID));
	}
