...
/** Generated Model for UY_BG_Notification
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_BG_Notification extends PO implements I_UY_BG_Notification, I_Persistent 
{
    ...
    public X_UY_BG_Notification (Properties ctx, int UY_BG_Notification_ID, String trxName)
    {
      super (ctx, UY_BG_Notification_ID, trxName);
      /** if (UY_BG_Notification_ID == 0)
        {
...
// DR
			setDocumentNo (null);
			setProcessed (false);
			setUY_BG_Notification_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_BG_Notification (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_BG_Notification[")
	...
	/** Set TypeCRT.
		@param TypeCRT TypeCRT	  */
	public void setTypeCRT (String TypeCRT)
	{
		set_Value (COLUMNNAME_TypeCRT, TypeCRT);
	}

	/** Get TypeCRT.
		@return TypeCRT	  */
	public String getTypeCRT () 
	{
		return (String)get_Value(COLUMNNAME_TypeCRT);
	}
	...
	/** Set UY_BG_Notification.
		@param UY_BG_Notification_ID UY_BG_Notification	  */
	public void setUY_BG_Notification_ID (int UY_BG_Notification_ID)
	{
		if (UY_BG_Notification_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_BG_Notification_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_BG_Notification_ID, Integer.valueOf(UY_BG_Notification_ID));
	}

	/** Get UY_BG_Notification.
		@return UY_BG_Notification	  */
	public int getUY_BG_Notification_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_BG_Notification_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
