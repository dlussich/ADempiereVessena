...
/** Generated Model for UY_Resguardo
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_Resguardo extends PO implements I_UY_Resguardo, I_Persistent 
{
    ...
    public X_UY_Resguardo (Properties ctx, int UY_Resguardo_ID, String trxName)
    {
      super (ctx, UY_Resguardo_ID, trxName);
      /** if (UY_Resguardo_ID == 0)
        {
			setC_Currency_ID (0);
			setC_DocType_ID (0);
...
// N
    ...
    /** Load Constructor */
    public X_UY_Resguardo (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_Resguardo[")
