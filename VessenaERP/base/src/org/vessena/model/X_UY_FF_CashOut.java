...
/** Generated Model for UY_FF_CashOut
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_UY_FF_CashOut extends PO implements I_UY_FF_CashOut, I_Persistent 
{
    ...
    public X_UY_FF_CashOut (Properties ctx, int UY_FF_CashOut_ID, String trxName)
    {
      super (ctx, UY_FF_CashOut_ID, trxName);
      /** if (UY_FF_CashOut_ID == 0)
        {
			setAD_User_ID (0);
			setAmount (Env.ZERO);
			setC_Currency_ID (0);
...
// DR
    ...
    /** Load Constructor */
    public X_UY_FF_CashOut (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_FF_CashOut[")
	...
	public void setUY_FF_CashOut_ID (int UY_FF_CashOut_ID)
	{
		if (UY_FF_CashOut_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_FF_CashOut_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_FF_CashOut_ID, Integer.valueOf(UY_FF_CashOut_ID));
	}
	...
	/** Set UY_FF_CashOut_ID_1.
		@param UY_FF_CashOut_ID_1 UY_FF_CashOut_ID_1	  */
	public void setUY_FF_CashOut_ID_1 (int UY_FF_CashOut_ID_1)
	{
		set_Value (COLUMNNAME_UY_FF_CashOut_ID_1, Integer.valueOf(UY_FF_CashOut_ID_1));
	}

	/** Get UY_FF_CashOut_ID_1.
		@return UY_FF_CashOut_ID_1	  */
	public int getUY_FF_CashOut_ID_1 () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_FF_CashOut_ID_1);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
