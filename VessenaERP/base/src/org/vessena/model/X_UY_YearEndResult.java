...
/** Generated Model for UY_YearEndResult
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_UY_YearEndResult extends PO implements I_UY_YearEndResult, I_Persistent 
{
    ...
    public X_UY_YearEndResult (Properties ctx, int UY_YearEndResult_ID, String trxName)
    {
      super (ctx, UY_YearEndResult_ID, trxName);
      /** if (UY_YearEndResult_ID == 0)
        {
			setC_DocType_ID (0);
...
// N
    ...
    /** Load Constructor */
    public X_UY_YearEndResult (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_YearEndResult[")
	...
	public void setUY_YearEndResult_ID (int UY_YearEndResult_ID)
	{
		if (UY_YearEndResult_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_YearEndResult_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_YearEndResult_ID, Integer.valueOf(UY_YearEndResult_ID));
	}
