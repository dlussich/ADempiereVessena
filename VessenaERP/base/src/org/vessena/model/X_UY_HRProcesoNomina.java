...
/** Generated Model for UY_HRProcesoNomina
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_UY_HRProcesoNomina extends PO implements I_UY_HRProcesoNomina, I_Persistent 
{
    ...
    public X_UY_HRProcesoNomina (Properties ctx, int UY_HRProcesoNomina_ID, String trxName)
    {
      super (ctx, UY_HRProcesoNomina_ID, trxName);
      /** if (UY_HRProcesoNomina_ID == 0)
        {
			setDocAction (null);
// CO
			setDocStatus (null);
...
// N
    ...
    /** Load Constructor */
    public X_UY_HRProcesoNomina (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_HRProcesoNomina[")
	...
	public void setUY_HRProcesoNomina_ID (int UY_HRProcesoNomina_ID)
	{
		if (UY_HRProcesoNomina_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_HRProcesoNomina_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_HRProcesoNomina_ID, Integer.valueOf(UY_HRProcesoNomina_ID));
	}
