 ...
 * Fecha : 29/03/2011
 */
public class MInvoiceBook extends X_UY_InvoiceBook {
	 ...
	 * @param trxName
	 */
	public MInvoiceBook(Properties ctx, int UY_InvoiceBook_ID, String trxName) {
	 ...
	 * @param trxName
	 */
	public MInvoiceBook(Properties ctx, ResultSet rs, String trxName) {
