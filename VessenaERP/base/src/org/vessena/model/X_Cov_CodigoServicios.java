...
/** Generated Model for Cov_CodigoServicios
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_Cov_CodigoServicios extends PO implements I_Cov_CodigoServicios, I_Persistent 
{
    ...
    public X_Cov_CodigoServicios (Properties ctx, int Cov_CodigoServicios_ID, String trxName)
    {
      super (ctx, Cov_CodigoServicios_ID, trxName);
      /** if (Cov_CodigoServicios_ID == 0)
        {
			setCov_CodigoServicios_ID (0);
			setName (null);
			setValue (null);
        } */
    }
    ...
    /** Load Constructor */
    public X_Cov_CodigoServicios (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Cov_CodigoServicios[")
	...
	public void setCov_CodigoServicios_ID (int Cov_CodigoServicios_ID)
	{
		if (Cov_CodigoServicios_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Cov_CodigoServicios_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Cov_CodigoServicios_ID, Integer.valueOf(Cov_CodigoServicios_ID));
	}
