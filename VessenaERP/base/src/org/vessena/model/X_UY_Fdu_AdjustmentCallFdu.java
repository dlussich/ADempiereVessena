...
/** Generated Model for UY_Fdu_AdjustmentCallFdu
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_UY_Fdu_AdjustmentCallFdu extends PO implements I_UY_Fdu_AdjustmentCallFdu, I_Persistent 
{
    ...
    public X_UY_Fdu_AdjustmentCallFdu (Properties ctx, int UY_Fdu_AdjustmentCallFdu_ID, String trxName)
    {
      super (ctx, UY_Fdu_AdjustmentCallFdu_ID, trxName);
      /** if (UY_Fdu_AdjustmentCallFdu_ID == 0)
        {
			setAD_User_ID (0);
			setC_DocType_ID (0);
...
// CO
    ...
    /** Load Constructor */
    public X_UY_Fdu_AdjustmentCallFdu (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_Fdu_AdjustmentCallFdu[")
	...
	public void setUY_Fdu_AdjustmentCallFdu_ID (int UY_Fdu_AdjustmentCallFdu_ID)
	{
		if (UY_Fdu_AdjustmentCallFdu_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_Fdu_AdjustmentCallFdu_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_Fdu_AdjustmentCallFdu_ID, Integer.valueOf(UY_Fdu_AdjustmentCallFdu_ID));
	}
