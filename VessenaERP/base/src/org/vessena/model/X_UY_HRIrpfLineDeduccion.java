...
/** Generated Model for UY_HRIrpfLineDeduccion
 *  @author Adempiere (generated) 
 *  @version Release 3.5.4a - $Id$ */
public class X_UY_HRIrpfLineDeduccion extends PO implements I_UY_HRIrpfLineDeduccion, I_Persistent 
{
    ...
    public X_UY_HRIrpfLineDeduccion (Properties ctx, int UY_HRIrpfLineDeduccion_ID, String trxName)
    {
      super (ctx, UY_HRIrpfLineDeduccion_ID, trxName);
      /** if (UY_HRIrpfLineDeduccion_ID == 0)
        {
			setanual (false);
			...
			setUY_HRIrpf_ID (0);
			setUY_HRIrpfLineDeduccion_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_HRIrpfLineDeduccion (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_HRIrpfLineDeduccion[")
	...
	/** Set UY_HRIrpfLineDeduccion.
		@param UY_HRIrpfLineDeduccion_ID UY_HRIrpfLineDeduccion	  */
	public void setUY_HRIrpfLineDeduccion_ID (int UY_HRIrpfLineDeduccion_ID)
	{
		if (UY_HRIrpfLineDeduccion_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_HRIrpfLineDeduccion_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_HRIrpfLineDeduccion_ID, Integer.valueOf(UY_HRIrpfLineDeduccion_ID));
	}

	/** Get UY_HRIrpfLineDeduccion.
		@return UY_HRIrpfLineDeduccion	  */
	public int getUY_HRIrpfLineDeduccion_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_HRIrpfLineDeduccion_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
