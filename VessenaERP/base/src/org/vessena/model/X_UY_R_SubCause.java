...
/** Generated Model for UY_R_SubCause
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_R_SubCause extends PO implements I_UY_R_SubCause, I_Persistent 
{
    ...
    public X_UY_R_SubCause (Properties ctx, int UY_R_SubCause_ID, String trxName)
    {
      super (ctx, UY_R_SubCause_ID, trxName);
      /** if (UY_R_SubCause_ID == 0)
        {
			setName (null);
			setUY_R_Cause_ID (0);
			setUY_R_SubCause_ID (0);
			setValue (null);
        } */
    }

    /** Load Constructor */
    public X_UY_R_SubCause (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_R_SubCause[")
	...
	public void setUY_R_SubCause_ID (int UY_R_SubCause_ID)
	{
		if (UY_R_SubCause_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_R_SubCause_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_R_SubCause_ID, Integer.valueOf(UY_R_SubCause_ID));
	}
