...
public class MHRIrpfLineDeduccion extends X_UY_HRIrpfLineDeduccion {

	private static final long serialVersionUID = 1L;

	public MHRIrpfLineDeduccion(Properties ctx, int UY_HRIrpfLineDeduccion_ID, String trxName) {
		super(ctx, UY_HRIrpfLineDeduccion_ID, trxName);
		// TODO Auto-generated constructor stub
	}

	public MHRIrpfLineDeduccion(Properties ctx, ResultSet rs, String trxName) {
	...
	protected boolean beforeSave(boolean newRecord) {
		...
		/*if(newRecord){
			String sql = "SELECT max(hasta) from uy_hrirpflinededuccion WHERE uy_hrirpf_id=" + hdr.get_ID();
