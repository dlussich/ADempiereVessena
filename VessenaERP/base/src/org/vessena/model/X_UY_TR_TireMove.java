...
/** Generated Model for UY_TR_TireMove
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_TR_TireMove extends PO implements I_UY_TR_TireMove, I_Persistent 
{

	/**
	 *
	 */
	private static final long serialVersionUID = 20140511L;

    /** Standard Constructor */
    public X_UY_TR_TireMove (Properties ctx, int UY_TR_TireMove_ID, String trxName)
    {
      super (ctx, UY_TR_TireMove_ID, trxName);
      /** if (UY_TR_TireMove_ID == 0)
        {
			setC_DocType_ID (0);
...
// DR
			setDocumentNo (null);
			setProcessed (false);
			setUY_TR_TireMove_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_TR_TireMove (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_TR_TireMove[")
	...
	{
		set_Value (COLUMNNAME_QtyAux, QtyAux);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_QtyAux);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	{
		set_Value (COLUMNNAME_QtyAxis, QtyAxis);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_QtyAxis);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	public void setUY_TR_TireMove_ID (int UY_TR_TireMove_ID)
	{
		if (UY_TR_TireMove_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_TR_TireMove_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_TR_TireMove_ID, Integer.valueOf(UY_TR_TireMove_ID));
	}
