...
/** Generated Model for UY_Payment_Resguardo
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_Payment_Resguardo extends PO implements I_UY_Payment_Resguardo, I_Persistent 
{
    ...
    public X_UY_Payment_Resguardo (Properties ctx, int UY_Payment_Resguardo_ID, String trxName)
    {
      super (ctx, UY_Payment_Resguardo_ID, trxName);
      /** if (UY_Payment_Resguardo_ID == 0)
        {
			setC_Payment_ID (0);
			setUY_Payment_Resguardo_ID (0);
			setUY_Resguardo_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_Payment_Resguardo (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_Payment_Resguardo[")
	...
	/** Set UY_Payment_Resguardo.
		@param UY_Payment_Resguardo_ID UY_Payment_Resguardo	  */
	public void setUY_Payment_Resguardo_ID (int UY_Payment_Resguardo_ID)
	{
		if (UY_Payment_Resguardo_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_Payment_Resguardo_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_Payment_Resguardo_ID, Integer.valueOf(UY_Payment_Resguardo_ID));
	}

	/** Get UY_Payment_Resguardo.
		@return UY_Payment_Resguardo	  */
	public int getUY_Payment_Resguardo_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_Payment_Resguardo_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
    ...
    {
		return (I_UY_ResguardoLine)MTable.get(getCtx(), I_UY_ResguardoLine.Table_Name)
			.getPO(getUY_ResguardoLine_ID(), get_TrxName());	}
	...
	public void setUY_ResguardoLine_ID (int UY_ResguardoLine_ID)
	{
		if (UY_ResguardoLine_ID < 1) 
			set_Value (COLUMNNAME_UY_ResguardoLine_ID, null);
		else 
			set_Value (COLUMNNAME_UY_ResguardoLine_ID, Integer.valueOf(UY_ResguardoLine_ID));
	}
