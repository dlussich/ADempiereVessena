...
/** Generated Model for UY_StoreLOSaleLine
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_StoreLOSaleLine extends PO implements I_UY_StoreLOSaleLine, I_Persistent 
{
    ...
    public X_UY_StoreLOSaleLine (Properties ctx, int UY_StoreLOSaleLine_ID, String trxName)
    {
      super (ctx, UY_StoreLOSaleLine_ID, trxName);
      /** if (UY_StoreLOSaleLine_ID == 0)
        {
			setLineTotalAmt (Env.ZERO);
			setM_Product_ID (0);
			setproductpu (Env.ZERO);
			setUY_StoreLOSale_ID (0);
			setUY_StoreLOSaleLine_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_StoreLOSaleLine (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_StoreLOSaleLine[")
	...
	/** Set UY_StoreLOSaleLine.
		@param UY_StoreLOSaleLine_ID UY_StoreLOSaleLine	  */
	public void setUY_StoreLOSaleLine_ID (int UY_StoreLOSaleLine_ID)
	{
		if (UY_StoreLOSaleLine_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_StoreLOSaleLine_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_StoreLOSaleLine_ID, Integer.valueOf(UY_StoreLOSaleLine_ID));
	}

	/** Get UY_StoreLOSaleLine.
		@return UY_StoreLOSaleLine	  */
	public int getUY_StoreLOSaleLine_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_StoreLOSaleLine_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
