...
/** Generated Model for UY_FF_Replenish
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_UY_FF_Replenish extends PO implements I_UY_FF_Replenish, I_Persistent 
{
    ...
    public X_UY_FF_Replenish (Properties ctx, int UY_FF_Replenish_ID, String trxName)
    {
      super (ctx, UY_FF_Replenish_ID, trxName);
      /** if (UY_FF_Replenish_ID == 0)
        {
			setActualAmt (Env.ZERO);
			setamtacumulate (Env.ZERO);
			setAmtOriginal (Env.ZERO);
			setC_Currency_ID (0);
			setC_DocType_ID (0);
...
// DR
    ...
    /** Load Constructor */
    public X_UY_FF_Replenish (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_FF_Replenish[")
	...
	/** Set amtacumulate.
		@param amtacumulate amtacumulate	  */
	public void setamtacumulate (BigDecimal amtacumulate)
	{
		set_Value (COLUMNNAME_amtacumulate, amtacumulate);
	}

	/** Get amtacumulate.
		@return amtacumulate	  */
	public BigDecimal getamtacumulate () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_amtacumulate);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	{
		set_ValueNoCheck (COLUMNNAME_DateFrom, DateFrom);
	}
	...
	public void setUY_FF_Branch_ID (int UY_FF_Branch_ID)
	{
		if (UY_FF_Branch_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_FF_Branch_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_FF_Branch_ID, Integer.valueOf(UY_FF_Branch_ID));
	}
	...
	public void setUY_FF_Replenish_ID (int UY_FF_Replenish_ID)
	{
		if (UY_FF_Replenish_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_FF_Replenish_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_FF_Replenish_ID, Integer.valueOf(UY_FF_Replenish_ID));
	}
