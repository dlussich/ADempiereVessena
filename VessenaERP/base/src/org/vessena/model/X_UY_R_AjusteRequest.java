...
/** Generated Model for UY_R_AjusteRequest
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_R_AjusteRequest extends PO implements I_UY_R_AjusteRequest, I_Persistent 
{
    ...
    public X_UY_R_AjusteRequest (Properties ctx, int UY_R_AjusteRequest_ID, String trxName)
    {
      super (ctx, UY_R_AjusteRequest_ID, trxName);
      /** if (UY_R_AjusteRequest_ID == 0)
        {
			setAD_User_ID (0);
			setC_DocType_ID (0);
...
// N
    ...
    /** Load Constructor */
    public X_UY_R_AjusteRequest (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_R_AjusteRequest[")
	...
	public void setUY_R_AjusteRequest_ID (int UY_R_AjusteRequest_ID)
	{
		if (UY_R_AjusteRequest_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_R_AjusteRequest_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_R_AjusteRequest_ID, Integer.valueOf(UY_R_AjusteRequest_ID));
	}
