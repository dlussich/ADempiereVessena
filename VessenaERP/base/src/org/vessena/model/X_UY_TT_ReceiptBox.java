...
/** Generated Model for UY_TT_ReceiptBox
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_TT_ReceiptBox extends PO implements I_UY_TT_ReceiptBox, I_Persistent 
{
    ...
    public X_UY_TT_ReceiptBox (Properties ctx, int UY_TT_ReceiptBox_ID, String trxName)
    {
      super (ctx, UY_TT_ReceiptBox_ID, trxName);
      /** if (UY_TT_ReceiptBox_ID == 0)
        {
			setComunicaUsuario (false);
// N
			setImpresionVale (false);
// N
			setUY_TT_ReceiptBox_ID (0);
			setUY_TT_Receipt_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_TT_ReceiptBox (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_TT_ReceiptBox[")
	...
	/** Set UY_TT_ReceiptBox.
		@param UY_TT_ReceiptBox_ID UY_TT_ReceiptBox	  */
	public void setUY_TT_ReceiptBox_ID (int UY_TT_ReceiptBox_ID)
	{
		if (UY_TT_ReceiptBox_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_TT_ReceiptBox_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_TT_ReceiptBox_ID, Integer.valueOf(UY_TT_ReceiptBox_ID));
	}

	/** Get UY_TT_ReceiptBox.
		@return UY_TT_ReceiptBox	  */
	public int getUY_TT_ReceiptBox_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_TT_ReceiptBox_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
