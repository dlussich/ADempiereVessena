...
/** Generated Model for UY_RecuentoConf
 *  @author Adempiere (generated) 
 *  @version Release 3.5.4a - $Id$ */
public class X_UY_RecuentoConf extends PO implements I_UY_RecuentoConf, I_Persistent 
{
    ...
    public X_UY_RecuentoConf (Properties ctx, int UY_RecuentoConf_ID, String trxName)
    {
      super (ctx, UY_RecuentoConf_ID, trxName);
      /** if (UY_RecuentoConf_ID == 0)
        {
			setC_DocType_ID (0);
			setDocumentNo (null);
    ...
    /** Load Constructor */
    public X_UY_RecuentoConf (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_RecuentoConf[")
	...
	public void setUY_RecuentoConf_ID (int UY_RecuentoConf_ID)
	{
		if (UY_RecuentoConf_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_RecuentoConf_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_RecuentoConf_ID, Integer.valueOf(UY_RecuentoConf_ID));
	}
	...
	public void setUY_RecuentoDef_ID (int UY_RecuentoDef_ID)
	{
		if (UY_RecuentoDef_ID < 1) 
			set_Value (COLUMNNAME_UY_RecuentoDef_ID, null);
		else 
			set_Value (COLUMNNAME_UY_RecuentoDef_ID, Integer.valueOf(UY_RecuentoDef_ID));
	}
