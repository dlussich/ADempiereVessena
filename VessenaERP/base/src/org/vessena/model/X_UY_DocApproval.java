...
/** Generated Model for UY_DocApproval
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_DocApproval extends PO implements I_UY_DocApproval, I_Persistent 
{
    ...
    public X_UY_DocApproval (Properties ctx, int UY_DocApproval_ID, String trxName)
    {
      super (ctx, UY_DocApproval_ID, trxName);
      /** if (UY_DocApproval_ID == 0)
        {
			setC_DocType_ID (0);
			setDocStatus (null);
			setDocumentNo (null);
    ...
    /** Load Constructor */
    public X_UY_DocApproval (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_DocApproval[")
	...
	public void setUY_DocApproval_ID (int UY_DocApproval_ID)
	{
		if (UY_DocApproval_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_DocApproval_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_DocApproval_ID, Integer.valueOf(UY_DocApproval_ID));
	}
