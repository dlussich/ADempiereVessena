...
/** Generated Model for UY_Gerencial_Main
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_Gerencial_Main extends PO implements I_UY_Gerencial_Main, I_Persistent 
{
    ...
    public X_UY_Gerencial_Main (Properties ctx, int UY_Gerencial_Main_ID, String trxName)
    {
      super (ctx, UY_Gerencial_Main_ID, trxName);
      /** if (UY_Gerencial_Main_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_UY_Gerencial_Main (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_Gerencial_Main[")
	...
	/** ColorSelector AD_Reference_ID=1000242 */
	public static final int COLORSELECTOR_AD_Reference_ID=1000242;
	/** DARK_BLUE = DARK_BLUE */
	public static final String COLORSELECTOR_DARK_BLUE = "DARK_BLUE";
	/** THIN_BLUE = THIN_BLUE */
	public static final String COLORSELECTOR_THIN_BLUE = "THIN_BLUE";
	/** Set ColorSelector.
	...
	public void setUY_Gerencial_Main_ID (int UY_Gerencial_Main_ID)
	{
		if (UY_Gerencial_Main_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_Gerencial_Main_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_Gerencial_Main_ID, Integer.valueOf(UY_Gerencial_Main_ID));
	}
