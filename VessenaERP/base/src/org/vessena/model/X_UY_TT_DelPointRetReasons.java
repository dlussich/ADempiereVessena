...
/** Generated Model for UY_TT_DelPointRetReasons
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_TT_DelPointRetReasons extends PO implements I_UY_TT_DelPointRetReasons, I_Persistent 
{
    ...
    public X_UY_TT_DelPointRetReasons (Properties ctx, int UY_TT_DelPointRetReasons_ID, String trxName)
    {
      super (ctx, UY_TT_DelPointRetReasons_ID, trxName);
      /** if (UY_TT_DelPointRetReasons_ID == 0)
        {
			setName (null);
			setUY_DeliveryPoint_ID (0);
			setUY_TT_DelPointRetReasons_ID (0);
			setUY_TT_ReturnReasons_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_TT_DelPointRetReasons (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_TT_DelPointRetReasons[")
	...
	public void setUY_TT_DelPointRetReasons_ID (int UY_TT_DelPointRetReasons_ID)
	{
		if (UY_TT_DelPointRetReasons_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_TT_DelPointRetReasons_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_TT_DelPointRetReasons_ID, Integer.valueOf(UY_TT_DelPointRetReasons_ID));
	}
