...
/** Generated Model for UY_TR_TruckRepair
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_TR_TruckRepair extends PO implements I_UY_TR_TruckRepair, I_Persistent 
{
    ...
    public X_UY_TR_TruckRepair (Properties ctx, int UY_TR_TruckRepair_ID, String trxName)
    {
      super (ctx, UY_TR_TruckRepair_ID, trxName);
      /** if (UY_TR_TruckRepair_ID == 0)
        {
			setIsOwn (false);
// N
			setKilometros (0);
			...
			setUY_TR_Truck_ID (0);
			setUY_TR_TruckRepair_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_TR_TruckRepair (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_TR_TruckRepair[")
	...
	/** Set UY_TR_TruckRepair.
		@param UY_TR_TruckRepair_ID UY_TR_TruckRepair	  */
	public void setUY_TR_TruckRepair_ID (int UY_TR_TruckRepair_ID)
	{
		if (UY_TR_TruckRepair_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_TR_TruckRepair_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_TR_TruckRepair_ID, Integer.valueOf(UY_TR_TruckRepair_ID));
	}

	/** Get UY_TR_TruckRepair.
		@return UY_TR_TruckRepair	  */
	public int getUY_TR_TruckRepair_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_TR_TruckRepair_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
