...
/** Generated Model for UY_TT_ReceiptCourier
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_UY_TT_ReceiptCourier extends PO implements I_UY_TT_ReceiptCourier, I_Persistent 
{
    ...
    public X_UY_TT_ReceiptCourier (Properties ctx, int UY_TT_ReceiptCourier_ID, String trxName)
    {
      super (ctx, UY_TT_ReceiptCourier_ID, trxName);
      /** if (UY_TT_ReceiptCourier_ID == 0)
        {
			setAD_User_ID (0);
			setC_DocType_ID (0);
...
// DR
    ...
    /** Load Constructor */
    public X_UY_TT_ReceiptCourier (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_TT_ReceiptCourier[")
	...
	public void setUY_TT_ReceiptCourier_ID (int UY_TT_ReceiptCourier_ID)
	{
		if (UY_TT_ReceiptCourier_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_TT_ReceiptCourier_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_TT_ReceiptCourier_ID, Integer.valueOf(UY_TT_ReceiptCourier_ID));
	}
