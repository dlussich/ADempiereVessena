...
/** Generated Model for UY_R_AccionPtoResol
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_R_AccionPtoResol extends PO implements I_UY_R_AccionPtoResol, I_Persistent 
{
    ...
    public X_UY_R_AccionPtoResol (Properties ctx, int UY_R_AccionPtoResol_ID, String trxName)
    {
      super (ctx, UY_R_AccionPtoResol_ID, trxName);
      /** if (UY_R_AccionPtoResol_ID == 0)
        {
			setName (null);
			setUY_R_AccionPtoResol_ID (0);
    ...
    /** Load Constructor */
    public X_UY_R_AccionPtoResol (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_R_AccionPtoResol[")
	...
	public void setUY_R_AccionPtoResol_ID (int UY_R_AccionPtoResol_ID)
	{
		if (UY_R_AccionPtoResol_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_R_AccionPtoResol_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_R_AccionPtoResol_ID, Integer.valueOf(UY_R_AccionPtoResol_ID));
	}
