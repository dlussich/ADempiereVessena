...
/** Generated Model for UY_TR_OperativeSite
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_TR_OperativeSite extends PO implements I_UY_TR_OperativeSite, I_Persistent 
{
    ...
    public X_UY_TR_OperativeSite (Properties ctx, int UY_TR_OperativeSite_ID, String trxName)
    {
      super (ctx, UY_TR_OperativeSite_ID, trxName);
      /** if (UY_TR_OperativeSite_ID == 0)
        {
			setName (null);
			setUY_TR_Aduana_ID (0);
			setUY_TR_OperativeSite_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_TR_OperativeSite (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_TR_OperativeSite[")
	...
	public void setUY_TR_OperativeSite_ID (int UY_TR_OperativeSite_ID)
	{
		if (UY_TR_OperativeSite_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_TR_OperativeSite_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_TR_OperativeSite_ID, Integer.valueOf(UY_TR_OperativeSite_ID));
	}
