...
/** Generated Model for UY_ExtProvision
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_ExtProvision extends PO implements I_UY_ExtProvision, I_Persistent 
{
    ...
    public X_UY_ExtProvision (Properties ctx, int UY_ExtProvision_ID, String trxName)
    {
      super (ctx, UY_ExtProvision_ID, trxName);
      /** if (UY_ExtProvision_ID == 0)
        {
			setC_DocType_ID (0);
			setC_Period_ID (0);
...
// DR
    ...
    /** Load Constructor */
    public X_UY_ExtProvision (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_ExtProvision[")
	...
	public void setUY_ExtProvision_ID (int UY_ExtProvision_ID)
	{
		if (UY_ExtProvision_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_ExtProvision_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_ExtProvision_ID, Integer.valueOf(UY_ExtProvision_ID));
	}
