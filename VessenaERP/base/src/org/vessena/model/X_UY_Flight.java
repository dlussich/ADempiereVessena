...
/** Generated Model for UY_Flight
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_Flight extends PO implements I_UY_Flight, I_Persistent 
{
    ...
    public X_UY_Flight (Properties ctx, int UY_Flight_ID, String trxName)
    {
      super (ctx, UY_Flight_ID, trxName);
      /** if (UY_Flight_ID == 0)
        {
			setName (null);
			setUY_Flight_ID (0);
    ...
    /** Load Constructor */
    public X_UY_Flight (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_Flight[")
	...
	{
		if (UY_Flight_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_Flight_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_Flight_ID, Integer.valueOf(UY_Flight_ID));
	}
