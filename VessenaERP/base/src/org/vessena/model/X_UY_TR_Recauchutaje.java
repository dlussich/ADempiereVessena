...
/** Generated Model for UY_TR_Recauchutaje
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_TR_Recauchutaje extends PO implements I_UY_TR_Recauchutaje, I_Persistent 
{
    ...
    public X_UY_TR_Recauchutaje (Properties ctx, int UY_TR_Recauchutaje_ID, String trxName)
    {
      super (ctx, UY_TR_Recauchutaje_ID, trxName);
      /** if (UY_TR_Recauchutaje_ID == 0)
        {
			setC_Currency_ID (0);
// 100
			setC_DocType_ID (0);
...
// DR
			setDocumentNo (null);
			setProcessed (false);
			setUY_TR_Recauchutaje_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_TR_Recauchutaje (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_TR_Recauchutaje[")
	...
	/** Set QtyKm2.
		...
		QtyKm2
	  */
	public void setQtyKm2 (BigDecimal QtyKm2)
	{
		set_Value (COLUMNNAME_QtyKm2, QtyKm2);
	}

	/** Get QtyKm2.
		@return QtyKm2
	  */
	public BigDecimal getQtyKm2 () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_QtyKm2);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	/** Set QtyKm3.
		...
		QtyKm3
	  */
	public void setQtyKm3 (BigDecimal QtyKm3)
	{
		set_Value (COLUMNNAME_QtyKm3, QtyKm3);
	}

	/** Get QtyKm3.
		@return QtyKm3
	  */
	public BigDecimal getQtyKm3 () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_QtyKm3);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	public void setUY_TR_Recauchutaje_ID (int UY_TR_Recauchutaje_ID)
	{
		if (UY_TR_Recauchutaje_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_TR_Recauchutaje_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_TR_Recauchutaje_ID, Integer.valueOf(UY_TR_Recauchutaje_ID));
	}
	...
	/** Set UY_TR_Tire_ID_Aux.
		@param UY_TR_Tire_ID_Aux UY_TR_Tire_ID_Aux	  */
	public void setUY_TR_Tire_ID_Aux (int UY_TR_Tire_ID_Aux)
	{
		set_Value (COLUMNNAME_UY_TR_Tire_ID_Aux, Integer.valueOf(UY_TR_Tire_ID_Aux));
	}

	/** Get UY_TR_Tire_ID_Aux.
		@return UY_TR_Tire_ID_Aux	  */
	public int getUY_TR_Tire_ID_Aux () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_TR_Tire_ID_Aux);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
