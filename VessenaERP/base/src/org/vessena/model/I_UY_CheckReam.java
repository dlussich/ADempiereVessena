...
/** Generated Interface for UY_CheckReam
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC
 */
public interface I_UY_CheckReam 
{

    /** TableName=UY_CheckReam */
    public static final String Table_Name = "UY_CheckReam";
    ...
    /** Column name CheckBookType */
    public static final String COLUMNNAME_CheckBookType = "CheckBookType";
    ...
    /** Column name endcheckno */
    public static final String COLUMNNAME_endcheckno = "endcheckno";

	/** Set endcheckno	  */
	public void setendcheckno (int endcheckno);

	/** Get endcheckno	  */
	public int getendcheckno();
    ...
    /** Column name IsEmitted */
    public static final String COLUMNNAME_IsEmitted = "IsEmitted";
    ...
    /** Column name IsResma */
    public static final String COLUMNNAME_IsResma = "IsResma";
    ...
    /** Column name starcheckno */
    public static final String COLUMNNAME_starcheckno = "starcheckno";

	/** Set starcheckno	  */
	public void setstarcheckno (int starcheckno);

	/** Get starcheckno	  */
	public int getstarcheckno();
