...
/** Generated Model for UY_PayOrderGenLine
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_PayOrderGenLine extends PO implements I_UY_PayOrderGenLine, I_Persistent 
{
    ...
    public X_UY_PayOrderGenLine (Properties ctx, int UY_PayOrderGenLine_ID, String trxName)
    {
      super (ctx, UY_PayOrderGenLine_ID, trxName);
      /** if (UY_PayOrderGenLine_ID == 0)
        {
			setC_BPartner_ID (0);
			setC_Currency_ID (0);
			setC_Invoice_ID (0);
...
// N
			...
			setUY_PayOrderGenLine_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_PayOrderGenLine (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_PayOrderGenLine[")
	...
	/** Set C_Currency_Bank_ID.
		@param C_Currency_Bank_ID C_Currency_Bank_ID	  */
	public void setC_Currency_Bank_ID (int C_Currency_Bank_ID)
	{
		if (C_Currency_Bank_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_C_Currency_Bank_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_C_Currency_Bank_ID, Integer.valueOf(C_Currency_Bank_ID));
	}

	/** Get C_Currency_Bank_ID.
		@return C_Currency_Bank_ID	  */
	public int getC_Currency_Bank_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_C_Currency_Bank_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set UY_PayOrderGenLine.
		@param UY_PayOrderGenLine_ID UY_PayOrderGenLine	  */
	public void setUY_PayOrderGenLine_ID (int UY_PayOrderGenLine_ID)
	{
		if (UY_PayOrderGenLine_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_PayOrderGenLine_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_PayOrderGenLine_ID, Integer.valueOf(UY_PayOrderGenLine_ID));
	}

	/** Get UY_PayOrderGenLine.
		@return UY_PayOrderGenLine	  */
	public int getUY_PayOrderGenLine_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_PayOrderGenLine_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	public I_UY_PayOrderLine getUY_PayOrderLine() throws RuntimeException
    {
		return (I_UY_PayOrderLine)MTable.get(getCtx(), I_UY_PayOrderLine.Table_Name)
			.getPO(getUY_PayOrderLine_ID(), get_TrxName());	}
	...
	public void setUY_PayOrderLine_ID (int UY_PayOrderLine_ID)
	{
		if (UY_PayOrderLine_ID < 1) 
			set_Value (COLUMNNAME_UY_PayOrderLine_ID, null);
		else 
			set_Value (COLUMNNAME_UY_PayOrderLine_ID, Integer.valueOf(UY_PayOrderLine_ID));
	}
