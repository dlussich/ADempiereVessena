...
/** Generated Model for UY_AllocDirectCreditNote
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_AllocDirectCreditNote extends PO implements I_UY_AllocDirectCreditNote, I_Persistent 
{
    ...
    public X_UY_AllocDirectCreditNote (Properties ctx, int UY_AllocDirectCreditNote_ID, String trxName)
    {
      super (ctx, UY_AllocDirectCreditNote_ID, trxName);
      /** if (UY_AllocDirectCreditNote_ID == 0)
        {
			...
			setProcessed (false);
			setsign (Env.ZERO);
			setUY_AllocDirectCreditNote_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_AllocDirectCreditNote (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_AllocDirectCreditNote[")
	...
	/** Set UY_AllocDirectCreditNote.
		@param UY_AllocDirectCreditNote_ID UY_AllocDirectCreditNote	  */
	public void setUY_AllocDirectCreditNote_ID (int UY_AllocDirectCreditNote_ID)
	{
		if (UY_AllocDirectCreditNote_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_AllocDirectCreditNote_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_AllocDirectCreditNote_ID, Integer.valueOf(UY_AllocDirectCreditNote_ID));
	}

	/** Get UY_AllocDirectCreditNote.
		@return UY_AllocDirectCreditNote	  */
	public int getUY_AllocDirectCreditNote_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_AllocDirectCreditNote_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
