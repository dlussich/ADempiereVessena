...
//				+ " AND c.ColumnName NOT LIKE 'Updated%' "
	...
	public static String getReferenceClassName(int AD_Table_ID, String columnName, int displayType, int AD_Reference_ID)
	{
				...
				|| (displayType == DisplayType.Search && AD_Reference_ID == 0))
		{
			...
			{
				// OpenUp. Gabriel Vila. 13/09/2010.
				// Para el GenerateModel cuando tengo un campo que termina en ID pero no
				// tiene tabla asociada, no tiro error. Simplemente retorno null para que no
				// me genere el get con el return de Interface.
