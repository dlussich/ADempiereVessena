/******************************************************************************
     ...
     public class CalloutOrder extends CalloutEngine
     {
    	...
    	//OpenUp Nicolas Garcia 22/06/2011 issue #734
    	public String product (Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value)
    	{
    		...
    		if (product == null)
    			return "";
    		//Se comenta codigo porque el usuario puede seleccionar cualquier flujo.
    		...
    		int bom_id = MPPProductBOM.getBOMSearchKey(product);
    		mTab.setValue(MPPOrder.COLUMNNAME_PP_Product_BOM_ID, bom_id > 0 ? bom_id : null);
    		
    		return "";
    	}//FIN OpenUp Nicolas Garcia 22/06/2011 issue #734
    }	//	CalloutOrder
