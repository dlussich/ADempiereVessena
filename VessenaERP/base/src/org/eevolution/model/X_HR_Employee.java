...
public class X_HR_Employee extends PO implements I_HR_Employee, I_Persistent 
{
	...
	/** paymethod AD_Reference_ID=1000133 */
	public static final int PAYMETHOD_AD_Reference_ID=1000133;
	/** Efectivo = EF */
	public static final String PAYMETHOD_Efectivo = "EF";
	/** Caja de ahorro = CA */
	public static final String PAYMETHOD_CajaDeAhorro = "CA";
	/** Cuenta corriente = CC */
	public static final String PAYMETHOD_CuentaCorriente = "CC";
	/** Set paymethod.
