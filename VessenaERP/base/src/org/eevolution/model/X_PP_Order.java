...
// 0
			...
			setTurno (0);
// 1
			setuy_Incluidoenplan (false);
			setUY_Packs (Env.ZERO);
// 0
			setUY_Resource_ID (0);
			setYield (Env.ZERO);
// 100
	...
	/** Set DespCreateFrom.
		@param DespCreateFrom DespCreateFrom	  */
	public void setDespCreateFrom (boolean DespCreateFrom)
	{
		set_Value (COLUMNNAME_DespCreateFrom, Boolean.valueOf(DespCreateFrom));
	}

	/** Get DespCreateFrom.
		@return DespCreateFrom	  */
	public boolean isDespCreateFrom () 
	{
		Object oo = get_Value(COLUMNNAME_DespCreateFrom);
		if (oo != null) 
		{
...
public static final int PRIORITYRULE_AD_Reference_ID=154;
	...
	/** Minor = 9 */
	public static final String PRIORITYRULE_Minor = "9";/** Set Priority.
		@param PriorityRule 
	...
	{
		set_Value (COLUMNNAME_Turno, Integer.valueOf(Turno));
	}
	...
	public int getTurno () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_Turno);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	public I_AD_User getUY_Ad_User_Id_() throws RuntimeException
    {
		return (I_AD_User)MTable.get(getCtx(), I_AD_User.Table_Name)
			.getPO(getUY_Ad_User_Id_bom(), get_TrxName());	}

	/** Set UY_Ad_User_Id_bom.
		@param UY_Ad_User_Id_bom UY_Ad_User_Id_bom	  */
	public void setUY_Ad_User_Id_bom (int UY_Ad_User_Id_bom)
	{
		set_Value (COLUMNNAME_UY_Ad_User_Id_bom, Integer.valueOf(UY_Ad_User_Id_bom));
	}

	/** Get UY_Ad_User_Id_bom.
		@return UY_Ad_User_Id_bom	  */
	public int getUY_Ad_User_Id_bom () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_Ad_User_Id_bom);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set UY_CerroConfirmacion.
		@param UY_CerroConfirmacion UY_CerroConfirmacion	  */
	public void setUY_CerroConfirmacion (boolean UY_CerroConfirmacion)
	{
		set_Value (COLUMNNAME_UY_CerroConfirmacion, Boolean.valueOf(UY_CerroConfirmacion));
	}

	/** Get UY_CerroConfirmacion.
		@return UY_CerroConfirmacion	  */
	public boolean isUY_CerroConfirmacion () 
	{
		Object oo = get_Value(COLUMNNAME_UY_CerroConfirmacion);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set uy_Incluidoenplan.
		@param uy_Incluidoenplan uy_Incluidoenplan	  */
	public void setuy_Incluidoenplan (boolean uy_Incluidoenplan)
	{
		set_Value (COLUMNNAME_uy_Incluidoenplan, Boolean.valueOf(uy_Incluidoenplan));
	}

	/** Get uy_Incluidoenplan.
		@return uy_Incluidoenplan	  */
	public boolean isuy_Incluidoenplan () 
	{
		Object oo = get_Value(COLUMNNAME_uy_Incluidoenplan);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set UY_Cantidad de Packs.
		@param UY_Packs UY_Cantidad de Packs	  */
	public void setUY_Packs (BigDecimal UY_Packs)
	{
		set_Value (COLUMNNAME_UY_Packs, UY_Packs);
	}

	/** Get UY_Cantidad de Packs.
		@return UY_Cantidad de Packs	  */
	public BigDecimal getUY_Packs () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_UY_Packs);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	{
		set_Value (COLUMNNAME_UY_PacksLiteral, UY_PacksLiteral);
	}
	...
	public I_S_Resource getUY_Resource() throws RuntimeException
    {
		return (I_S_Resource)MTable.get(getCtx(), I_S_Resource.Table_Name)
			.getPO(getUY_Resource_ID(), get_TrxName());	}

	/** Set UY_Resource_ID.
		@param UY_Resource_ID 
		UY_Resource_ID
	  */
	public void setUY_Resource_ID (int UY_Resource_ID)
	{
		if (UY_Resource_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_Resource_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_Resource_ID, Integer.valueOf(UY_Resource_ID));
	}

	/** Get UY_Resource_ID.
		@return UY_Resource_ID
	  */
	public int getUY_Resource_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_Resource_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
