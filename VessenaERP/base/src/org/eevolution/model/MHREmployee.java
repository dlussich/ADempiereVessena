...
public class MHREmployee extends X_HR_Employee
{
	...
	protected boolean beforeSave(boolean newRecord) {
		...
		if(this.getStartDate().compareTo(new Timestamp(System.currentTimeMillis())) >=0){
			
			throw new AdempiereException("La fecha de inicio debe ser menor ó igual a la fecha actual");
