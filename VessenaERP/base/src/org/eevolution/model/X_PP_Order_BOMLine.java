...
// @#Date@
	...
	/** Set UY_Operacion_Orden.
		@param UY_Operacion_Orden UY_Operacion_Orden	  */
	public void setUY_Operacion_Orden (String UY_Operacion_Orden)
	{
		set_Value (COLUMNNAME_UY_Operacion_Orden, UY_Operacion_Orden);
	}

	/** Get UY_Operacion_Orden.
		@return UY_Operacion_Orden	  */
	public String getUY_Operacion_Orden () 
	{
		return (String)get_Value(COLUMNNAME_UY_Operacion_Orden);
	}

	/** Set UY_Secuencia_Orden.
		@param UY_Secuencia_Orden UY_Secuencia_Orden	  */
	public void setUY_Secuencia_Orden (int UY_Secuencia_Orden)
	{
		set_Value (COLUMNNAME_UY_Secuencia_Orden, Integer.valueOf(UY_Secuencia_Orden));
	}

	/** Get UY_Secuencia_Orden.
		@return UY_Secuencia_Orden	  */
	public int getUY_Secuencia_Orden () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_Secuencia_Orden);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
