...
public class X_HR_Payroll extends PO implements I_HR_Payroll, I_Persistent 
{
	...
	/** Set SelectRequired.
		@param SelectRequired SelectRequired	  */
	public void setSelectRequired (boolean SelectRequired)
	{
		set_Value (COLUMNNAME_SelectRequired, Boolean.valueOf(SelectRequired));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_SelectRequired);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set soloNovedades.
		@param soloNovedades soloNovedades	  */
	public void setsoloNovedades (boolean soloNovedades)
	{
		set_Value (COLUMNNAME_soloNovedades, Boolean.valueOf(soloNovedades));
	}

	/** Get soloNovedades.
		@return soloNovedades	  */
	public boolean issoloNovedades () 
	{
		Object oo = get_Value(COLUMNNAME_soloNovedades);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
