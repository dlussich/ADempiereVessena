...
public final class FactLine extends X_Fact_Acct
{
	...
	/**
	 * OpenUp. Gabriel Vila. 25/10/2011. Issue #896.
	 * Elimino asientos para una determinada transaccion.
	 * @param adTableID
	 * @param recordID
	 * @param trxName
	 * @throws Exception 
	...
	public static void deleteFact(int adTableID, int recordID, String trxName){
		//OpenUp. Nicolas Sarlabos. 18/11/2013. #1307. Se modifica para capturar y tirar exception.
		String action = "";
