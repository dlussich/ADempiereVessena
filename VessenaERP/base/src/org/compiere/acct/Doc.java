...
public abstract class Doc
{
	...
	//OpenUp M.R. 14-02-2011 issue #355 creo documento facturas de importaciones
	/**	Factura de importaciones             */
	public static final String 	DOCTYPE_FacturaImportaciones       = "AFI";
	//Fin OpenUp
	//OpenUp Nicolas Sarlabos #754 1/12/2011, creo documento nota de vredito importaciones
	public static final String DOCTYPE_NotaCreditoImportaciones = "ANI";
	//fin OpenUp Nicolas Sarlabos #754 1/12/2011
	// OpenUp. Gabriel Vila. 14/06/2010.
	public static final String	DOCTYPE_Factoring	= "FAT";
	public static final String	DOCTYPE_Canje	= "CDC";
	public static final String	DOCTYPE_Cheque	= "CHQ";
	// Fin
	
	// OpenUp. Gabriel Vila. 18/08/2010.
	public static final String DOCTYPE_Banco_Transferencias = "BTR";
	public static final String DOCTYPE_Banco_DepositoChequeTerceros = "BDT";
	public static final String DOCTYPE_Banco_DepositoChequePropio = "BDP";
	public static final String DOCTYPE_Banco_DepositoEfectivo = "BDE";
	public static final String DOCTYPE_Banco_DepositoTicket = "BDK";// OpenUp. Nicolas Sarlabos. 22/02/2016. #5264.
	public static final String DOCTYPE_Banco_DescuentoChequesTerceros = "BDC";
	public static final String DOCTYPE_Banco_GastosBancarios = "BGB";
	public static final String DOCTYPE_Banco_InteresesBancarios = "BIB";
	public static final String DOCTYPE_Banco_ConciliacionChequesPropios = "BCD";
	// Fin OpenUp.
	// OpenUp. Nicolas Garcia 21/12/2010.
	//public static final String DOCTYPE_Banco_DevolucionChequesPropios = "DCP";
	//public static final String DOCTYPE_Banco_DevolucionChequesTerceros = "DCT";
	public static final String DOCTYPE_Banco_RechazoChequesPropios = "RCP";
	public static final String DOCTYPE_Banco_RechazoChequesTerceros = "RCT";
	public static final String DOCTYPE_Banco_PagoValeBancario = "PVB";//OpenUp M.R. 23-03-2011 issue #473 Agrego tipo de documento para contabilizar
	public static final String DOCTYPE_Banco_CambioChequePropio = "DCP";
	public static final String DOCTYPE_Banco_CambioChequeTercero = "DCT";
	public static final String DOCTYPE_Banco_ValesBancarios = "BPB";
	public static final String DOCTYPE_Banco_CobroConformes = "CNF"; //OpenUp M.R. 16-06-2011 Issue #700 se crea tuipo de documento de conformes
	public static final String DOCTYPE_Control_Libretas_Recibos = "CLR";// OpenUp M.R. 21-09-2011 issue# 721 agrego tipo de documento para validar el proceso de control de libretas de cobro.
	// Fin OpenUp.
	
	// OpenUp. Gabriel Vila. 12/04/2011. Issue #139
	public static final String DOCTYPE_Ctb_ExchangeDiff = "EXD";
	// Fin OpenUp.
	
	// OpenUp. Gabriel Vila. 24/10/2011. Issue #896
	public static final String DOCTYPE_UY_Allocation_Payment = "ALP";
	public static final String DOCTYPE_UY_Allocation_Invoice = "ALR";
	// Fin OpenUp.
	
	// OpenUp. Gabriel Vila. 12/04/2011. Issue #49
	public static final String DOCTYPE_Ctb_Provision = "PRO";
	// Fin OpenUp.

	// OpenUp. Gabriel Vila. 12/04/2011. Issue #82
	public static final String DOCTYPE_Ctb_Devengamiento = "DEV";
	// Fin OpenUp.

	// OpenUp. Gabriel Vila. 14/11/2012. Issue #100
	public static final String DOCTYPE_Ctb_Resguardo = "RGU";
	// Fin OpenUp.
	...
	public static Doc get (MAcctSchema[] ass, int AD_Table_ID, int Record_ID, String trxName)
	{
		...
		if (TableName == null)
		{
			// OpenUp. Gabriel Vila. 09/07/2012.
			// Comento para que no considere tablas con campo posted y que no tengan su clases acct.
	...
	// OpenUp. Gabriel Vila. 27/08/2010.
	// Agrego variable para el manejo de tasa de cambio manual en transacciones.
	private BigDecimal manualDivideRate = new BigDecimal(0);
	// Fin OpenUp.
	...
	public final String post (boolean force, boolean repost)
	{
		...
		// OpenUp. Gabriel Vila. 30/01/2015. Issue #3483
		// Proceso todo documento que no este posteado incluyendo los marcados con errores de posteo
		// Comento y sustituyo
		...
		*/
		...
		//OpenUp. Nicolas Sarlabos. 17/09/2013. #1232. Si se produjo un error se deben eliminar las lineas de asiento creadas.
		if (p_Status.equals(STATUS_Error) || p_Status.equals(STATUS_NotBalanced)){
			
			FactLine.deleteFact(get_Table_ID(), p_po.get_ID(), getTrxName());
		}
		//Fin OpenUp.
		//  commitFact
		...
		if (!p_Status.equals(STATUS_Posted))
		{
			...
			//OpenUp. Guillermo Brust. 08/07/2013. ISSUE #
			//Segun este seteado el system configurator se guarda o no aviso de aplicado
			if (MSysConfig.getBooleanValue("UY_CREATE_NOTE_UNPOSTED", false, this.getAD_Client_ID())){
				//  Insert Note					
				...
				//OpenUp. Nicolas Sarlabos 28/12/2012. Se cambia metodo por problemas al completar documento
				//note.saveEx();
				note.saveEx(getTrxName());
				//Fin OpenUp.
	...
	public void setPeriod()
	{
		...
		// OpenUp. Gabriel Vila. 29/07/2014. Issue #2552.
		// Me aseguro que el periodo sea el correspondiente a la fecha de contabilizacion.
		if (m_period != null){
			MPeriod acctPeriod = MPeriod.get(getCtx(), getDateAcct(), getAD_Org_ID());
			if (acctPeriod != null){
				if (m_period.get_ID() != acctPeriod.get_ID()){
					m_period = acctPeriod;
				}
			}			
		}
		// Fin OpenUp. Issue #2552
	...
	// OpenUp M.R. 14-02-2011 Issue #355 creo contabilidad de factura importaciones
	public static final int 	ACCTTYPE_V_Facturas_Importaciones = 127;
	//OpenUp M.R. 26-09-2011 Issue #754 creo contabilidad de nota de credito importaciones
	public static final int 	ACCTTYPE_V_Nota_Credito_Importaciones = 130;
	//fin #754

	// OpenUp. Gabriel Vila. 14/06/2010.
	public static final int 	ACCTTYPE_V_Factoring   = 5;
	public static final int 	ACCTTYPE_V_Canje   = 6;
	// Fin
	...
	// OpenUp. Gabriel Vila. 14/06/2010.
	public static final int ACCTTYPE_BankEmited = 15; //Emision de cheques
	public static final int ACCTTYPE_IVA_COMPRAS = 16; //Emision de cheques
	public static final int ACCTTYPE_IVA_VENTAS = 17; //Emision de cheques
	public static final int ACCTTYPE_BankRevaluation = 18;
	//OpenUp MR 09-02-2011 Issue#124
	public static final int ACCTTYPE_BankRevaluationGain = 19;
	...
	// OpenUp. Gabriel Vila. 18/08/2010.
	// Tipos nuevos para manejo de bancos
	public static final int ACCTTYPE_TransferenciaBancaria = 120;
	public static final int ACCTTYPE_DepositoChequeTerceros = 121;
	public static final int ACCTTYPE_DepositoChequePropio = 122;
	public static final int ACCTTYPE_DepositoEfectivo = 123;
	public static final int ACCTTYPE_DescuentoChequesTerceros = 124;
	public static final int ACCTTYPE_GastosBancarios = 125;
	public static final int ACCTTYPE_InteresesBancarios = 126;
	public static final int ACCTTYPE_ValesBancarios = 128;
	public static final int ACCTTYPE_CobroConformes = 129; //OpenUp M.R. 16-06-2011 Issue #700 Se crea tipo de entradas contables para el cobro de conforme
	//sevans 04/03/2016 issue #4618
	//Nuevo tipo de cuenta para vale flete
	public static final int ACCTTYPE_ValeFlete = 130;
	// Fin OpenUp.
	...
	public int getValidCombination_ID (int AcctType, MAcctSchema as)
	{
		...
		// OpenUp. Gabriel Vila. 14/06/2010.
		//ACCTTYPE_V_Factoring 
		else if (AcctType == ACCTTYPE_V_Factoring)
		{
			sql = "SELECT C_Factoring_Acct FROM C_BP_Customer_Acct WHERE C_BPartner_ID=? AND C_AcctSchema_ID=?";
			para_1 = getC_BPartner_ID();
		}
		//ACCTTYPE_V_Canje   
		else if (AcctType == ACCTTYPE_V_Canje)
		{
			sql = "SELECT C_Canje_Acct FROM C_BP_Customer_Acct WHERE C_BPartner_ID=? AND C_AcctSchema_ID=?";
			para_1 = getC_BPartner_ID();
		}
		else if (AcctType == ACCTTYPE_BankEmited)
		{
		...
		// OpenUp. MR. 08/02/2011. Issue #124.
		else if (AcctType == ACCTTYPE_BankRevaluation)
		{
			sql = "SELECT B_RevaluationLoss_Acct FROM C_BankAccount_Acct WHERE C_BankAccount_ID=? AND C_AcctSchema_ID=?";
			para_1 = getC_BankAccount_ID();
		}
		else if (AcctType == ACCTTYPE_BankRevaluationGain)
		{
			sql = "SELECT B_RevaluationGain_Acct FROM C_BankAccount_Acct WHERE C_BankAccount_ID=? AND C_AcctSchema_ID=?";
			para_1 = getC_BankAccount_ID();
		}
		...
		//OpenUp M.R. Issue#355 se crea la busqueda del tipo de contabilidad para este documento
		else if (AcctType == ACCTTYPE_V_Facturas_Importaciones)
		{
			sql = "SELECT V_Liability_Services_Acct FROM C_AcctSchema_Default WHERE C_AcctSchema_ID=?";
			para_1 = -1;
		}
		//Fin OpenUp
		//OpenUp M.R. Issue#754 26/09/2011 se crea la busqueda del tipo de contabilidad para este documento
		else if (AcctType == ACCTTYPE_V_Nota_Credito_Importaciones)
		{
			sql = "SELECT V_Liability_Services_Acct FROM C_AcctSchema_Default WHERE C_AcctSchema_ID=?";
			para_1 = -1;
		}
		...
		//OpenUp M.R. 21-02-2011 Issue#355 se crea la busqueda del tipo de contabilidad para este documento
		else if (AcctType == ACCTTYPE_ValesBancarios)
		{
			sql = "SELECT B_Expense_Acct FROM C_BankAccount_Acct WHERE C_BankAccount_ID=? AND C_AcctSchema_ID=?";
			para_1 = getC_BankAccount_ID();//OpenUp M.R. 05-08-2011 Issue#810 Agrego linea con el parametro de la cuenta bancaria
		}
		//OpenUp M.R. 16-06-2011 Issue #700 Busqueda de cuentas coantables para el cobro de conforme
		else if (AcctType == ACCTTYPE_CobroConformes)
		{
			sql = "SELECT B_InTransit_Acct FROM C_BankAccount_Acct WHERE C_BankAccount_ID=? AND C_AcctSchema_ID=?";
			para_1 = getC_BankAccount_ID();
		}
	...
	// OpenUp. Gabriel Vila. 27/08/2010.
	// Para el manejo de tasa cambiaria manual en una transaccion, agrego estos metodos.
	public BigDecimal getManualDivideRate()
	{
		if (this.manualDivideRate.compareTo(Env.ZERO)<=0)
		{
			int index = p_po.get_ColumnIndex("DivideRate");
			if (index != -1)
			{
				BigDecimal value = (BigDecimal)p_po.get_Value(index);
				if (value != null)
					this.manualDivideRate = value;
			}
			else
				this.manualDivideRate = new BigDecimal(0);
		}
		return this.manualDivideRate;
	}	

	public void setManualDivideRate (BigDecimal value)
	{
		this.manualDivideRate = value;
	}
	// Fin OpenUp.
	...
	// Openup. Gabriel Vila. 20/07/2011. Issue #493
	// Cambios varios en este metodo.
	private static void fillDocumentsTableArrays() {
		if (documentsTableID == null) {
			String sql = "SELECT t.AD_Table_ID, t.TableName " +
					...
					"c.ColumnName='Posted' AND " +
					"IsView='N' " +
					" AND t.AD_Table_ID NOT IN (SELECT ad_table_id from uy_notpostedtable) " +
