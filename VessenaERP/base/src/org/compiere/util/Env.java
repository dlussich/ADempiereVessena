...
public final class Env
{
		...
		boolean onlyWindow, boolean ignoreUnparsable)
	{
		...
		while (i != -1)
		{
			...
			// OpenUp. Gabriel Vila. 01/01/2015. Issue #3433.
			// Si no viene valor en contexto pongo un CERO para que no retorne string vacio y respete el texto de la regla de validacion.
			if (ctxInfo.length() == 0){
				//s_log.log(Level.WARNING, "No Context Win=" + WindowNo + " for: " + token);
				ctxInfo = "0";
			}
			// Fin OpenUp. Issue #3433.
