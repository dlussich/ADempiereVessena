...
public class Language implements Serializable
{
	...
	public SimpleDateFormat getDateTimeFormat()
	{
		...
		// OpenUp. Gabriel Vila. 17/06/2013. Issue #1016.
		// Comento linea de formateo de fecha con hora y hago el cambio para que no me muestre
		// mas la localizacion (UYT) el final del texto de la fecha-hora.
		...
		*/
		...
		SimpleDateFormat retValue = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");

		// Fin OpenUp. Issue #1016.
