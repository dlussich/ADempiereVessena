...
public class Evaluator
{
	...
	{
		// OpenUp. Gabriel Vila. 27/04/2012.
		// Comento codigo y reemplazo por codigo del foro.
		// Ver link : http://sourceforge.net/projects/adempiere/forums/forum/610547/topic/5087640
		...
		*/
		...
		// OpenUp. Gabriel Vila. 09/10/2012.
		// Problemas con DisplayLogic ="\n"
		if ((logic.trim().equalsIgnoreCase("\n")) || (logic.trim().equalsIgnoreCase("\t"))) 
			return true;
		// Fin OpenUp.
        ...
        while (st.hasMoreTokens()) {
                ...
                if (logOp.equals("&"))
                        ...
                        s_log.log(Level.SEVERE, "Logic operant '|' or '&' expected => "
                                        + logic);
                        return false;
                }
        }
