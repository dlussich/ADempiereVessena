...
public class MPrintFormat extends X_AD_PrintFormat
{
	...
	static public MPrintFormat get (Properties ctx, int AD_PrintFormat_ID, boolean readFromDisk)
	{
		...
		// OpenUp. Gabriel Vila. 17/03/2011. Issue #431.
		// El reportviewer no refresca cambios dinamicos de su definicion. (ej:printname de columnas)
		// ya que lo guarda en cache. Comento lineas para que no lo traiga de cache. 
