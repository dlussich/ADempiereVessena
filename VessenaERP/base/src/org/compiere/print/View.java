...
public class View extends CPanel
{
	...
	/**	Zoom Level						*/
	private int						m_zoomLevel = 1;   // OpenUp. Gabriel Vila. 06/06/2012. Cambie zoom 100% (2) por 150% (1)
	/** Zoom Options					*/
	...
	{
		double scale = (doScale ? getScale() : 1.50);// OpenUp M.R. 03-06-2011 Issue# 702 se realiza modificacion de escalas para que cuando el reportview se abra muestre las fuentes con tamaño distinto
	...
	private double getScale()
	{
		...
		if (scale != null)
			...
			// OpenUp. Gabriel Vila. 05/06/2012. Zoom en RV no se ve bien.
			//return 1.00;
			return 1.50;
		}
	}
