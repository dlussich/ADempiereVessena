		...
		else if (getC_InvoiceLine_ID() != 0)
		{
			...
			else if (!ce.isCostingMethod())		//	Cost Adjustments
			{
					...
					MAcctSchema.COSTINGMETHOD_AverageInvoice.equals(costingMethod))
				{
					...
					// Stock con el modelo de openup. Comento lineas y obtengo cantidad disponible desde modelo
					...
					*/
					...
					BigDecimal qtyOnhand = MStockTransaction.getQtyPhysical(0, 0, cost.getM_Product_ID(), 0, null, get_TrxName());
					// Fin OpenUp.
