...
public class MPaymentTerm extends X_C_PaymentTerm
{
	...
	public String validate()
	{
		...
		// Dejo que haya al menos una linea de esquema en la definicion de los terminos de pago.
		// Comento codigo original de adempiere.
	...
	public boolean apply (MInvoice invoice)
	{
		...
		// OpenUp. Gabriel Vila. 29/10/2015. Issue #4998.
		// Dejo que haya al menos una linea de esquema en la definicion de los terminos de pago.
		// Comento if original y lo cambio por un cero
	...
	private boolean applySchedule (MInvoice invoice)
	{
		...
		for (int i = 0; i < m_schedule.length; i++)
		{
			...
			// OpenUp. Gabriel Vila. 11/05/2015. Issue #5036
			// Seteo información de cuotas en vencimientos y voy actualizando vencimiento maximo de invoice
			int quoteNo = i + 1;
			int totalQuotes = m_schedule.length;
			ips.set_Value("QuoteNo", quoteNo);
			ips.set_Value("TotalQuotes", totalQuotes);
			ips.set_Value("LiteralQuote", String.valueOf(quoteNo) + "/" + String.valueOf(totalQuotes));
			invoice.setDueDate(ips.getDueDate());
			// Fin OpenUp. Issue #5036
	...
	/***
	 * Obtiene y retorna termino de pago por defecto para una forma de pago recibida.
	 * OpenUp Ltda. Issue #76 
	 * @author Gabriel Vila - 18/10/2012
	 * @see
	 * @param ctx
	 * @param uyPaymentRuleID
	 * @param trxName
	 * @return
	 */
	public static MPaymentTerm forPaymentRuleDefault(Properties ctx, int uyPaymentRuleID, String trxName){
		
		String whereClause = X_C_PaymentTerm.COLUMNNAME_UY_PaymentRule_ID + "=" + uyPaymentRuleID +
							" AND IsDefault='Y'";
		
		MPaymentTerm value = new Query(ctx, I_C_PaymentTerm.Table_Name, whereClause, trxName)
		.first();
	...
	/***
	 * Obtiene y retorna termino de pago segun value recibido
	 * OpenUp Ltda. Issue #1420
	 * @author Nicolas Sarlabos - 26/12/2013
	 * @see
	 * @param ctx
	 * @param value
	 * @param trxName
	 * @return
	 */
	public static MPaymentTerm forValue(Properties ctx, String value, String trxName){
		
		String whereClause = X_C_PaymentTerm.COLUMNNAME_Value + "='" + value + "'";
		
		MPaymentTerm term = new Query(ctx, I_C_PaymentTerm.Table_Name, whereClause, trxName)
		.setClient_ID()
		.first();
	...
	/** Obtiene y retorna termino de pago segun value recibido  --> OJO  NO MULTIEMPRESA!!!!
	 * OpenUp Ltda Issue#
	 ...
	 * @return
	 */
	public static MPaymentTerm forValueAndSystem(Properties ctx, String value, String trxName){
	...
	/***
	 * Obtiene y retorna termino de pago contado
	 * OpenUp Ltda. Issue #76 
	 ...
	 * @return
	 */
	public static MPaymentTerm getContado(Properties ctx, String trxName){
		
		String whereClause = X_C_PaymentTerm.COLUMNNAME_Value + "='contado'";
	...
	/***
	 * Obtiene y retorna termino de pago credito
	 * OpenUp Ltda. 
	 * @author Nicolas Sarlabos - 07/11/2012
	 * @see
	 * @param ctx
	 * @param value
	 * @param trxName
	 * @return
	 */
	public static MPaymentTerm getCredito(Properties ctx, String trxName){
		
		String whereClause = X_C_PaymentTerm.COLUMNNAME_Value + "='credito'";
