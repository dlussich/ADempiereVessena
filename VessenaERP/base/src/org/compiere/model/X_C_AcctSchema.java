...
// -
	...
	public I_C_ValidCombination getUY_Account_LossGain() throws RuntimeException
    {
		return (I_C_ValidCombination)MTable.get(getCtx(), I_C_ValidCombination.Table_Name)
			.getPO(getUY_Account_LossGain_ID(), get_TrxName());	}

	/** Set UY_Account_LossGain_ID.
		@param UY_Account_LossGain_ID UY_Account_LossGain_ID	  */
	public void setUY_Account_LossGain_ID (int UY_Account_LossGain_ID)
	{
		if (UY_Account_LossGain_ID < 1) 
			set_Value (COLUMNNAME_UY_Account_LossGain_ID, null);
		else 
			set_Value (COLUMNNAME_UY_Account_LossGain_ID, Integer.valueOf(UY_Account_LossGain_ID));
	}

	/** Get UY_Account_LossGain_ID.
		@return UY_Account_LossGain_ID	  */
	public int getUY_Account_LossGain_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_Account_LossGain_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	public I_C_ValidCombination getUY_Account_Result() throws RuntimeException
    {
		return (I_C_ValidCombination)MTable.get(getCtx(), I_C_ValidCombination.Table_Name)
			.getPO(getUY_Account_Result_ID(), get_TrxName());	}

	/** Set UY_Account_Result_ID.
		@param UY_Account_Result_ID UY_Account_Result_ID	  */
	public void setUY_Account_Result_ID (int UY_Account_Result_ID)
	{
		if (UY_Account_Result_ID < 1) 
			set_Value (COLUMNNAME_UY_Account_Result_ID, null);
		else 
			set_Value (COLUMNNAME_UY_Account_Result_ID, Integer.valueOf(UY_Account_Result_ID));
	}

	/** Get UY_Account_Result_ID.
		@return UY_Account_Result_ID	  */
	public int getUY_Account_Result_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_Account_Result_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set YearEndDate.
		@param YearEndDate YearEndDate	  */
	public void setYearEndDate (Timestamp YearEndDate)
	{
		set_Value (COLUMNNAME_YearEndDate, YearEndDate);
	}

	/** Get YearEndDate.
		@return YearEndDate	  */
	public Timestamp getYearEndDate () 
	{
		return (Timestamp)get_Value(COLUMNNAME_YearEndDate);
	}
}