...
// 0
	...
	/** Set UY_StockStatus_To_ID.
		@param UY_StockStatus_To_ID UY_StockStatus_To_ID	  */
	public void setUY_StockStatus_To_ID (int UY_StockStatus_To_ID)
	{
		if (UY_StockStatus_To_ID < 1) 
			set_Value (COLUMNNAME_UY_StockStatus_To_ID, null);
		else 
			set_Value (COLUMNNAME_UY_StockStatus_To_ID, Integer.valueOf(UY_StockStatus_To_ID));
	}

	/** Get UY_StockStatus_To_ID.
		@return UY_StockStatus_To_ID	  */
	public int getUY_StockStatus_To_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_StockStatus_To_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
