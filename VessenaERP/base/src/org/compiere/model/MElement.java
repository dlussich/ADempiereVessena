...
public class MElement extends X_C_Element
{
	...
	/***
	 * Obtiene y retorna lista de cuentas contables asociadas a este elemento.
	 * OpenUp Ltda. Issue #1722 
	 * @author Gabriel Vila - 16/12/2013
	 * @see
	 * @return
	 */
	public List<MElementValue> getElementValues(){
		
		String whereClause = X_C_ElementValue.COLUMNNAME_C_Element_ID + "=" + this.get_ID();
		
		List<MElementValue> lines = new Query(getCtx(), I_C_ElementValue.Table_Name, whereClause, get_TrxName()).list();
