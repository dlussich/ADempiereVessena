...
public class X_M_Replenish extends PO implements I_M_Replenish, I_Persistent 
{
	...
	/** Set Tolerance_Percentage.
		@param Tolerance_Percentage Tolerance_Percentage	  */
	public void setTolerance_Percentage (int Tolerance_Percentage)
	{
		set_Value (COLUMNNAME_Tolerance_Percentage, Integer.valueOf(Tolerance_Percentage));
	}

	/** Get Tolerance_Percentage.
		@return Tolerance_Percentage	  */
	public int getTolerance_Percentage () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_Tolerance_Percentage);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
