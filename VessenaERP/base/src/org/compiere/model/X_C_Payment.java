...
import org.openup.model.I_UY_Allocation;
...
// S
	...
	/** Set AmtToAllocate.
		@param AmtToAllocate AmtToAllocate	  */
	public void setAmtToAllocate (BigDecimal AmtToAllocate)
	{
		set_Value (COLUMNNAME_AmtToAllocate, AmtToAllocate);
	}

	/** Get AmtToAllocate.
		@return AmtToAllocate	  */
	public BigDecimal getAmtToAllocate () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_AmtToAllocate);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	/** Set CreateFrom3.
		@param CreateFrom3 CreateFrom3	  */
	public void setCreateFrom3 (String CreateFrom3)
	{
		set_Value (COLUMNNAME_CreateFrom3, CreateFrom3);
	}

	/** Get CreateFrom3.
		@return CreateFrom3	  */
	public String getCreateFrom3 () 
	{
		return (String)get_Value(COLUMNNAME_CreateFrom3);
	}
	...
	/** Set uy_totaldepago.
		@param uy_totaldepago uy_totaldepago	  */
	public void setuy_totaldepago (BigDecimal uy_totaldepago)
	{
		set_Value (COLUMNNAME_uy_totaldepago, uy_totaldepago);
	}

	/** Get uy_totaldepago.
		@return uy_totaldepago	  */
	public BigDecimal getuy_totaldepago () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_uy_totaldepago);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
