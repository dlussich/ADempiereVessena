...
// @#Date@
	...
	/** Set UY_MovementReasons_ID.
		@param UY_MovementReasons_ID UY_MovementReasons_ID	  */
	public void setUY_MovementReasons_ID (int UY_MovementReasons_ID)
	{
		if (UY_MovementReasons_ID < 1) 
			set_Value (COLUMNNAME_UY_MovementReasons_ID, null);
		else 
			set_Value (COLUMNNAME_UY_MovementReasons_ID, Integer.valueOf(UY_MovementReasons_ID));
	}

	/** Get UY_MovementReasons_ID.
		@return UY_MovementReasons_ID	  */
	public int getUY_MovementReasons_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_MovementReasons_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
