...
public class X_Fact_Acct extends PO implements I_Fact_Acct, I_Persistent 
{
	...
	/** Set ConciliaError.
		@param ConciliaError ConciliaError	  */
	public void setConciliaError (boolean ConciliaError)
	{
		set_Value (COLUMNNAME_ConciliaError, Boolean.valueOf(ConciliaError));
	}

	/** Get ConciliaError.
		@return ConciliaError	  */
	public boolean isConciliaError () 
	{
		Object oo = get_Value(COLUMNNAME_ConciliaError);
		if (oo != null) 
		{
	...
	/** Set Conciliar.
		@param Conciliar Conciliar	  */
	public void setConciliar (boolean Conciliar)
	{
		set_Value (COLUMNNAME_Conciliar, Boolean.valueOf(Conciliar));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_Conciliar);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set Account Native Currency.
		@param UY_AccNat_Currency_ID Account Native Currency	  */
	public void setUY_AccNat_Currency_ID (BigDecimal UY_AccNat_Currency_ID)
	{
		set_Value (COLUMNNAME_UY_AccNat_Currency_ID, UY_AccNat_Currency_ID);
	}

	/** Get Account Native Currency.
		@return Account Native Currency	  */
	public BigDecimal getUY_AccNat_Currency_ID () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_UY_AccNat_Currency_ID);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}

	/** Set Amount Native Credit.
		@param UY_AmtNativeCr Amount Native Credit	  */
	public void setUY_AmtNativeCr (BigDecimal UY_AmtNativeCr)
	{
		set_Value (COLUMNNAME_UY_AmtNativeCr, UY_AmtNativeCr);
	}

	/** Get Amount Native Credit.
		@return Amount Native Credit	  */
	public BigDecimal getUY_AmtNativeCr () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_UY_AmtNativeCr);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}

	/** Set Amount Native Debit.
		@param UY_AmtNativeDr Amount Native Debit	  */
	public void setUY_AmtNativeDr (BigDecimal UY_AmtNativeDr)
	{
		set_Value (COLUMNNAME_UY_AmtNativeDr, UY_AmtNativeDr);
	}

	/** Get Amount Native Debit.
		@return Amount Native Debit	  */
	public BigDecimal getUY_AmtNativeDr () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_UY_AmtNativeDr);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
