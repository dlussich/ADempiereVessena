...
import org.openup.model.I_UY_InOutType;
import org.openup.model.I_UY_ProcesoFactmasHdr;
import org.openup.model.I_UY_ReservaPedidoHdr;
...
// 5
	...
	/** DocStatusReason AD_Reference_ID=1000150 */
	public static final int DOCSTATUSREASON_AD_Reference_ID=1000150;
	/** Mercaderia ya Retirada = YR */
	public static final String DOCSTATUSREASON_MercaderiaYaRetirada = "YR";
	/** Mercaderia no Existente = NE */
	public static final String DOCSTATUSREASON_MercaderiaNoExistente = "NE";
	/** Otros = OT */
	public static final String DOCSTATUSREASON_Otros = "OT";
	/** No Visitado = NV */
	public static final String DOCSTATUSREASON_NoVisitado = "NV";
	/** Anulacion de Nota de Credito = NC */
	public static final String DOCSTATUSREASON_AnulacionDeNotaDeCredito = "NC";
	/** Set DocStatusReason.
	...
	/** Set generatetonci.
		@param generatetonci generatetonci	  */
	public void setgeneratetonci (String generatetonci)
	{
		set_Value (COLUMNNAME_generatetonci, generatetonci);
	}

	/** Get generatetonci.
		@return generatetonci	  */
	public String getgeneratetonci () 
	{
		return (String)get_Value(COLUMNNAME_generatetonci);
	}
	...
	/** Set uy_asignatransportehdrfirst_id.
		@param uy_asignatransportehdrfirst_id uy_asignatransportehdrfirst_id	  */
	public void setuy_asignatransportehdrfirst_id (int uy_asignatransportehdrfirst_id)
	{
		set_Value (COLUMNNAME_uy_asignatransportehdrfirst_id, Integer.valueOf(uy_asignatransportehdrfirst_id));
	}

	/** Get uy_asignatransportehdrfirst_id.
		@return uy_asignatransportehdrfirst_id	  */
	public int getuy_asignatransportehdrfirst_id () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_uy_asignatransportehdrfirst_id);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set UY_ImprimirDevolucion.
		@param UY_ImprimirDevolucion UY_ImprimirDevolucion	  */
	public void setUY_ImprimirDevolucion (String UY_ImprimirDevolucion)
	{
		set_Value (COLUMNNAME_UY_ImprimirDevolucion, UY_ImprimirDevolucion);
	}

	/** Get UY_ImprimirDevolucion.
		@return UY_ImprimirDevolucion	  */
	public String getUY_ImprimirDevolucion () 
	{
		return (String)get_Value(COLUMNNAME_UY_ImprimirDevolucion);
	}

	public I_UY_InOutType getUY_InOutType() throws RuntimeException
    {
		return (I_UY_InOutType)MTable.get(getCtx(), I_UY_InOutType.Table_Name)
			.getPO(getUY_InOutType_ID(), get_TrxName());	}

	/** Set uy_inouttype_id.
		@param UY_InOutType_ID uy_inouttype_id	  */
	public void setUY_InOutType_ID (int UY_InOutType_ID)
	{
		if (UY_InOutType_ID < 1) 
			set_Value (COLUMNNAME_UY_InOutType_ID, null);
		else 
			set_Value (COLUMNNAME_UY_InOutType_ID, Integer.valueOf(UY_InOutType_ID));
	}

	/** Get uy_inouttype_id.
		@return uy_inouttype_id	  */
	public int getUY_InOutType_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_InOutType_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set uy_procesofactmashdr_id.
		@param UY_ProcesoFactmasHdr_ID uy_procesofactmashdr_id	  */
	...
	/** Get uy_procesofactmashdr_id.
		@return uy_procesofactmashdr_id	  */
	...
	/** Set uy_reservapedidohdr_id.
		@param UY_ReservaPedidoHdr_ID uy_reservapedidohdr_id	  */
	...
	/** Get uy_reservapedidohdr_id.
		@return uy_reservapedidohdr_id	  */
