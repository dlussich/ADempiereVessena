...
import org.openup.model.I_UY_DocTypeFact;
import org.openup.model.I_UY_FactWildCard;
import org.openup.model.MDocTypeFact;
import org.openup.model.MFactWildCard;
import org.openup.model.X_UY_DocTypeFact;
import org.openup.model.X_UY_FactWildCard;
...
public class MDocType extends X_C_DocType
{
	...
	/* OpenUp. Gabriel Vila. 26/08/2010.
	 * Dado un C_DocType_ID obtengo su correspondiente DocBaseType
	 */
	static public String getDocBaseType(int C_DocType_ID)
	{
		final String sql = "SELECT DocBaseType FROM C_DocType "
						+" WHERE C_DocType_ID=?";
		String result = DB.getSQLValueString(null, sql, C_DocType_ID);
		return result;	
	}	//	setGL_Category_ID
	 ...
	 * @return
	 */
	public static MDocType forValue(Properties ctx, String value, String trxName){
		
		String whereClause = X_C_DocType.COLUMNNAME_Value + "='" + value + "'";
	...
	/***
	 * Obtiene y retorna tipo de documento segun value recibido
	 * OpenUp Ltda. Issue #5213 
	 * @author Emiliano Bentancor - 03/03/2016
	 * @see
	 * @param ctx
	 * @param value
	 * @param trxName
	 * @return
	 */
	public static MDocType forValueWOClinetID(Properties ctx, String value, String trxName){
	...
	/***
	 * Obtiene y retorna tipo de documento segun value recibido - --> OJO  NO MULTIEMPRESA!!!! 
	 * OpenUp Ltda. Issue #2501 
	 * @author Sylvie Bouissa - 14/11/2014
	 * @see
	 * @param ctx
	 * @param value
	 * @param trxName
	 * @return
	 */
	public static MDocType forValueAndSystem(Properties ctx, String value, String trxName){
	...
	/***
	 * Obtiene y retorna un modelo de cuenta de asiento tipo para un determinado documento.
	 * OpenUp Ltda. Issue # 
	 * @author Gabriel Vila - 20/11/2014
	 * @see
	 * @param ctx
	 * @param c_DocType_ID_2
	 * @param c_ElementValue_ID
	 * @param object
	 * @return
	 */
	public static MDocTypeFact getDocTypeFact(Properties ctx, int cDocTypeID, int cElementValueID, String trxName) {

		String whereClause = X_UY_DocTypeFact.COLUMNNAME_C_DocType_ID + "=" + cDocTypeID +
				" AND " + X_UY_DocTypeFact.COLUMNNAME_C_ElementValue_ID + "=" + cElementValueID;
		
		MDocTypeFact model = new Query(ctx, I_UY_DocTypeFact.Table_Name, whereClause, trxName).first(); 
	...
	/***
	 * Obtiene y retorna comodines de asientos tipos que no son del sistema.
	 ...
	 * @return
	 */
	public static List<MFactWildCard> getTypeFactWildCards(Properties ctx, String trxName) {

		String whereClause = X_UY_FactWildCard.COLUMNNAME_IsSystem + "='N'";
		
		List<MFactWildCard> lines = new Query(ctx, I_UY_FactWildCard.Table_Name, whereClause, trxName)
		.setClient_ID()
		.setOnlyActiveRecords(true)
		.list();
