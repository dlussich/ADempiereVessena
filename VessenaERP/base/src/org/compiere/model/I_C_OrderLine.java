...
public interface I_C_OrderLine 
{
    ...
    /** Column name cant_pendiente */
    public static final String COLUMNNAME_cant_pendiente = "cant_pendiente";
    ...
    /** Column name iscrossbonus */
    public static final String COLUMNNAME_iscrossbonus = "iscrossbonus";
    ...
    /** Column name UY_BonifCantHijo */
    public static final String COLUMNNAME_UY_BonifCantHijo = "UY_BonifCantHijo";
    ...
    /** Column name UY_BonifXPadreUnHijo */
    public static final String COLUMNNAME_UY_BonifXPadreUnHijo = "UY_BonifXPadreUnHijo";
    ...
    /** Column name uy_cantcancelada */
    public static final String COLUMNNAME_uy_cantcancelada = "uy_cantcancelada";
    ...
    /** Column name uy_cantidadpedido */
    public static final String COLUMNNAME_uy_cantidadpedido = "uy_cantidadpedido";
    ...
    /** Column name uy_c_uom_id */
    public static final String COLUMNNAME_uy_c_uom_id = "uy_c_uom_id";
    ...
    /** Column name Uy_FechaConfirmacionCompra */
    public static final String COLUMNNAME_Uy_FechaConfirmacionCompra = "Uy_FechaConfirmacionCompra";
    ...
    /** Column name UY_FechaConfirmacionCompras */
    public static final String COLUMNNAME_UY_FechaConfirmacionCompras = "UY_FechaConfirmacionCompras";
    ...
    /** Column name UY_LineaPadre_ID */
    public static final String COLUMNNAME_UY_LineaPadre_ID = "UY_LineaPadre_ID";
    ...
    /** Column name uy_polineclosed */
    public static final String COLUMNNAME_uy_polineclosed = "uy_polineclosed";
    ...
    /** Column name uy_printprice */
    public static final String COLUMNNAME_uy_printprice = "uy_printprice";
    ...
    /** Column name uy_promodiscount */
    public static final String COLUMNNAME_uy_promodiscount = "uy_promodiscount";
    ...
    /** Column name uy_promodiscountmax */
    public static final String COLUMNNAME_uy_promodiscountmax = "uy_promodiscountmax";
