...
public class MReplenish extends X_M_Replenish {
	 ...
	 * 
	 * OpenUp.	issue #901
	 * Descripcion : Se implementa beforesave para controlar el porcentaje de 
	 * tolerancia ingresado 
	...
	protected boolean beforeSave(boolean newRecord) {
    	...
    	if(this.getTolerance_Percentage()<0 || this.getTolerance_Percentage()>100)
			throw new AdempiereException("El porcentaje debe ser un valor entre 0 y 100");
