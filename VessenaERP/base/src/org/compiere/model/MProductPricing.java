...
public class MProductPricing
{
	...
	// OpenUp. Gabriel Vila. 03/01/2011
	// Descuento
	...
	private void calculateDiscount()
	{
		...
		// OpenUp. Gabriel Vila. 03/01/2011
		// Guardo descuento = flatdiscount del cliente
		this.m_Discount = FlatDiscount;
		// Fin Openup.
	...
	public BigDecimal getDiscount()
	{
		...
		// OpenUp. Gabriel Vila. 03/01/2011
		// Retorno discount = flatdiscount del cliente (calculado previamente) o cero
		// Comento lineas de calculo anterior de descuentos
