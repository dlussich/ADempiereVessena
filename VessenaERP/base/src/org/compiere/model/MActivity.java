...
public class MActivity extends X_C_Activity
{
	...
	/***
	 * Obtiene y retorna actividad segun value recibido.
	 ...
	 * @return
	 */
	public static MActivity forValue (Properties ctx, String value, String trxName){
		
		String whereClause = X_C_Activity.COLUMNNAME_Value + "='" + value + "' ";
		
		MActivity act = new Query(ctx, I_C_Activity.Table_Name, whereClause, trxName)
		.setClient_ID()
		.first();
