...
// Y
	...
	/** Set FirstRowExtract.
		@param FirstRowExtract FirstRowExtract	  */
	public void setFirstRowExtract (int FirstRowExtract)
	{
		set_Value (COLUMNNAME_FirstRowExtract, Integer.valueOf(FirstRowExtract));
	}

	/** Get FirstRowExtract.
		@return FirstRowExtract	  */
	public int getFirstRowExtract () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_FirstRowExtract);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set Es Caja.
		@param IsCaja Es Caja	  */
	public void setIsCaja (boolean IsCaja)
	{
		set_Value (COLUMNNAME_IsCaja, Boolean.valueOf(IsCaja));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_IsCaja);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
