...
public class MInventoryLine extends X_M_InventoryLine 
{
	...
	protected boolean beforeSave (boolean newRecord)
	{
		...
		//OpenUp Nicolas Sarlabos #983 23/02/2010, seteo categoria y familia del producto  
		MProduct prod = new MProduct(getCtx(), this.getM_Product_ID(), get_TrxName());

		if (prod != null) {

			this.setM_Product_Category_ID(prod.getM_Product_Category_ID());
			this.setUY_Familia_ID(prod.getUY_Familia_ID());
		}
		//fin OpenUp Nicolas Sarlabos #983 23/02/2010
