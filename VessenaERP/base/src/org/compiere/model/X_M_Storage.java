...
public class X_M_Storage extends PO implements I_M_Storage, I_Persistent 
{
	...
	public BigDecimal getQtyOnHand () 
	{
		...
		// Considero stock con el mnodelo de openup
		bd = MStockTransaction.getQtyApproved(0, this.getM_Locator_ID(), this.getM_Product_ID(), this.getM_AttributeSetInstance_ID(), null, this.get_TrxName());
		// Fin OpenUp.
	...
	public BigDecimal getQtyOrdered () 
	{
		...
		// OpenUp. Gabriel Vila. 14/06/2011. Issue #719.
		// Considero stock con el mnodelo de openup
		bd = MStockTransaction.getQtyOrdered(0, this.getM_Locator_ID(), this.getM_Product_ID(), this.getM_AttributeSetInstance_ID(), null, this.get_TrxName());
		// Fin OpenUp.
	...
	public BigDecimal getQtyReserved () 
	{
		...
		// OpenUp. Gabriel Vila. 14/06/2011. Issue #719.
		// Considero stock con el mnodelo de openup, debo traer valor segun este modelo
		bd = MStockTransaction.getQtyReserved(0, this.getM_Locator_ID(), this.getM_Product_ID(), this.getM_AttributeSetInstance_ID(), null, this.get_TrxName());
		// Fin OpenUp.
