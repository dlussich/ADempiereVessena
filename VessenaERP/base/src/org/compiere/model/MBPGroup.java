...
public class MBPGroup extends X_C_BP_Group
{
	...
	protected boolean afterSave (boolean newRecord, boolean success)
	{
		if (newRecord && success){
			...
			// OpenUp. Gabriel Vila. 05/11/2014. Issue #3154
			// Comento y susutituyo codigo para que no retorne false cuando no puede crear la contabilidad de un grupo de manera automatica.
