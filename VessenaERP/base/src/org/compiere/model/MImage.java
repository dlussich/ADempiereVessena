...
public class MImage extends X_AD_Image
{
	...
	/***
	 * Obtiene y retorna nombre del archivo de la imagen, sin el path.
	 * OpenUp Ltda. Issue #401 
	 * @author Hp - 25/02/2013
	 * @see
	 * @return
	 */
	public String getAbsoluteFileName(){
		...
		try{
			...
			if (this.getImageURL() == null) return value;

			int pos1 = this.getImageURL().toString().lastIndexOf("\\");
			if (pos1 > 0){
				value = this.getImageURL().toString().substring(pos1 + 1);
			}
