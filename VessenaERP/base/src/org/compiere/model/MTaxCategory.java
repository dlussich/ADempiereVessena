...
public class MTaxCategory extends X_C_TaxCategory
{
	...
	/**
	 * Obtiene y retorna categoria de impuesto por default y activa.
	 * OpenUp Ltda. Issue #1034 
	 * @author Gabriel Vila - 17/07/2012
	 * @see
	 * @return
	 */
	public static MTaxCategory getDefault() {

		final String whereClause = X_C_TaxCategory.COLUMNNAME_IsActive + "='Y' " +
						 " AND " + X_C_TaxCategory.COLUMNNAME_IsDefault+ "='Y' ";
		
		MTaxCategory value = new Query(Env.getCtx(), I_C_TaxCategory.Table_Name, whereClause, null)
							.setClient_ID()
							.setOnlyActiveRecords(true)
							.first();

		if (value == null) value = new MTaxCategory(Env.getCtx(), 0, null);
