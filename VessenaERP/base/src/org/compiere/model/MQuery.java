	...
	static public MQuery get (Properties ctx, int AD_PInstance_ID, String TableName)
	{
		...
		if (!trl)
			SQL = "SELECT ip.ParameterName,ip.P_String,ip.P_String_To,"			//	1..3
				...
				+ " AND ((pp.UY_NotFieldMatch is null) OR (pp.UY_NotFieldMatch='N'))"; // OpenUp. Gabriel Vila. 04/11/2011. No considerar parametros que no se asocian a un campo de la tabla.;
		else
