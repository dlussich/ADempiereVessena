...
// @M_Locator_ID@
	...
	/** Baja por Roturas = R */
	public static final String INVENTORYTYPE_BajaPorRoturas = "R";
	/** Vencidos = V */
	public static final String INVENTORYTYPE_Vencidos = "V";
	/** Baja por Robo = X */
	public static final String INVENTORYTYPE_BajaPorRobo = "X";
	/** Set Inventory Type.
		@param InventoryType 
