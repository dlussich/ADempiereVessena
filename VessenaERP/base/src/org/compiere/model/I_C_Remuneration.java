...
public interface I_C_Remuneration 
{
    ...
    public static final String COLUMNNAME_compensa = "compensa";
    ...
    /** Column name importe_cero */
    public static final String COLUMNNAME_importe_cero = "importe_cero";
    ...
    public static final String COLUMNNAME_tipo_horario = "tipo_horario";
    ...
    /** Column name UY_HRRemunerationGroup_ID */
    public static final String COLUMNNAME_UY_HRRemunerationGroup_ID = "UY_HRRemunerationGroup_ID";
    ...
    public static final String COLUMNNAME_WeekHours = "WeekHours";
