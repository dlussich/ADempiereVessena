...
public class MWarehouse extends X_M_Warehouse
{
	...
	/***
	 * Obtiene modelo de almacen segun un determinado value recibido.
	 * OpenUp Ltda. Issue #
	 * @author Nicolas Sarlabos - 04/11/2015
	 * @see
	 * @param ctx
	 * @param value
	 * @param trxName
	 * @return
	 */
	public static MWarehouse forValue(Properties ctx, String value, String trxName)
	{
