...
public class X_C_UOM extends PO implements I_C_UOM, I_Persistent 
{
	...
	/** ContainerType AD_Reference_ID=1000211 */
	public static final int CONTAINERTYPE_AD_Reference_ID=1000211;
	/** Unidad Simple = UNI */
	public static final String CONTAINERTYPE_UnidadSimple = "UNI";
	/** Caja = CAJ */
	public static final String CONTAINERTYPE_Caja = "CAJ";
	/** Display = DIS */
	public static final String CONTAINERTYPE_Display = "DIS";
	/** Quintal = QUI */
	public static final String CONTAINERTYPE_Quintal = "QUI";
	...
	/** Quantity = QT */
	public static final String UOMTYPE_Quantity = "QT";
	/** Set UOM Type.
