...
// @SQL=SELECT COALESCE(MAX(SeqNo),0)+10 AS DefaultValue FROM AD_Tab WHERE AD_Window_ID=@AD_Window_ID@
	...
	/** Set IsShowToolbar.
		@param IsShowToolbar IsShowToolbar	  */
	public void setIsShowToolbar (boolean IsShowToolbar)
	{
		set_Value (COLUMNNAME_IsShowToolbar, Boolean.valueOf(IsShowToolbar));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_IsShowToolbar);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set LinkChildTab_ID.
		@param LinkChildTab_ID LinkChildTab_ID	  */
	public void setLinkChildTab_ID (int LinkChildTab_ID)
	{
		if (LinkChildTab_ID < 1) 
			set_Value (COLUMNNAME_LinkChildTab_ID, null);
		else 
			set_Value (COLUMNNAME_LinkChildTab_ID, Integer.valueOf(LinkChildTab_ID));
	}

	/** Get LinkChildTab_ID.
		@return LinkChildTab_ID	  */
	public int getLinkChildTab_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_LinkChildTab_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
