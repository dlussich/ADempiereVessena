...
// M
	...
	/**
	 * OpenUp. Gabriel Vila. 04/05/2011. Issue #634
	 */
    public X_AD_Window(){
    	super (Env.getCtx());
    }
	...
	/** Set OpenAsNewRecord.
		@param OpenAsNewRecord OpenAsNewRecord	  */
	public void setOpenAsNewRecord (boolean OpenAsNewRecord)
	{
		set_Value (COLUMNNAME_OpenAsNewRecord, Boolean.valueOf(OpenAsNewRecord));
	}

	/** Get OpenAsNewRecord.
		@return OpenAsNewRecord	  */
	public boolean isOpenAsNewRecord () 
	{
		Object oo = get_Value(COLUMNNAME_OpenAsNewRecord);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set TimerMinDelay.
		...
		TimerMinDelay
	  */
	public void setTimerMinDelay (int TimerMinDelay)
	{
		set_Value (COLUMNNAME_TimerMinDelay, Integer.valueOf(TimerMinDelay));
	}

	/** Get TimerMinDelay.
		@return TimerMinDelay
	  */
	public int getTimerMinDelay () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_TimerMinDelay);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	{
		set_Value (COLUMNNAME_UseTimer, Boolean.valueOf(UseTimer));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_UseTimer);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	// OpenUp. Gabriel Vila. 12/05/2011. Issue #634
	// Para la serializacion de objetos de este type a XML,
	// se requieren que sus atributos tengan las propiedades GET y SET.
	// Adempiere para los atributos que empiezan con IS, no les pone el profijo GET
	// y por lo tanto estos atributos no se serializan
	...
	public boolean getIsOpenAsNewRecord()
	{
		Object oo = get_Value(COLUMNNAME_OpenAsNewRecord);
		if (oo != null) 
		{
