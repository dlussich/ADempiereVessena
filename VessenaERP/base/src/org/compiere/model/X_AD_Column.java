...
// Y
	...
	// OpenUp. Gabriel Vila. 25/01/2015. Issue #1405
	private boolean migrateColumn = true;

	public boolean isMigrateColumn() {
		return migrateColumn;
	}
	
	public void setMigrateColumn(boolean migrateColumn) {
		this.migrateColumn = migrateColumn;
	}
	// Fin OpenUp. Issue #2015
