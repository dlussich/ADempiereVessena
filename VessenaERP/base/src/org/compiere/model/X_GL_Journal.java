...
import org.openup.model.I_UY_FduLoad;
import org.openup.model.I_UY_LoadCierreCtaCte;
...
public class X_GL_Journal extends PO implements I_GL_Journal, I_Persistent 
{
	 ...
	 *
	 */
	private static final long serialVersionUID = 20121029L;
...
// 0
	...
	public I_UY_LoadCierreCtaCte getUY_LoadCierreCtaCte() throws RuntimeException
    {
		return (I_UY_LoadCierreCtaCte)MTable.get(getCtx(), I_UY_LoadCierreCtaCte.Table_Name)
			.getPO(getUY_LoadCierreCtaCte_ID(), get_TrxName());	}

	/** Set UY_LoadCierreCtaCte.
		@param UY_LoadCierreCtaCte_ID UY_LoadCierreCtaCte	  */
	public void setUY_LoadCierreCtaCte_ID (int UY_LoadCierreCtaCte_ID)
	{
		if (UY_LoadCierreCtaCte_ID < 1) 
			set_Value (COLUMNNAME_UY_LoadCierreCtaCte_ID, null);
		else 
			set_Value (COLUMNNAME_UY_LoadCierreCtaCte_ID, Integer.valueOf(UY_LoadCierreCtaCte_ID));
	}

	/** Get UY_LoadCierreCtaCte.
		@return UY_LoadCierreCtaCte	  */
	public int getUY_LoadCierreCtaCte_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_LoadCierreCtaCte_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
