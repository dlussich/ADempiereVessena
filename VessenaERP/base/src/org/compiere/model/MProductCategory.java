...
public class MProductCategory extends X_M_Product_Category
{
	...
	/***
	 * Obtiene y retorna contabilidad de esta categoria de producto.
	 * OpenUp Ltda. Issue #89 
	 * @author Gabriel Vila - 30/10/2012
	 * @see
	 * @return
	 */
	public MProductCategoryAcct getCategoryAccounting(){
		
		// Obtengo cuentas del producto
		MProductCategoryAcct acct = new Query(getCtx(), I_M_Product_Category_Acct.Table_Name, "M_Product_Category_ID=?", get_TrxName())
