...
public class MRefTable extends X_AD_Ref_Table
{
	...
	/**
	 * OpenUp. Gabriel Vila. 04/05/2011. Obtengo modelo a partir de reference y tabla.
	 * @param ctx
	 * @param reference_Value_ID
	 * @param trxName
	 * @return
	 */
	public static MRefTable getRefTable(Properties ctx, int reference_Value_ID, int adTableID, String trxName)
	{
		String sql = " SELECT * from AD_Ref_Table where AD_Reference_ID = " + reference_Value_ID +
	...
	/**
	 * OpenUp. Gabriel Vila. 04/05/2011. Obtengo modelo a partir de reference
	 * @param ctx
	 * @param reference_Value_ID
	 * @param trxName
	 * @return
	 */
	public static MRefTable getRefTable(Properties ctx, int reference_Value_ID, String trxName)
	{
		String sql = " SELECT * from AD_Ref_Table where AD_Reference_ID = " + reference_Value_ID;
