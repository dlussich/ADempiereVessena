...
// 1
	...
	/** Set cant_pendiente.
		@param cant_pendiente cant_pendiente	  */
	public void setcant_pendiente (BigDecimal cant_pendiente)
	{
		throw new IllegalArgumentException ("cant_pendiente is virtual column");	}

	/** Get cant_pendiente.
		@return cant_pendiente	  */
	public BigDecimal getcant_pendiente () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_cant_pendiente);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	/** Set iscrossbonus.
		@param iscrossbonus iscrossbonus	  */
	public void setiscrossbonus (boolean iscrossbonus)
	{
		set_Value (COLUMNNAME_iscrossbonus, Boolean.valueOf(iscrossbonus));
	}

	/** Get iscrossbonus.
		@return iscrossbonus	  */
	public boolean iscrossbonus () 
	{
		Object oo = get_Value(COLUMNNAME_iscrossbonus);
		if (oo != null) 
		{
	...
	{
		throw new IllegalArgumentException ("saldo is virtual column");	}
	...
	/** Set UY_BonifCantHijo.
		@param UY_BonifCantHijo UY_BonifCantHijo	  */
	public void setUY_BonifCantHijo (BigDecimal UY_BonifCantHijo)
	{
		set_Value (COLUMNNAME_UY_BonifCantHijo, UY_BonifCantHijo);
	}

	/** Get UY_BonifCantHijo.
		@return UY_BonifCantHijo	  */
	public BigDecimal getUY_BonifCantHijo () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_UY_BonifCantHijo);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	/** Set UY_BonifXPadreUnHijo.
		@param UY_BonifXPadreUnHijo UY_BonifXPadreUnHijo	  */
	public void setUY_BonifXPadreUnHijo (BigDecimal UY_BonifXPadreUnHijo)
	{
		set_Value (COLUMNNAME_UY_BonifXPadreUnHijo, UY_BonifXPadreUnHijo);
	}

	/** Get UY_BonifXPadreUnHijo.
		@return UY_BonifXPadreUnHijo	  */
	public BigDecimal getUY_BonifXPadreUnHijo () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_UY_BonifXPadreUnHijo);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}

	/** Set uy_cantcancelada.
		@param uy_cantcancelada uy_cantcancelada	  */
	public void setuy_cantcancelada (BigDecimal uy_cantcancelada)
	{
		set_Value (COLUMNNAME_uy_cantcancelada, uy_cantcancelada);
	}

	/** Get uy_cantcancelada.
		@return uy_cantcancelada	  */
	public BigDecimal getuy_cantcancelada () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_uy_cantcancelada);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	public org.compiere.model.I_C_UOM getuy_c_uom() throws RuntimeException
    {
		return (org.compiere.model.I_C_UOM)MTable.get(getCtx(), org.compiere.model.I_C_UOM.Table_Name)
			.getPO(getuy_c_uom_id(), get_TrxName());	}
	...
	{
		set_ValueNoCheck (COLUMNNAME_UY_EsBonificCruzada, Boolean.valueOf(UY_EsBonificCruzada));
	}
	...
	/** Set Uy_FechaConfirmacionCompra.
		@param Uy_FechaConfirmacionCompra Uy_FechaConfirmacionCompra	  */
	public void setUy_FechaConfirmacionCompra (Timestamp Uy_FechaConfirmacionCompra)
	{
		set_Value (COLUMNNAME_Uy_FechaConfirmacionCompra, Uy_FechaConfirmacionCompra);
	}

	/** Get Uy_FechaConfirmacionCompra.
		@return Uy_FechaConfirmacionCompra	  */
	public Timestamp getUy_FechaConfirmacionCompra () 
	{
		return (Timestamp)get_Value(COLUMNNAME_Uy_FechaConfirmacionCompra);
	}

	/** Set UY_FechaConfirmacionCompras.
		@param UY_FechaConfirmacionCompras UY_FechaConfirmacionCompras	  */
	public void setUY_FechaConfirmacionCompras (Timestamp UY_FechaConfirmacionCompras)
	{
		set_Value (COLUMNNAME_UY_FechaConfirmacionCompras, UY_FechaConfirmacionCompras);
	}

	/** Get UY_FechaConfirmacionCompras.
		@return UY_FechaConfirmacionCompras	  */
	public Timestamp getUY_FechaConfirmacionCompras () 
	{
		return (Timestamp)get_Value(COLUMNNAME_UY_FechaConfirmacionCompras);
	}

	/** Set UY_LineaPadre_ID.
		@param UY_LineaPadre_ID UY_LineaPadre_ID	  */
	public void setUY_LineaPadre_ID (int UY_LineaPadre_ID)
	{
		if (UY_LineaPadre_ID < 1) 
			set_Value (COLUMNNAME_UY_LineaPadre_ID, null);
		else 
			set_Value (COLUMNNAME_UY_LineaPadre_ID, Integer.valueOf(UY_LineaPadre_ID));
	}

	/** Get UY_LineaPadre_ID.
		@return UY_LineaPadre_ID	  */
	public int getUY_LineaPadre_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_LineaPadre_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set uy_polineclosed.
		@param uy_polineclosed uy_polineclosed	  */
	public void setuy_polineclosed (boolean uy_polineclosed)
	{
		set_Value (COLUMNNAME_uy_polineclosed, Boolean.valueOf(uy_polineclosed));
	}

	/** Get uy_polineclosed.
		@return uy_polineclosed	  */
	public boolean isuy_polineclosed () 
	{
		Object oo = get_Value(COLUMNNAME_uy_polineclosed);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set uy_promodiscountmax.
		@param uy_promodiscountmax uy_promodiscountmax	  */
	public void setuy_promodiscountmax (BigDecimal uy_promodiscountmax)
	{
		set_Value (COLUMNNAME_uy_promodiscountmax, uy_promodiscountmax);
	}

	/** Get uy_promodiscountmax.
		@return uy_promodiscountmax	  */
	public BigDecimal getuy_promodiscountmax () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_uy_promodiscountmax);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	{
		set_ValueNoCheck (COLUMNNAME_UY_TieneBonificCruzada, Boolean.valueOf(UY_TieneBonificCruzada));
	}
