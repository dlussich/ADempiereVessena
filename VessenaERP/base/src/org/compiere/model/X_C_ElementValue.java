...
// Y
	...
	/** Set IsProvisionable.
		@param IsProvisionable IsProvisionable	  */
	public void setIsProvisionable (boolean IsProvisionable)
	{
		set_Value (COLUMNNAME_IsProvisionable, Boolean.valueOf(IsProvisionable));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_IsProvisionable);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set UY_AccountChapter.
		@param UY_AccountChapter_ID UY_AccountChapter	  */
	public void setUY_AccountChapter_ID (int UY_AccountChapter_ID)
	{
		if (UY_AccountChapter_ID < 1) 
			set_Value (COLUMNNAME_UY_AccountChapter_ID, null);
		else 
			set_Value (COLUMNNAME_UY_AccountChapter_ID, Integer.valueOf(UY_AccountChapter_ID));
	}

	/** Get UY_AccountChapter.
		@return UY_AccountChapter	  */
	public int getUY_AccountChapter_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_AccountChapter_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	/** Set Cuenta Dif. Cambio Ganada.
		@param uy_ctadifgan Cuenta Dif. Cambio Ganada	  */
	public void setuy_ctadifgan (String uy_ctadifgan)
	{
		set_Value (COLUMNNAME_uy_ctadifgan, uy_ctadifgan);
	}

	/** Get Cuenta Dif. Cambio Ganada.
		@return Cuenta Dif. Cambio Ganada	  */
	public String getuy_ctadifgan () 
	{
		return (String)get_Value(COLUMNNAME_uy_ctadifgan);
	}

	/** Set Cuenta Dif. Cambio Perdida.
		@param uy_ctadifper Cuenta Dif. Cambio Perdida	  */
	public void setuy_ctadifper (String uy_ctadifper)
	{
		set_Value (COLUMNNAME_uy_ctadifper, uy_ctadifper);
	}

	/** Get Cuenta Dif. Cambio Perdida.
		@return Cuenta Dif. Cambio Perdida	  */
	public String getuy_ctadifper () 
	{
		return (String)get_Value(COLUMNNAME_uy_ctadifper);
	}
