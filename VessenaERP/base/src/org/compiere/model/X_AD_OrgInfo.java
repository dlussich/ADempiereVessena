...
public class X_AD_OrgInfo extends PO implements I_AD_OrgInfo, I_Persistent 
{
	...
	/** Set girotype.
		@param girotype girotype	  */
	public void setgirotype (String girotype)
	{
		set_Value (COLUMNNAME_girotype, girotype);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_girotype);
	}
	...
	{
		set_Value (COLUMNNAME_rznsoc, rznsoc);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_rznsoc);
	}
