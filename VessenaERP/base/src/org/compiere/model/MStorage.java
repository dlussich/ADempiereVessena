...
public class MStorage extends X_M_Storage
{
		...
		int M_Product_ID, int M_AttributeSetInstance_ID, String trxName)
	{
		...
		// Si manejo el stock con el mnodelo de openup, debo traer el disponible segun 
		// este modelo
		if (MSysConfig.getBooleanValue("UY_USE_OPENUP_STOCK", true, 1000005))
			return MStockTransaction.getQtyAvailable(M_Warehouse_ID, M_Locator_ID, M_Product_ID, M_AttributeSetInstance_ID, 0, null, trxName);
		// Fin OpenUp.
