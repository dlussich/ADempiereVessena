	...
	protected boolean beforeSave (boolean newRecord)
	{
		...
		if (MSysConfig.getBooleanValue("ProductUOMConversionUOMValidate", true))
		{
				...
				&& (newRecord || is_ValueChanged("M_Product_ID")))
			{
				...
				// OpenUp. Gabriel Vila. 31/03/2011. Issue #580
				// Si no obtuve producto fuera de una transaction, lo intento de nuevo pero en transaction.
				if (product == null)
					product = MProduct.get(getCtx(), getM_Product_ID(), this.get_TrxName());
				// Fin OpenUp
