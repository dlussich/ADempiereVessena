...
public interface DocAction
{
	...
	/** ReQuest = RQ, OpenUP FL 18/02/2011, issue #301 */
	public static final String ACTION_Request = "RQ";
	/** Asign = AS, OpenUP FL 18/02/2011, issue #301 */
	public static final String ACTION_Asign = "AS";
	/** Receive = RV OpenUP FL 18/02/2011, issue #301 */
	public static final String ACTION_Recive = "RV";
	/** Pick = PK OpenUP FL 18/02/2011, issue #301 */
	public static final String ACTION_Pick = "PK";
	/** Apply = AY, OpenUp GV 25/05/2012, issue #1021 */
	...
	/** ReQuested = RQ, OpenUP FL 18/02/2011, isseue #301 */
	public static final String STATUS_Requested = "RQ";
	/** Asigned = AS, OpenUP FL 18/02/2011, isseue #301 */
	public static final String STATUS_Asigned = "AS";
	/** Applied = AY, OpenUp GV 25/05/2012, isseue #1021 */
	public static final String STATUS_Applied = "AY";
	/** Recived = RV, OpenUP FL 18/02/2011, issue #301 */
	public static final String STATUS_Recived = "RV";
	/** Picked = PK, OpenUP FL 18/02/2011, issue #301 */
	public static final String STATUS_Picked = "PK";
