...
public class CostUpdate extends SvrProcess
{
	...
	protected String doIt() throws Exception
	{
		...
		// Calculo con el metodo de costeo ingresado por el usuario y no el standar quemado como tenia.
		//m_ce = MCostElement.getMaterialCostElement(client, MAcctSchema.COSTINGMETHOD_StandardCosting);
		m_ce = MCostElement.getMaterialCostElement(client, p_SetStandardCostTo);
		// Fin OpenUp
	...
	private BigDecimal getCosts (MCost cost, String to) throws Exception
	{
		...
		else if (to.equals(TO_LastInvoicePrice))
		{
			...
			// OpenUp. Gabriel Vila. 08/11/2010.
			// Cambio el if para que tambien considere si el costo actual es cero
			//if (retValue == null)
			if (retValue == null || retValue.doubleValue()==0)
			// Fin OpenUp
			{
