...
public class InventoryCountUpdate extends SvrProcess
{
	...
	protected String doIt () throws Exception
	{
		...
		if (MSysConfig.getBooleanValue("UY_USE_OPENUP_STOCK", false, this.getAD_Client_ID())){
			sql = "UPDATE M_InventoryLine l "
					+ "SET (QtyBook,QtyCount) = "
					+ "(SELECT stk_physical(l.M_Product_ID, null, l.M_Locator_ID, l.M_AttributeSetInstance_ID, 0)," +
							  "stk_physical(l.M_Product_ID, null, l.M_Locator_ID, l.M_AttributeSetInstance_ID, 0)), "
					+ " Updated=SysDate,"
					+ " UpdatedBy=" + getAD_User_ID()
					+ " WHERE M_Inventory_ID=" + this.p_M_Inventory_ID;
		}
		// Fin OpenUp.
