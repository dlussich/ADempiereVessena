 ...
 */
	...
	/***
	 * Obtiene responsable del wf recibiendo como parametro un determinado node de wf.
	 ...
	 * @return
	 */
	public int getAD_WF_Responsible_ID(MWFNode node) {
		
		int value = 0;
		
		if (this.getPO() instanceof IDynamicWF) {
			value = ((IDynamicWF)this.getPO()).getDynamicWFResponsibleID(node);
		}

		if (value == 0){
			value = super.getAD_WF_Responsible_ID(); 
		}
