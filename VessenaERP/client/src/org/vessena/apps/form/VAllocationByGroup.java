...
public class VAllocationByGroup extends Allocation
	implements FormPanel, ActionListener, TableModelListener, VetoableChangeListener
{
	...
	private JLabel bpgroupLabel = new JLabel();						// Openup #issue: 113
	private VLookup bpgroupSearch = null;							// Openup #issue: 113
	...
	private JLabel rateLabel = new JLabel();					// Openup #issue: 113
	private CTextField rateField = new CTextField();			// Openup #issue: 113
	...
	private void jbInit() throws Exception
	{
		...
		bpgroupLabel.setText(Msg.translate(Env.getCtx(), "C_BP_Group_ID"));			// Openup #issue: 113
		...
		rateLabel.setText(Msg.translate(Env.getCtx(), "MultiplyRate"));
		rateField.setText("0");
		...
		parameterPanel.add(organizationLabel, new GridBagConstraints(6, 0, 1, 1, 0.0, 0.0
				,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5,5,5,5), 0, 0));
		parameterPanel.add(organizationPick, new GridBagConstraints(7, 0, 1, 1, 0.0, 0.0
				,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5,5,5,5), 0, 0));
		
		parameterPanel.add(bpgroupLabel, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0
				,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 0, 0));			// Openup #issue: 113
		
		parameterPanel.add(bpartnerLabel, new GridBagConstraints(2, 0, 1, 1, 0.0, 0.0
			,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 0, 0));
		
		parameterPanel.add(bpgroupSearch, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0						
			,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 0, 5, 5), 0, 0));				// Openup #issue: 113
		...
		parameterPanel.add(rateLabel, new GridBagConstraints(2, 1, 1, 1, 0.0, 0.0
				,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 0, 0));			// Openup #issue: 113
			
		parameterPanel.add(rateField, new GridBagConstraints(3, 1, 1, 1, 0.0, 0.0
				,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 0, 0));			// Openup #issue: 113
		...
		parameterPanel.add(currencyPick, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0
			,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 0, 5, 5), 0, 0));
		parameterPanel.add(multiCurrency, new GridBagConstraints(5, 1, 1, 1, 0.0, 0.0
			,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 0, 5, 5), 0, 0));
		
		parameterPanel.add(autoWriteOff, new GridBagConstraints(7, 1, 1, 1, 0.0, 0.0
			,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 0, 0));
	...
	public void dynInit() throws Exception
	{
		...
		//  Buisness Partner Group, used just to filter the partner lookup. Openup #issue: 113
		AD_Column_ID = MColumn.getColumn_ID(MBPartner.Table_Name, MBPartner.COLUMNNAME_C_BP_Group_ID);
		MLookup lookupBPGroup = MLookupFactory.get (Env.getCtx(), m_WindowNo, 0, AD_Column_ID, DisplayType.Search);
		bpgroupSearch = new VLookup("C_BP_Group_ID", true, false, true, lookupBPGroup);
		bpgroupSearch.addVetoableChangeListener(this);

		// BPartner
		// AD_Column_ID = 3499;        //  C_Invoice.C_BPartner_ID			// Openup, changed to allocation line table due to #issue 113
		
		AD_Column_ID= 1001373;
	...
	public void vetoableChange (PropertyChangeEvent e)
	{
		...
		{
			bpartnerSearch.getComponentPopupMenu();
		}
