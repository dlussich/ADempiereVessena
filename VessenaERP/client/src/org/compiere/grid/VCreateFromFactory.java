...
public class VCreateFromFactory
{
	...
	static
	{
		...
		// OpenUp. Gabriel Vila. 19/11/2012. Nuevas clases.
		s_registeredClasses.put(I_UY_MovBancariosHdr.Table_ID, VCreateFromBancoMedioPagoUI.class);
		s_registeredClasses.put(I_C_AllocationHdr.Table_ID, VCreateFromAllocationUI.class);
		s_registeredClasses.put(I_C_Payment.Table_ID, VCreateFromPaymentUI.class);
		s_registeredClasses.put(I_UY_AsignaTransporteHdr.Table_ID, VCreateFromReservaUI.class);
		s_registeredClasses.put(X_C_Order.Table_ID, VCreateFromPPOrderUI.class);
		s_registeredClasses.put(X_UY_Allocation.Table_ID, VCreateFromAllocPaymentUI.class);
		s_registeredClasses.put(X_UY_Resguardo.Table_ID, VCreateFromRetentionInvUI.class);
		// Fin OpenUp		
