	...
	implements ActionListener
{
	...
	private void dynInit(int Record_ID)
	{
		...
		// Necesito enviar el record id para ver las valid actions.
		//index = DocumentEngine.getValidActions(DocStatus, Processing, OrderType, IsSOTrx, m_AD_Table_ID, docActionHolder, options);
		
		index = DocumentEngine.getValidActions(DocStatus, Processing, OrderType, IsSOTrx, m_AD_Table_ID, Record_ID, docActionHolder, options);
		// Fin Issue #646
