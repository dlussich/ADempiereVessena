		...
		VetoableChangeListener,	PropertyChangeListener, MouseListener
{
	...
	/***
	 * Se le da foco al primero componente editable.
	 * OpenUp Ltda. Issue # 
	 * @author Gabriel Vila - 07/08/2013
	 * @return true si todo ok, false sino se pudo setear el foco.
	 * @see
	 */
	public boolean setComponentFocus(){
