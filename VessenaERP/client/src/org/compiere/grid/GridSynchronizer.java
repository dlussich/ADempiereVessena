...
public class GridSynchronizer implements PropertyChangeListener, StateChangeListener {
	...
	public void propertyChange(PropertyChangeEvent evt) {
		...
		// Trampa, solo refresco linktab hija cuando se refresca la tablink padre y NO cuando
		// se refesca la gridtab que la CONTIENE fisicamente.
		if (child.getMTab().getParentLinkTab() != null){
			if (child.getMTab().getParentLinkTab().getAD_Tab_ID() != parent.getMTab().getAD_Tab_ID()){
				return;
			}
		}
