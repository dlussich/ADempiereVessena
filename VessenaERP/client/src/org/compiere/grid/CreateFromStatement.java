...
public class CreateFromStatement extends CreateFrom 
{
			...
			Object AmtFrom, Object AmtTo, Object DocType, Object TenderType, String AuthCode)
	{
		...
		// OpenUp. Gabriel Vila. 30/06/2010.
		// Se agrega en la select un ultimo campo : DueDate para traer y mostrar en la grilla 
		...
		try
		{
			...
			while (rs.next())
			{
				...
				// OpenUp. Gabriel Vila. 30/06/2010.
				// Se guarda la el valor de campo fecha de vencimiento del pago
				line.add(rs.getTimestamp(9));       //  9-DueDate
				// Fin OpenUp
	...
	protected void configureMiniTable (IMiniTable miniTable)
	{
		...
		// OpenUp. Gabriel Vila. 30/06/2010.
		// Se agrega columna para fecha de vencimiento
	...
	public boolean save(IMiniTable miniTable, String trxName)
	{
		...
		for (int i = 0; i < miniTable.getRowCount(); i++)
		{
			if (((Boolean)miniTable.getValueAt(i, 0)).booleanValue())
			{
				...
				// OpenUp. Gabriel Vila. 30/06/2010.
				// Grabo campo para Fecha de Vencimiento del pago.
				bsl.setValutaDate((Timestamp)miniTable.getValueAt(i, 7));					
				// Fin OpenUp
	...
	protected Vector<String> getOISColumnNames()
	{
		...
		// OpenUp. Gabriel Vila. 30/06/2010
		// Nombre de la columna de fecha de vencimiento
