 ...
 *
 */
public class VCreateFromAllocPaymentUI extends CreateFromAllocPayment implements
	 ...
	 * @param gridTab
	 */
	public VCreateFromAllocPaymentUI(GridTab gridTab) {
	...
	protected void configureMiniTable(IMiniTable miniTable) {
		...
		col.setCellEditor(new AllocPayAmountCellEditor());
	 ...
	 *
	 */
	public class AllocPayAmountCellEditor extends AbstractCellEditor implements TableCellEditor {

		private static final long serialVersionUID = 6360749875875285796L;
		JTextField 	editor;
