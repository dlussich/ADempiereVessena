 ...
 *
 */
public class VCreateFromAllocDirectInvoiceUI extends
		CreateFromAllocDirectInvoice implements ActionListener,
	 ...
	 * @param gridTab
	 */
	public VCreateFromAllocDirectInvoiceUI(GridTab gridTab) {
	...
	public boolean dynInit() throws Exception
	{
		...
		//SBT 25/02/2016 Issue 5516 --> create from se utiliza desde dos tablas cpayment y cinvoice
		
		int ad_client_id = 0;int c_bpartner_id = 0;int c_payment_id = 0;Timestamp dateTrx=null;
		String issotrx="";int c_currency_id =0; int c_invoice_id = 0;
		...
		// Load data
		loadData(ad_client_id, issotrx, c_bpartner_id, c_currency_id, dateTrx, c_payment_id, c_invoice_id);
	...
	protected void loadData(int ad_client_id, String issotrx, int c_bpartner_id, 
							int c_currency_id, Timestamp dateTrx, int cPaymentID,int cInvoiceID)
	{
		loadTableOIS(getData(ad_client_id, issotrx, c_bpartner_id, dateTrx, c_currency_id, cPaymentID,cInvoiceID));
	}
	...
	protected void configureMiniTable(IMiniTable miniTable) {
		...
		col.setCellEditor(new AllocDirectInvAmountCellEditor());
	 ...
	 *
	 */
	public class AllocDirectInvAmountCellEditor extends AbstractCellEditor implements TableCellEditor {
