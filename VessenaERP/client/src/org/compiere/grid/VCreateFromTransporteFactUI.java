/**
 * VCreateFromTransporteFactUI.java
 * 20/01/2011
 */
...
/**
 * OpenUp.
 * VCreateFromTransporteFactUI
 * Descripcion :
 * @author Gabriel Vila
 * Fecha : 20/01/2011
 */
public class VCreateFromTransporteFactUI extends CreateFromTransporteFact
	...
	protected CLabel labelFactura = new CLabel("Factura");
	protected VLookup lookupFactura;
	
	private CLabel dateFromLabel = new CLabel("Fecha Factura");
	 ...
	 * @param gridTab
	 */
	public VCreateFromTransporteFactUI(GridTab gridTab) {
	...
	public boolean dynInit() throws Exception
	{
		...
		lookupFactura = new VLookup(X_C_Invoice.COLUMNNAME_C_Invoice_ID, false, false, true,
				MLookupFactory.get (Env.getCtx(), p_WindowNo, 0, MColumn.getColumn_ID(X_C_Invoice.Table_Name, X_C_Invoice.COLUMNNAME_C_Invoice_ID), DisplayType.Search));
		labelFactura.setLabelFor(lookupFactura);
    ...
    private void jbInit() throws Exception
    {
    	...
    	parameterDataPanel.add(labelFactura, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0
    			,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 0, 0));
    	parameterDataPanel.add(lookupFactura, new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0
    				,GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(5, 0, 5, 5), 0, 0)); 
	...
	{
		loadTableOIS(getData(lookupCliente.getValue(), lookupFactura.getValue(), dateFromField.getValue(), dateToField.getValue(), 
