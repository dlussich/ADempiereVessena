...
public class CreateFromInvoice extends CreateFrom
{
	...
	protected Vector<Vector<Object>> getShipmentData(int M_InOut_ID)
	{
		...
		StringBuffer sql = new StringBuffer("SELECT "	//	QtyEntered
			+ "l.MovementQty, l.QtyEntered/l.MovementQty," // OpenUp Nicolas Sarlabos #948 05/01/2012
...
//	    MRMA m_rma = new MRMA(Env.getCtx(), M_RMA_ID, null);
	...
	public boolean save(IMiniTable miniTable, String trxName)
	{
		...
		// Marco la invoice indicando que sus lineas se generan automaticamente desde un create from po
		...
		// OpenUp. Gabriel Vila. 23/01/2014. Issue #1588
		// Guardo siempre los cambios en la c_invoice
		invoice.saveEx();
		// Fin OpenUp.
