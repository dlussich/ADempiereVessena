...
public final class VPanel extends CTabbedPane
{
	...
	/**
	 * Retorno hash con informacion de paneles colapsables de pestañas incluidas.
	 * OpenUp Ltda. Issue #1147
	 * @author Gabriel Vila - 19/07/2013
	 * @see
	 * @return
	 */
	public java.util.Hashtable<Integer, CollapsiblePanel> getCollapsedIncludedTab(){
		return this.m_tabincludelist;
	}
