...
public class InfoBPartner extends Info
{
	...
	private static Info_Column[] s_partnerLayout = {
		...
		//Cambiado por E. Bentancor #5702 Para realizar busquedas por UPC
		//new Info_Column(Msg.translate(Env.getCtx(), "Postal"), "a.Postal", KeyNamePair.class, "l.C_BPartner_Location_ID"),
		new Info_Column(Msg.translate(Env.getCtx(), "RUT"), "C_BPartner.DUNS", String.class),
		//Fin #5702
...
//		fieldPostal.addActionListener(this);
		labelDUNS.setText(Msg.getMsg(Env.getCtx(), "RUT"));
...
//		parameterPanel.add(fieldPostal, null);
		parameterPanel.add(labelDUNS, null);
		parameterPanel.add(fieldDUNS, null);
		//FIN #5702
	...
	protected String getSQLWhere()
	{
		...
		if (!(name.equals("") || name.equals("%")))
			list.add ("(UPPER(C_BPartner.Name) LIKE ? OR UPPER(C_BPartner.Name2) LIKE '" + name + "' )"); //OpenUp M.R. 16-05-2011 Issue#644 Se modifica linea para filtrar por nombre o razon social
		//	=> Contact
...
//		=> DUNS (RUT)
		String duns = fieldDUNS.getText().toUpperCase();
		if (!(duns.equals("") || duns.equals("%")))
